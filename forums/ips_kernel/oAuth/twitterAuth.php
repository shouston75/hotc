...
/*
* Thanks to: (for giving me some work to clean up your disgusting code)
...
require_once IPS_KERNEL_PATH . 'oAuth/oAuth.php';
...
class TwitterOAuth 
{
	...
	/* Returned anything but 200 recentyly? */
	private $troubles = 0;
	...
	*/
	...
	{ 
		return self::$TO_API_ROOT . '/oauth/request_token'; 
	}

	function authorizeURL() 
	{ 
		return self::$TO_API_ROOT . '/oauth/authorize'; 
	}
	...
	/**
	 * See if Twitter have returned anything but HTTP 200
	 *
	 * @access public
	 * @return	string	1 if Twitter had problems, 0 if not
	 */
	public function twitterProblems()
	{
	...
	*/
	function getAccessToken($token = NULL, $args=array() ) 
	{
	...
	*/
	...
	{
		//$this->_NOW = IPSDebug::getMemoryDebugFlag();
	...
	*/
	function http( $url, $post_data = NULL ) 
	{
		...
		$this->troubles 		= $this->http_status != 200 ? 1 : 0;
