 ...
 * Upon downloading the tables, extract the zip and place the top-level i18n folder under ips_kernel/.
 ...
 * <code>
 * $convert = new classConvertCharset();
