...
class class_xml
{
	...
	* @return	array
	*/
	protected function _xmlBuildTag( $thisvals, $vals, &$i, $type )
	{
		$tag = array();
	...
	* @return	array
	*/
	protected function _xmlGetChildren($vals, &$i)
	{
		$children = array();
	...
	* @return	string
	*/
	protected function _xmlBuildAttributeString( $array = array() )
	{
...
class xml_lite_parse
{
	...
	* @return	@e void
	*/
	protected function _myStartElement( &$parser_obj, $name, $attr )
	{
		//-------------------------------
		// Add to stack
		//-------------------------------
	...
	* @return	@e void
	*/
	protected function _myEndElement( &$parser_obj, $name )
	{
		$this->stack[ $this->array_id ] = array( 'tag'        => $name,
												 'type'       => 'close',
	...
	* @return	@e void
	*/
	protected function _myCdataElement( &$parser_obj, $data )
	{
...
class xml_extract
{
	...
	* @return	@e void
	*/
	protected function _parseTag( $text )
	{
		$attr = array();
		$text = trim($text);
		$fchr = $text{0};
	...
	*/
	protected function _parseAttr( $text )
	{
		$text         = trim($text);	
		$attr_array   = array();
		$query_entity = false;			
	...
	* @return	@e void
	*/
	protected function _parseBetweenTags( $t )
	{
		if ( trim($t ) != '')
		{
	...
	* @return	@e void
	*/
	protected function _execCharacterData( $data )
	{
	...
	* @return	@e void
	*/
	protected function _execStartElement( $tagname, $attr )
	{
	...
	* @return	@e void
	*/
	protected function _execEndElement( $tagname )
	{
	...
	* @return	@e void
	*/
	protected function _execCdataElement( $data )
	{
	...
	* @return	@e void
	*/
	protected function _myXmlSetElementHandler($startHandler, $endHandler)
	{
	...
	* @return	@e void
	*/
	protected function _myXmlSetCharacterDataHandler($handler)
	{
	...
	* @return	@e void
	*/
	protected function _myXmlSetCdataSectionHandler($handler)
	{
	...
	*/
	protected function _getNthCharFromEnd( $t, $i )
	{
