...
{
	/**
	 * XML header - this is prepended to every request
	 *
	 * @var 		string
	 */
	public $header			= "";
	...
	/**
	 * Variable types (do not change - the specification only accounts for certain variable types)
	 *
	 * @var 		array
	 */
	...
	/**
	 * Adjust value of parameter and return it properly cast
	 *
	...
	/**
	 * Create and send an XML document, returning boolean if there is a problem, or the decoded response
	 *
	...
	/**
	 * Prints a document with a single value and exits
	 *
	 * @param	string		Value
	 * @return	@e void
	 */
	...
	/**
	 * Prints an error document and exits
	 *
	...
	/**
	 * Create and send an XML document.  Returns false on error, or the decoded XML-RPC response as a string.
	 *
	 * @param	string		URL to send XML-RPC data to
	...
	public function post( $file_location, $xmldata='' )
	{
		...
		if ( ! $this->auth_user AND !empty($url_parts['user']) )
		{
