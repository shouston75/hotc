...
+---------------------------------------------------------------------------
|   > $Date: 2008-10-02 14:30:24 -0400 (Thu, 02 Oct 2008) $
|   > $Revision: 2578 $
|   > $Author: bfarber $
+---------------------------------------------------------------------------
|
...
class register {
	...
	function revalidate_one($errors="")
	{
		...
		$this->ipsclass->lang['rv_ins'] = sprintf( $this->ipsclass->lang['rv_ins'], strtolower( $this->ipsclass->vars['ipbli_usertype'] == 'username' ? $this->ipsclass->lang['rv_name'] : $this->ipsclass->lang['rv_email'] ) );
