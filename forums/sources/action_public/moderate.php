...
class moderate
{
	...
	function topic_approve_alter($type='approve')
	{
		...
		$this->moderate_log( sprintf( $type == 'approve' ? $this->ipsclass->lang['acp_approve_topic'] : $this->ipsclass->lang['acp_unapprove_topic'], $this->topic['tid'] ) );
	...
	function multi_complete_checked_move()
	{
		...
		if ($source_id == "")
		{
			$this->moderate_error('forum_no_post_allowed');
			return;
		}
		...
		{
			$this->moderate_error('move_same_forum');
			return;
		}
