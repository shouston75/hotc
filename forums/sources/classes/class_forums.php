...
class forum_functions
{
	...
	*/
	...
	function forums_new_posts($forum_data)
	{
        ...
        {
        	$rtime = $this->ipsclass->member['members_markers']['board'] > $forum_data['_db_row']['marker_last_cleared'] ? $this->ipsclass->member['members_markers']['board'] : $forum_data['_db_row']['marker_last_cleared'];
        }
