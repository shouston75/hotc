    ...
    function load_member($member_id=0)
    {
     	...
     	if ($member_id != 0)
        {
            $this->ipsclass->DB->build_query( array( 'select' => "id, name, mgroup, member_login_key, member_login_key_expire, email, restrict_post, view_sigs, view_avs, view_pop, view_img, auto_track,
																  ...
																  has_blog, has_gallery, members_markers, members_editor_choice, members_auto_dst, members_display_name, members_created_remote,ibbookie_points, ibbookie_banned, ibbookie_won, ibbookie_bets, ibbookie_add, ibbookie_mod, ibbookie_admin,
																  members_cache, members_disable_pm, points, deposited_points, pava, psig",
													 'from'   => 'members',
													 'where'  => 'id='.$member_id ) );
