...
// Ads In Topic
//----------------
	if ($this->ipsclass->vars['ait_enable']) 
		{
		if ($ait==1) 
			{
			if ($this->ipsclass->vars['ait_code']) 
				{
	if ($this->ipsclass->member['g_see_ait'] != 1) 
		{
			   $this->output .= $this->ipsclass->compiled_templates['skin_topic']->ait_row();
				$ait++;
		}  
				}
			}
