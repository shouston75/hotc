...
+---------------------------------------------------------------------------
|   > $Date: 2008-01-18 14:58:55 -0500 (Fri, 18 Jan 2008) $
|   > $Revision: 1168 $
|   > $Author: bfarber $
+---------------------------------------------------------------------------
|
	...
	*/
	...
	function member_do_unlock()
	{
		...
		if ($this->ipsclass->input['type'] == 'unlock')
		{
			...
			$this->ipsclass->admin->save_log( count($ids)." Member(s) Unlocked");
			
			$this->ipsclass->main_msg = count($ids)." Member(s) Unlocked";
			$this->member_view_locked_queue();
		}
