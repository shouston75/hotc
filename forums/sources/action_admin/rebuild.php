...
+---------------------------------------------------------------------------
|   > $Date: 2008-01-31 16:16:15 -0500 (Thu, 31 Jan 2008) $
|   > $Revision: 1182 $
|   > $Author: bfarber $
+---------------------------------------------------------------------------
|
...
class ad_rebuild {
	...
	*/
	...
	function tools_splash()
	{
		...
		$this->ipsclass->html .= $this->ipsclass->adskin->add_td_row( array( "<b style='color:red;'>This tool should only be used to update IPB 2.1 skins to be compatible with IPB 2.2.  Using this tool on skins for IPB 2.2 or 2.3 will break them.</b><br />The format for HTML logic in IPB 2.2.0 changed slightly. This tool updates your master skin set held in the DB. You may wish to rebuild caches after using this tool.
