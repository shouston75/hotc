...
+---------------------------------------------------------------------------
|   > $Date: 2008-04-23 16:14:05 -0400 (Wed, 23 Apr 2008) $
|   > $Revision: 1255 $
|   > $Author: bfarber $
+---------------------------------------------------------------------------
|
...
EOF;
	...
	function member_do_edit()
	{
		...
		$this->parser->parse_smilies 	 = 0;
		$this->parser->parse_bbcode  	 = $this->ipsclass->vars['sig_allow_ibc'];
		$this->parser->parse_html  	 	 = $this->ipsclass->vars['sig_allow_html'];
		...
		if ( $this->ipsclass->DB->get_num_rows() )
		{
			$this->ipsclass->DB->do_update( 'profile_portal', array( 'pp_gender'      => $pp_gender,
																	 ...
																	 'pp_about_me'	  => $aboutme ), 'pp_member_id='.$this->ipsclass->input['mid'] );
		}
		else
		{
