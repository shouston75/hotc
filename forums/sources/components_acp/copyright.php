...
+---------------------------------------------------------------------------
|   > $Date: 2007-04-30 12:14:45 -0400 (Mon, 30 Apr 2007) $
|   > $Revision: 957 $
|   > $Author: bfarber $
+---------------------------------------------------------------------------
|
	...
	function copy_save()
	{
		...
		else if ( $response == '0' )
		{
			$this->ipsclass->admin->error("The copyright key you entered is not valid, this might be because of the following:
			               ...
			               <br />
			               Please <a href='{$this->ipsclass->base_url}&section=help&act=support&code=contact'>contact us</a> for assistance or start a new ticket from your <a href='{$this->ipsclass->base_url}&section=help&act=support&code=support'>IPS customer account</a>.
			             ");
		}
		else
		{
