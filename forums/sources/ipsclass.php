...
+---------------------------------------------------------------------------
|   > $Date: 2008-10-03 02:39:12 -0400 (Fri, 03 Oct 2008) $
|   > $Revision: 2588 $
|   > $Author: matt $
+---------------------------------------------------------------------------
|
...
class ipsclass {
	...
	*/
	...
	function parse_member( $member=array(), $custom_fields=1, $skin_file='skin_topic' )
	{
		...
		$member['member_posts']    = $this->compiled_templates[ $skin_file ]->member_posts( $this->do_number_format( intval( $member['posts'] ) ) );$member['member_ibbookie_points']    = $this->compiled_templates[ $skin_file ]->member_ibbookie_points( $this->do_number_format( intval( $member['ibbookie_points'] ) ), $member['id'] );
		$member['member_bookie_points']    = $this->compiled_templates[ $skin_file ]->member_bookie_points( $this->do_number_format( intval( $member['ibbookie_won'] ) ), $member['id'] );
		$member['member_bets']    = $this->compiled_templates[ $skin_file ]->member_bets( $this->do_number_format( intval( $member['ibbookie_bets'] ) ), $member['id'] );
