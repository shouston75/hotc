...
class sql_queries extends db_driver_mysql
{
    ...
    function topics_get_posts( $a )
    {
    	...
    	return "SELECT p.*, pp.*,
				m.id,m.name,m.mgroup,m.email,m.joined,m.posts, m.last_visit, m.last_activity,m.login_anonymous,m.title,m.hide_email, m.warn_level, m.warn_lastwarn, m.points, m.ibbookie_won, m.ibbookie_points, m.ibbookie_bets,
