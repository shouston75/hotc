...
class sql_extra_queries extends db_driver_mysql
{
    ...
    {
    	return "SELECT tr.trid, tr.topic_id, tr.member_id as trmid, m.mgroup, m.mgroup_others, m.org_perm_id, m.members_display_name, m.email, m.id, m.email_full, m.language, m.last_activity, t.title, t.*
    ...
    {
    	return "SELECT ft.*, m.members_display_name, m.mgroup, m.mgroup_others, m.org_perm_id, m.id, m.email, m.language
