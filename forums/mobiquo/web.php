...
$latest_plugin_version = file_get_contents('http://tapatalk.com/v.php?sys=ip30');
$latest_vrsion_link = file_get_contents('http://tapatalk.com/v.php?sys=ip30&link');
...
echo '<br>Forum system version: '.$app_version.'<br>';
