...
class public_portal_portal_portal extends ipsCommand
{
	...
	public function doExecute( ipsRegistry $registry ) 
	{
 	...
 	protected function _do_output()
 	{
        ...
        $this->registry->output->addContent( "<br /><div class='ipsType_smaller desc lighter right' style='clear: both; text-align:right;'>Powered By: Portal v1.0.1 by <a href='http://www.devfuse.com/' title='DevFuse home page'>DevFuse</a><br />Based on IP.Board Portal by <a href='http://www.invisionpower.com/products/board/' title='IP.Board Product Page'>Invision Power Services</a></div>" );
