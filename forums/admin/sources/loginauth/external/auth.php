...
class login_external extends login_core implements interface_login
{
	 ...
	 * @return	boolean
	 */
	protected function _comparePasswords( $password, $remote_member )
	{
		$check_pass = $password;
	...
	public function authenticate( $username, $email_address, $password )
	{
		...
		if( $this->external_conf['REMOTE_SQL_TYPE'] )
		{
			$RDB->connect_vars['sql_type']	= $this->external_conf['REMOTE_SQL_TYPE'];
		}
