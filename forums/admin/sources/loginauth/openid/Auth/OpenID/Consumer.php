 ...
 */
require_once "Auth/OpenID.php";/*noLibHook*/
require_once "Auth/OpenID/Message.php";/*noLibHook*/
require_once "Auth/OpenID/HMAC.php";/*noLibHook*/
require_once "Auth/OpenID/Association.php";/*noLibHook*/
require_once "Auth/OpenID/CryptUtil.php";/*noLibHook*/
require_once "Auth/OpenID/DiffieHellman.php";/*noLibHook*/
require_once "Auth/OpenID/KVForm.php";/*noLibHook*/
require_once "Auth/OpenID/Nonce.php";/*noLibHook*/
require_once "Auth/OpenID/Discover.php";/*noLibHook*/
require_once "Auth/OpenID/URINorm.php";/*noLibHook*/
require_once "Auth/Yadis/Manager.php";/*noLibHook*/
require_once "Auth/Yadis/XRI.php";/*noLibHook*/
