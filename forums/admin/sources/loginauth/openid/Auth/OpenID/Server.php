...
require_once "Auth/OpenID/BigMath.php";/*noLibHook*/
require_once "Auth/OpenID/DiffieHellman.php";/*noLibHook*/
require_once "Auth/OpenID/KVForm.php";/*noLibHook*/
require_once "Auth/OpenID/TrustRoot.php";/*noLibHook*/
require_once "Auth/OpenID/ServerRequest.php";/*noLibHook*/
        ...
        if ($allow) {
            ...
            if (($this->message->isOpenID1()) &&
                ...
                return new Auth_OpenID_ServerError(null,
                  ...
                  "include an identifier.");/*noLibHook*/
            }
