 ...
 * Last Updated: $Date: 2012-11-21 14:26:15 -0500 (Wed, 21 Nov 2012) $
 * </pre>
 *
...
class adminFunctions
{
	...
	/**
	 * Exection order is a beatch
	 */
	public function postOutputInit()
	{
		/* Init tab keys */
		$this->registry->output->initTabKeys();
	}
	...
	public function fetchModRewrite()
	{
		...
		$rules .= "RewriteRule \.(jpeg|jpg|gif|png)\$ {$_root}public/404.php [NC,L]\n\n";
		$rules .= "RewriteCond %{REQUEST_FILENAME} !-f\n" .
