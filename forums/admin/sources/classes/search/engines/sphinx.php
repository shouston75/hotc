 ...
 * IP.Board v3.4.1
 * Global Search
 * Last Updated: $Date: 2012-12-03 14:03:02 -0500 (Mon, 03 Dec 2012) $
 * </pre>
 *
...
class search_engine
{
	...
	public function __construct( ipsRegistry $registry )
	{
		...
		/* Load Sphinx */
		require_once( DOC_IPS_ROOT_PATH . 'sphinxapi.php' );/*noLibHook*/
	...
	{
		$begin = ( $begin < 1000000000 ) ? 1000000000 : $begin;
