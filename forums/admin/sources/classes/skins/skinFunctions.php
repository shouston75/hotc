 ...
 * IP.Board v3.4.1
 * Skin Functions
 * Last Updated: $Date: 2012-08-15 10:33:53 -0400 (Wed, 15 Aug 2012) $
 * </pre>
 *
 * Owner: Matt
 * @author 		$Author: mark $
...
//		$css['css_content'] = IPSText::textToForm( $css['css_content'] );
	...
	public function flushipscdn()
	{
		...
		{				
			...
			$cfm->timeout = 1;
			$cfm->getFileContents( "http://license.invisionpower.com/?a=cdnflush&key=" . ipsRegistry::$settings['ipb_reg_number'] );
		}
	}
}