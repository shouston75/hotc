 ...
 * IP.Board v3.4.1
 * Skin Functions
 * Last Updated: $Date: 2012-11-27 20:31:18 -0500 (Tue, 27 Nov 2012) $
 * </pre>
 *
 * Owner: Matt
						...
						if ( $template['template_group'] AND $template['template_name'] )
						{
							...
							if ( $existing_id )
							{
								...
								$this->DB->update( 'skin_templates', array( 'template_content'     => $template['template_content'],
																			...
																			'template_updated'     => ( $template['template_updated'] ) ? $template['template_updated'] : IPS_UNIX_TIME_NOW,
		...
		foreach( $templates as $group => $data )
		{
			...
			{ 
				...
				foreach( $data as $name => $templateData )
				{
					...
					unset( $templateData['template_updated'] );
