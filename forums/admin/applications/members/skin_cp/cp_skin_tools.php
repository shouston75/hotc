 ...
 * IP.Board v3.4.1
 * ACP tools skin file
 * Last Updated: $Date: 2012-10-17 15:22:49 -0400 (Wed, 17 Oct 2012) $
 * </pre>
 *
 ...
 * @return	string		HTML
 */
public function showAllIPs( $member, $allips, $links, $reg=array(), $totalips ) {

$IPBHTML = "";
//--starthtml--//

$counttxt = sprintf( $this->lang->words['t_counttxt'], $member['members_display_name'], $totalips );
$IPBHTML .= <<<HTML
<div class='acp-box'>
	<h3>{$counttxt}</h3>
