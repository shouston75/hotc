 ...
 * @return	string		HTML
 */
public function groupForm( $id, $data, $title, $do, $button ) {
$IPBHTML = "";
//--starthtml--//
...
<div class='acp-box'>
	...
	<div>
		<table class='ipsTable'>
			<tr>
				<th style='width: 2%'>&nbsp;</th>
				<th style='width: 24%'>{$this->lang->words['cf_title']}</th>
				<th style='width: 12%'>{$this->lang->words['cf_type']}</th>
				<th style='width: 15%; text-align: center;'>{$this->lang->words['cf_required']}</th>
				<th style='width: 15%; text-align: center;'>{$this->lang->words['cf_notpublic']}</th>
				<th style='width: 15%; text-align: center;'>{$this->lang->words['cf_showreg']}</th>
				<th style='width: 15%; text-align: center;'>{$this->lang->words['cf_adminonly']}</th>
