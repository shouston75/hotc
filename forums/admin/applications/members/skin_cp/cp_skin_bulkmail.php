...
$htmlOn = 0;
if ( $mail['mail_html_on'] or $this->request['mail_html_on'] )
{
			...
			<tr>
				...
				<td class='field_field'>
					...
					<div id='editor_plain' style='{$plainStyle}'>
						...
						<p style='margin-top: 5px' class='desctext'>
							<span class='clickable mini_button' onclick='variablesPopup()'>{$this->lang->words['b_var_link']}</span> <span class='clickable mini_button' onclick="editorModeToggle('standard')">{$this->lang->words['b_standard']}</span>
						</p>
					</div>
				</td>
		 	</tr>
