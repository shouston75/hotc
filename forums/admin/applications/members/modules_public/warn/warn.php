 ...
 * Last Updated: $Date: 2010-10-08 10:15:14 -0400 (Fri, 08 Oct 2010) $
 * </pre>
 *
 * @author 		$Author: mark $
...
class public_members_warn_warn extends ipsCommand
{
	...
	public function loadData( $returnOnError=false )
	{
		...
		$classToLoad = IPSLib::loadLibrary( IPS_ROOT_PATH . 'applications/forums/app_class_forums.php', 'app_class_forums', 'forums' );
		$app_class_forums = new $classToLoad( $this->registry );
		...
		$this->registry->output->setTitle( $this->page_title ? $this->page_title : $this->lang->words['w_title'] . ' - ' . ipsRegistry::$settings['board_name'] );
	}
	 ...
	 * @return	void		[Outputs to screen/redirects]
	 */
	protected function _addNoteForm()
	{
		if ( $this->type == 'member' )
		{
	 ...
	 * @return	void		[Outputs to screen/redirects]
	 */
	protected function _showForm( $errors="" )
	{
		if ( $this->type == 'member' )
		{
