 ...
 * Last Updated: $Date: 2012-09-24 08:55:53 -0400 (Mon, 24 Sep 2012) $
 * </pre>
 *
...
class public_members_ajax_messenger extends ipsAjaxCommand 
{
	 ...
	 */
 	protected function _getInboxDropDown()
 	{
 		...
 		$this->returnJsonArray( array( 'html' => $this->registry->output->getTemplate('global_other')->inboxList( $topics ) ), true );
 	}
	 ...
	 */
 	protected function _showQuickForm()
 	{
		...
		return $this->returnHtml( $this->registry->getClass('output')->getTemplate('messaging')->PMQuickForm( $toMemberData ) );
	}
