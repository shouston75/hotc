...
class public_members_profile_status extends ipsCommand 
{
	...
	protected function _approveStatus()
	{
		...
		if ( ! $status_id )
		{
			$this->registry->output->showError( 'status_off', 10282, null, null, 404 );
		}
		...
		{
			$this->registry->output->showError( 'status_off', 10283, null, null, 403 );
		}
	...
	*/
	protected function _list()
	{
		...
		else if ( $this->request['member_id'] )
		{
