...
class enhancements_members_mandrill
{
	...
	public function saveSettings()
	{
		...
		$json = @file_get_contents( 'http://license.invisionpower.com/mandrill/?key='.urlencode( ipsRegistry::$request['api_key'] ) . '&username=' . urlencode( ipsRegistry::$request['username'] ) . '&lkey=' . urldecode( ipsRegistry::$settings['ipb_reg_number'] ) . '&version=' . IPB_LONG_VERSION );
