 ...
 * Last Updated: $Date: 2012-09-14 10:11:40 -0400 (Fri, 14 Sep 2012) $
 * </pre>
 *
 * @author 		$Author: mark $
...
class profile_friends extends profile_plugin_parent
{
	...
	public function return_html_block( $member=array() ) 
	{
		...
		$queryData = array( 'select'		=> 'f.*',
							 ...
							 'where'		=> 'f.friends_member_id=' . $member['member_id'] . ' AND f.friends_approved=1 AND m.member_banned=0 AND ( ! ' . IPSBWOptions::sql( 'bw_is_spammer', 'members_bitoptions', 'members', 'global', 'has' ) . ')',
							 'add_join'		=> array(
												  1 => array( 'select' => 'pp.*',
