...
class admin_forums_forums_forums extends ipsCommand
{
	...
	public function forumForm( $type='edit', $changetype=0 )
	{
		...
		$form['ipseo_priority'] = $this->registry->getClass('output')->formDropdown(
			'ipseo_priority',
			array(
				array( '1', '1' ),
				array( '0.9', '0.9' ),
	...
	public function forumSave( $type='new' )
	{
		...
		$save = array(	'name'						=> IPSText::getTextClass('bbcode')->xssHtmlClean( nl2br( IPSText::stripslashes( $_POST['name'] ) ) ),
						'name_seo'					=> IPSText::makeSeoTitle( strip_tags( $this->request['name'] ) ),
						...
						'ipseo_priority'			=> $this->request['ipseo_priority'],
						'viglink'					=> intval( $this->request['viglink'] ) );
