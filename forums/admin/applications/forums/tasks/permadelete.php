 ...
 * $Author: bfarber $
 * @since		-
 * $LastChangedDate: 2012-08-28 17:56:22 -0400 (Tue, 28 Aug 2012) $
 * @version		v3.4.1
 * $Revision: 11296 $
 */
...
class task_item
{
	...
	public function runTask()
	{
		...
		$this->DB->build( array( 'select' => '*',
								 'from'   => 'topics',
								 'where'  => $this->registry->getClass('class_forums')->fetchTopicHiddenQuery( array( 'pdelete', 'oktoremove' ) ) . ' AND tdelete_time < ' . $_ts . ' AND ' . $this->registry->getClass('class_forums')->fetchTopicArchiveQuery( array( 'not', 'exclude' ) ),
								 'limit'  => array( 0, 500 ) ) );
