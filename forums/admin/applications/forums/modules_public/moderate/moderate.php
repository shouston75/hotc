 ...
 * IP.Board v3.4.1
 * Moderator actions
 * Last Updated: $Date: 2012-12-03 11:05:17 -0500 (Mon, 03 Dec 2012) $
 * </pre>
 *
...
class public_forums_moderate_moderate extends ipsCommand
{
	...
	protected function _topicUnarchive()
	{
		...
		/* Back to topic, then? */
		$this->registry->output->silentRedirect( $this->settings['base_url'] . "showtopic=" . $this->topic['tid'] . '&page=' . intval( $this->request['page'] ), $this->topic['title_seo'], "showtopic" );
	}
	...
	protected function _postsManage( $what )
	{
		...
		if ( $this->topic['tid'] )
		{
			...
			if ( count( $this->pids ) )
			{
				...
				/* Done */
				$this->registry->output->redirectScreen( $this->lang->words['cp_redirect_posts'], $this->settings['base_url'] . "showtopic=" . $this->topic['tid'] . '&amp;page=' . intval( $this->request['page'] ), $this->topic['title_seo'], 'showtopic' );
			}
		}
	...
	protected function _topicApproveAlter( $type='approve' )
	{
		...
		$this->registry->output->redirectScreen( $this->lang->words['redirect_modified'], $this->settings['base_url'] . "showtopic=" . $this->topic['tid'] . "&amp;page=" . intval($this->request['page']), $this->topic['title_seo'], 'showtopic' );
	}
	...
	protected function _topicPinAlter( $type='pin' )
	{
		...
		$url	= "showtopic=".$this->topic['tid']."&amp;page=".intval($this->request['page']);
		
		if( $this->request['from'] == 'forum' )
		{
			$url	= "showforum=".$this->topic['forum_id']."&amp;page=".intval($this->request['page']);
		}
	...
	protected function _multiPostModify()
	{
		...
		{			
			...
			{
				$this->registry->output->redirectScreen( $this->lang->words['cp_redirect_posts'], $this->settings['base_url'] . "showforum=" . $this->topic['forum_id'], $this->forum['name_seo'], "showforum" );
			}		
			$this->registry->output->redirectScreen( $this->lang->words['cp_redirect_posts'], $this->settings['base_url'] . "showtopic=" . $this->topic['tid'] . '&amp;page=' . intval($this->request['page']), $this->topic['title_seo'], 'showtopic' );
		}
	}
	...
	protected function _closeTopic()
	{
		...
		$this->registry->output->redirectScreen( $this->lang->words['p_closed'], $this->settings['base_url'] . "showforum=".$this->forum['id'] . ( $this->request['_from'] == 'forum' ? '&page=' . intval( $this->request['page'] ) : '' ), $this->forum['name_seo'], "showforum" );
	}
	...
	protected function _softDeleteTopicToggle( $delete )
	{
		...
		$this->registry->output->redirectScreen( $this->lang->words[ $lang ], $this->settings['base_url'] . "showforum=" . $this->forum['id'] . '&page=' . intval( $this->request['page'] ), $this->forum['name_seo'], 'showforum' );
	}
	...
	protected function _deleteTopic()
	{
		...
		$this->registry->output->redirectScreen( $this->lang->words['p_deleted'], $this->settings['base_url'] . "showforum=" . $this->forum['id'], $this->forum['name_seo'], 'showforum' );
	}
	...
	protected function _unsubscribeAll()
	{
		...
		$this->registry->output->redirectScreen( $this->lang->words['ts_redirect'], $this->settings['base_url'] . "showtopic=" . $this->topic['tid'] . "&amp;page=" . intval($this->request['page']), $this->topic['title_seo'], 'showtopic' );
	}
	...
	protected function _deletePost()
	{
		...
		$this->registry->output->redirectScreen( $this->lang->words['post_deleted'], $this->settings['base_url'] . "showtopic=" . $this->topic['tid'] . "&amp;page=" . intval($this->request['page']), $this->topic['title_seo'], 'showtopic' );
	}
	...
	protected function _openTopic()
	{
		...
		$_st	= '&page=' . intval( $this->request['page'] );
