 ...
 * Last Updated: $Date: 2012-11-19 13:33:07 -0500 (Mon, 19 Nov 2012) $
 * </pre>
 *
 * @author 		$author$
...
class search_format_forums extends search_format
{
	...
	public function formatContent( $data )
	{
		...
		if ( ! $is_read )
		{
			$data['_unreadUrl']	= $this->registry->output->buildSEOUrl( 'showtopic=' . $data['tid'] . '&amp;view=getnewpost', 'public', $data['title_seo'], 'showtopic' );
		}
