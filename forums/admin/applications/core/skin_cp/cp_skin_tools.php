 ...
 * @return	string		HTML
 */
public function login_conf_form( $login, $form, $help ) {
...
$ipsConnectKey = sprintf( $this->lang->words['ipsconnect_details'], $this->settings['board_url'] . '/interface/ipsconnect/ipsconnect.php', md5( md5( $this->settings['sql_user'] . $this->settings['sql_pass'] ) . $this->settings['board_start'] ) );
