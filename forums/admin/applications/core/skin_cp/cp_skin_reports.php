 ...
 * Last Updated: $Date: 2012-09-18 10:15:15 -0400 (Tue, 18 Sep 2012) $
 * </pre>
 *
 * @author 		$Author: mark $
...
<div class='section_title'>
	...
	<ul class='context_menu'>
		<li><a href='{$this->settings['base_url']}{$this->form_code}&amp;do=create_status'><img src='{$this->settings['skin_acp_url']}/images/icons/add.png' alt=''>{$this->lang->words['r_createnew']}</a></li>
	</ul>
</div>

<div class="acp-box">
	<h3>{$this->lang->words['r_repstatsev']}</h3>
	<div class='ipsExpandable' id='statuses_list'>
EOF;
...
if ( is_array($statusRows) && count($statusRows) )
{
	...
	{
		$newBadge = $data['is_new'] ? "<span class='ipsBadge badge_red' data-tooltip='{$this->lang->words['rbadge_default_desc']}'>{$this->lang->words['rbadge_default']}</span>" : "<a href='{$this->settings['base_url']}&amp;{$this->form_code}&amp;do=set_status&amp;status=new&amp;id={$data['status']}'><span class='ipsBadge badge_grey' data-tooltip='{$this->lang->words['rbadge_not_default_desc']}'>{$this->lang->words['rbadge_not_default']}</span></a>";
		
		$completeBadge = $data['is_complete'] ? "<span class='ipsBadge badge_green' data-tooltip='{$this->lang->words['rbadge_complete_desc']}'>{$this->lang->words['rbadge_complete']}</span>" : "<a href='{$this->settings['base_url']}&amp;{$this->form_code}&amp;do=set_status&amp;status=complete&amp;id={$data['status']}'><span class='ipsBadge badge_grey' data-tooltip='{$this->lang->words['rbadge_not_complete_desc']}'>{$this->lang->words['rbadge_not_complete']}</span></a>";
		
		$activeBadge = $data['is_active'] ? "<a href='{$this->settings['base_url']}&amp;{$this->form_code}&amp;do=set_status&amp;status=active&amp;id={$data['status']}'><span class='ipsBadge badge_purple' data-tooltip='{$this->lang->words['rbadge_active_desc']}'>{$this->lang->words['rbadge_active']}</span></a>" : "<a href='{$this->settings['base_url']}&amp;{$this->form_code}&amp;do=set_status&amp;status=active&amp;id={$data['status']}'><span class='ipsBadge badge_grey' data-tooltip='{$this->lang->words['rbadge_inactive_desc']}'>{$this->lang->words['rbadge_inactive']}</span></a>";
	
		$IPBHTML .= <<<EOF
		<div class='isDraggable' id='status_{$data['status']}'>
			<div class='root_item item category clearfix ipsControlRow'>
				<div class='col_buttons right' style='white-space: nowrap'>
				    <ul class='ipsControlStrip'>
						...
						<li class='i_delete'><a href='#' onclick='return acp.confirmDelete("{$this->settings['base_url']}{$this->form_code}&amp;do=remove_status&amp;id={$data['status']}");' title='{$this->lang->words['r_removestatus']}'>{$this->lang->words['r_removestatus']}</a></li>
				    </ul>
				</div>
				<div class='draghandle'>&nbsp;</div>
				<div class='item_info'>
					<strong class='larger_text'>{$data['title']}</strong>
				</div>
				<div class='right' style='line-height: 1em; padding-right: 10px'>
					{$newBadge}
					{$completeBadge}
					{$activeBadge}
				</div>
...
<script type='text/javascript'>
	jQ("#statuses_list").ipsSortable( 'div', { 
