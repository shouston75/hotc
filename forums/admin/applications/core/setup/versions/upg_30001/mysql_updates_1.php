...
# ALTER MEMBER TABLES
$SQL[] = "DELETE FROM members WHERE id=0;"; // http://community.invisionpower.com/tracker/issue-34479-upgrade-fails-if-there-is-a-member-id-0
...
/* Adding this here so permsBbcode section doesn't throw error */
