...
/* This index makes the PM conversion run much quicker
	@link http://community.invisionpower.com/tracker/issue-30484-ipb2-upgrades */
$SQL[] = "ALTER TABLE message_topics ADD INDEX mt_msg_id(mt_msg_id);";
