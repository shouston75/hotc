...
class version_upgrade
{
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		{
			IPSSetUp::setSavedData('vid', $this->install->current_version );
	...
	function step_1()
	{
		...
		$this->registry->output->addMessage("Forums table backed up - creating new tables next....<br /><br />$this->sqlcount queries ran....");
	...
	function step_2()
	{
	   ...
	   $SQL[] = "CREATE TABLE ".ipsRegistry::dbFunctions()->getPrefix()."forums (
		...
		$this->registry->output->addMessage("New tables created. Altering tables (Part 1, section 1 - post table)<br /><br />$this->sqlcount queries ran....");
	...
	function step_3()
	{
		...
		$this->registry->output->addMessage("Post table altered, altering topic table next...<br /><br />$this->sqlcount queries ran....");
	...
	function step_4()
	{
		...
		$this->registry->output->addMessage("Topic table altered, altering members table next...<br /><br />$this->sqlcount queries ran....");
	...
	function step_5()
	{
		...
		$this->registry->output->addMessage("Members table altered, other tables next...<br /><br />$this->sqlcount queries ran....");
	...
	function step_6()
	{
		...
		$this->registry->output->addMessage("Other tables altered, converting forums next...<br /><br />$this->sqlcount queries ran....");
	...
	function step_18()
	{
		...
		$this->registry->output->addMessage("Inserts completed, dropping old tables next...<br /><br />$this->sqlcount queries ran....");
	...
	function step_19()
	{
		...
		$this->registry->output->addMessage("Old tables dropped, optimization next...<br /><br />$this->sqlcount queries ran....");
	...
	function step_20()
	{
		...
		$this->registry->output->addMessage("Optimization started...<br /><br />$this->sqlcount queries ran....");
	...
	function step_21()
	{
		...
		$this->registry->output->addMessage("Optimization completed, new skins import next...<br /><br />$this->sqlcount queries ran....");
