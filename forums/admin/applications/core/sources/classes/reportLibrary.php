 ...
 * Last Updated: $LastChangedDate: 2012-11-14 18:17:25 -0500 (Wed, 14 Nov 2012) $
 * </pre>
 *
...
class reportLibrary
{
	...
	public function showReportForm( $name, $url, $ex_data=array() )
	{
		...
		return $this->registry->getClass('output')->getTemplate('reports')->basicReportForm( $name, $url, $extra_input, $captchaHTML );
	}
