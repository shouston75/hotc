 ...
 * @since		-
 * $LastChangedDate: 2012-11-14 18:17:25 -0500 (Wed, 14 Nov 2012) $
 * @version		v3.4.1
 * $Revision: 11604 $
 */
...
{	
	...
	public function _processReports()
	{
        ...
        if ( $this->request['newstatus'] == 'x' )
        {
        	$this->registry->getClass('output')->showError( 'invalid_option', 20113, null, null, 403 );
        }
