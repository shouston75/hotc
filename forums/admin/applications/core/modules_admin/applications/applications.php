 ...
 * $LastChangedDate: 2012-10-01 11:12:40 -0400 (Mon, 01 Oct 2012) $
 * @version		v3.4.1
 * $Revision: 11396 $
 */
...
class admin_core_applications_applications extends ipsCommand
{
	...
	public function moduleForm( $type = 'add' )
	{
		...
		$form['sys_module_title'] = $this->registry->output->formInput( 'sys_module_title', $_POST['sys_module_title'] ? $_POST['sys_module_title'] : $module['sys_module_title'], '', 30, 'text', '', '', 32 );
		$form['sys_module_description'] = $this->registry->output->formInput( 'sys_module_description', $_POST['sys_module_description'] ? $_POST['sys_module_description'] : $module['sys_module_description'], '', 30, 'text', '', '', 100 );
