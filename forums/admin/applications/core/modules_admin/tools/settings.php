 ...
 * IP.Board v3.1.3
 * ACP : Settings
 * Last Updated: $Date: 2010-10-19 10:40:05 -0400 (Tue, 19 Oct 2010) $
 *
...
class admin_core_tools_settings extends ipsCommand
{
	...
	private function _processSettingEntry($r)
	{
		...
		$delete  = "&nbsp;<a class='dropdown-button' href='#' onclick='return acp.confirmDelete(\"{$this->settings['_base_url']}&amp;app=core&amp;{$this->form_code}&amp;do=setting_delete&id={$r['conf_id']}\");' title='key: {$r['conf_key']}'><img src='" . $this->settings['skin_acp_url'] . "/_newimages/icons/delete.png' alt='{$this->lang->words['s_delete']}' /></a>";
		$edit    = "<a class='dropdown-button' href='" . $this->settings['_base_url'] . "&amp;app=core&amp;{$this->form_code}&amp;do=setting_showedit&id={$r['conf_id']}' title='id: {$r['conf_id']}'><img src='" . $this->settings['skin_acp_url'] . "/_newimages/icons/pencil.png' alt='{$this->lang->words['s_edit']}' /></a>";
	 ...
	 * @return	void
	 */
	private function _loadDeleteList()
	{
		if ( IN_DEV )
		{
			/* Check for group settings */
			if ( file_exists( DOC_IPS_ROOT_PATH . '_deleteGroupSettings.txt' ) )
			{
			...
			if ( file_exists( DOC_IPS_ROOT_PATH . '_deleteSettings.txt' ) )
			{
