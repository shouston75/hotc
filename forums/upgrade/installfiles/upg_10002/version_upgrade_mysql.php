...
class version_upgrade
{
	...
	function step_1()
	{
		...
		{
			$nq = $this->install->ipsclass->DB->query("REPLACE INTO ".SQL_PREFIX."forum_perms SET perm_id={$r['g_id']}, perm_name='{$r['g_title']} Mask'");
