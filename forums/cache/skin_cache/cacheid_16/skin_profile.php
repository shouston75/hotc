...
class skin_profile_16 extends skinMaster{
...
{
$count_084d8c10e1b9cbd236a0543b39b798f6 = is_array($this->functionData['profileModern']) ? count($this->functionData['profileModern']) : 0;
$this->functionData['profileModern'][$count_084d8c10e1b9cbd236a0543b39b798f6]['tabs'] = $tabs;
$this->functionData['profileModern'][$count_084d8c10e1b9cbd236a0543b39b798f6]['member'] = $member;
$this->functionData['profileModern'][$count_084d8c10e1b9cbd236a0543b39b798f6]['visitors'] = $visitors;
$this->functionData['profileModern'][$count_084d8c10e1b9cbd236a0543b39b798f6]['default_tab'] = $default_tab;
$this->functionData['profileModern'][$count_084d8c10e1b9cbd236a0543b39b798f6]['default_tab_content'] = $default_tab_content;
$this->functionData['profileModern'][$count_084d8c10e1b9cbd236a0543b39b798f6]['friends'] = $friends;
$this->functionData['profileModern'][$count_084d8c10e1b9cbd236a0543b39b798f6]['status'] = $status;
$this->functionData['profileModern'][$count_084d8c10e1b9cbd236a0543b39b798f6]['warns'] = $warns;
}
...
<profileTabs>
	".$this->__f__1b5cb06881c431fab1d63e366393f26c($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns)."</profileTabs>") : ("
	{$default_tab_content}
")) . "";
return $IPBHTML;
}
...
function __f__1b5cb06881c431fab1d63e366393f26c($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
...
{
$count_93790e09bea873c2d867769a1eacbd89 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_93790e09bea873c2d867769a1eacbd89]['replies'] = $replies;
$this->functionData['statusReplies'][$count_93790e09bea873c2d867769a1eacbd89]['no_wrapper'] = $no_wrapper;
}
$IPBHTML .= "<commentReplies>
	".$this->__f__e43d52d72c9fd0d7e47c6bf4d840f8a2($replies,$no_wrapper)."</commentReplies>";
return $IPBHTML;
}


function __f__e43d52d72c9fd0d7e47c6bf4d840f8a2($replies=array(), $no_wrapper=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_23de5dbc16697863959b837f0aae5bca = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_23de5dbc16697863959b837f0aae5bca]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_23de5dbc16697863959b837f0aae5bca]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_23de5dbc16697863959b837f0aae5bca]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "<profileComments>".$this->__f__b9b73c914e6d9cdc57e2c2471385752d($updates,$smallSpace,$latestOnly)."</profileComments>";
return $IPBHTML;
}


function __f__b9b73c914e6d9cdc57e2c2471385752d($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e2a2d667a3159f73a413f00ec7393589 = is_array($this->functionData['tabFriends']) ? count($this->functionData['tabFriends']) : 0;
$this->functionData['tabFriends'][$count_e2a2d667a3159f73a413f00ec7393589]['friends'] = $friends;
$this->functionData['tabFriends'][$count_e2a2d667a3159f73a413f00ec7393589]['member'] = $member;
$this->functionData['tabFriends'][$count_e2a2d667a3159f73a413f00ec7393589]['pagination'] = $pagination;
}
$IPBHTML .= "<pagination>{$pagination}</pagination>
<friends>
	".$this->__f__ed457031c71a4fc78d1a02ce935ff1b3($friends,$member,$pagination)."</friends>";
return $IPBHTML;
}


function __f__ed457031c71a4fc78d1a02ce935ff1b3($friends=array(), $member=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a70eeca9afccfc4d0ef5521c5b9a987b = is_array($this->functionData['tabStatusUpdates']) ? count($this->functionData['tabStatusUpdates']) : 0;
$this->functionData['tabStatusUpdates'][$count_a70eeca9afccfc4d0ef5521c5b9a987b]['updates'] = $updates;
$this->functionData['tabStatusUpdates'][$count_a70eeca9afccfc4d0ef5521c5b9a987b]['actions'] = $actions;
$this->functionData['tabStatusUpdates'][$count_a70eeca9afccfc4d0ef5521c5b9a987b]['member'] = $member;
}
