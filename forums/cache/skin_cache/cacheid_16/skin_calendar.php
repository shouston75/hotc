...
class skin_calendar_16 extends skinMaster{
...
$this->_funcHooks['calendarBirthdayList'] = array('birthdays');
$this->_funcHooks['calendarMainContent'] = array('days');
$this->_funcHooks['mini_cal_mini_wrap'] = array('days');
...
$IPBHTML = "";
$IPBHTML .= "<li class='cal'><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$event['event_calendar_id']}&amp;do=showevent&amp;event_id={$event['event_id']}", "public",'' ), "", "" ) . "\" title='{$this->lang->words['view_event']}'>{$event['event_title']}</a></li>";
return $IPBHTML;
}
...
$IPBHTML = "";
$IPBHTML .= "<li class='cal'><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;{$url}", "public",'' ), "", "" ) . "\" title='{$this->lang->words['view_event']}'>{$text}</a></li>";
return $IPBHTML;
}
...
$IPBHTML .= "<div class=\"calranged\">
	<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$event['event_calendar_id']}&amp;do=showevent&amp;event_id={$event['event_id']}", "public",'' ), "", "" ) . "\" title='{$this->lang->words['view_event']}'>{$event['event_title']}</a>
</div>";
return $IPBHTML;
}
...
<!-- NEW ROW--><tr class='{$this->row_class}'>
	<th class='view_week' scope='row'>
		<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$this->request['_cal_id']}&amp;do=showweek&amp;week=$week", "public",'' ), "", "" ) . "\" title=\"{$this->lang->words['view_this_week']}\"><img src=\"{$this->settings['img_url']}/next.png\" alt='' /></a>
	</th>";
return $IPBHTML;
}
...
$IPBHTML = "";
$IPBHTML .= "<h2>Event: {$event['event_title']}</h2>
...
<div class='post_block " . (($event['event_approved']==0) ? ("moderated") : ("")) . " id='event_id_{$event['event_id']}'>
	<div class='post_wrap'>
		...
		") : ("
			<h3 class='guest'>
		")) . "" . (($member['member_id']) ? ("" . (($member['_online']) ? ("" . $this->registry->getClass('output')->getReplacement("user_online") . "") : ("" . $this->registry->getClass('output')->getReplacement("user_offline") . "")) . " &nbsp;
							<address class=\"author vcard\"><a class=\"url fn\" href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$member['member_id']}", "public",'' ), "", "" ) . "' title='{$this->lang->words['view_profile']}'>{$member['members_display_name']}</a>" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'user_popup' ) ? $this->registry->getClass('output')->getTemplate('global')->user_popup($member['member_id']) : '' ) . "</address>") : ("
					{$member['members_display_name']}
				")) . "
			</h3>
		<p class='posted_info'>
			<strong class='event'>{$this->lang->words['event_date']} {$event['_start_date']} $date_ends</b> {$event['time']} ($type)</strong>
		</p>
...
<div id='calendar_list' class='general_box'>
	...
	<ol>
		".$this->__f__5e7a180cdf4ee2c23d3dc9a38f39b8d8($calendars,$date,$month,$year,$prev,$next,$cal_id)."	</ol>
	") : ("")) . "
	<p>
...
<div id='current_calendar'>
	<div class='topic_controls'>
		<ul class='pagination'>
			<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$cal_id}&amp;do=showweek&amp;week={$prev['0']}", "public",'' ), "", "" ) . "\" title=\"{$prev['month_name']} {$prev['year_id']}\">{$this->lang->words['_larr']} {$this->lang->words['week_previous']}</a></li>
			<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$cal_id}&amp;do=showweek&amp;week={$next['0']}", "public",'' ), "", "" ) . "\" title=\"{$next['month_name']} {$next['year_id']}\">{$this->lang->words['week_next']} {$this->lang->words['_rarr']}</a></li>
		</ul>
	...
	<br />
	<h2>{$this->lang->words['week_beginning']} $date $month $year</h2>
	<ol id='week_view'>
		<!--IBF.DAYS_CONTENT-->
	</ol>
</div>
<div id='mini_calendars'>
	<!--PREV.MONTH-->
	<br />
	<!--THIS.MONTH-->	
	<br />
...
function __f__5e7a180cdf4ee2c23d3dc9a38f39b8d8($calendars, $date="",$month="",$year="",$prev="",$next="", $cal_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $calendars as $cid => $cal )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
			<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$cid}&amp;do=showweek&amp;week={$this->request['week']}", "public",'' ), "", "" ) . "' title=\"{$this->lang->words['view_this_calendar']}\">{$cal['cal_title']}</a></li>
...
$IPBHTML .= "<div class=\"divpad\">
	<b><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;$link", "public",'' ), "", "" ) . "\">$text</a></b>
</div>";
return $IPBHTML;
}
...
{
$count_8da8a9e522d72556fa729a8e3dd840d8 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_8da8a9e522d72556fa729a8e3dd840d8]['rows'] = $rows;
}
$IPBHTML .= "<div class=\"formsubtitle\">{$this->lang->words['cal_birthdays']}</div>
<div class=\"tablepad\">
	<ul>
	".$this->__f__094f3cbc1e65b6baeb13e30b1496aebe($rows)."	</ul>
</div>";
return $IPBHTML;
}


function __f__094f3cbc1e65b6baeb13e30b1496aebe($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$r['uid']}", "public",'' ), "", "" ) . "\">{$r['uname']}</a> ({$r['age']})</li>
...
<div class='post_form'>
<form id='postingform' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&amp;do={$code}&amp;cal_id={$calendar_id}&amp;formtype={$formtype}&amp;event_id={$event_id}", "public",'' ), "", "" ) . "\" method=\"post\" name=\"REPLIER\">
	...
	<fieldset>
		...
		<ul>
			<li>{$editor}</li>
			<li class='field checkbox'>
				<input type=\"checkbox\" name=\"enableemo\" class=\"input_check\" value=\"yes\" {$formData['checkBoxes']['emo']} />
...
{
$count_3f4496a19971afa296daf2f6982f3fbd = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_3f4496a19971afa296daf2f6982f3fbd]['calendars'] = $calendars;
$this->functionData['calendarMainContent'][$count_3f4496a19971afa296daf2f6982f3fbd]['month'] = $month;
$this->functionData['calendarMainContent'][$count_3f4496a19971afa296daf2f6982f3fbd]['year'] = $year;
$this->functionData['calendarMainContent'][$count_3f4496a19971afa296daf2f6982f3fbd]['prev'] = $prev;
$this->functionData['calendarMainContent'][$count_3f4496a19971afa296daf2f6982f3fbd]['next'] = $next;
$this->functionData['calendarMainContent'][$count_3f4496a19971afa296daf2f6982f3fbd]['cal_jump'] = $cal_jump;
$this->functionData['calendarMainContent'][$count_3f4496a19971afa296daf2f6982f3fbd]['cal_id'] = $cal_id;
$this->functionData['calendarMainContent'][$count_3f4496a19971afa296daf2f6982f3fbd]['day_words'] = $day_words;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<h2>{$this->lang->words['calendars']}</h2>
<div id='calendar_list' class='general_box'>
	...
	<p><strong>{$this->lang->words['select_calendar']}</strong></p>
	<ol>
		".$this->__f__99754e3a30d586e158a0b3ee08c365d8($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."	</ol>
	") : ("")) . "
...
<div id='current_calendar'>
	...
	<table id='calendar_table' class='ipb_table' summary=\"{$this->lang->words['calendar_for']} $month $year\">
		...
		<tr class='header'>
			...
			".$this->__f__ccea1bd71abc210d07fa58fa8a35bc6f($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."			<!--IBF.DAYS_CONTENT-->
		</tr>
	</table>
...
function __f__99754e3a30d586e158a0b3ee08c365d8($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $calendars as $cid => $cal )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
			<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$cid}", "public",'' ), "", "" ) . "' title=\"{$this->lang->words['view_this_calendar']}\">{$cal['cal_title']}</a></li>
...
function __f__ccea1bd71abc210d07fa58fa8a35bc6f($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9c2925a8c3d3a38f8ef13c85d4c78e96 = is_array($this->functionData['mini_cal_mini_wrap']) ? count($this->functionData['mini_cal_mini_wrap']) : 0;
$this->functionData['mini_cal_mini_wrap'][$count_9c2925a8c3d3a38f8ef13c85d4c78e96]['month'] = $month;
$this->functionData['mini_cal_mini_wrap'][$count_9c2925a8c3d3a38f8ef13c85d4c78e96]['mid'] = $mid;
$this->functionData['mini_cal_mini_wrap'][$count_9c2925a8c3d3a38f8ef13c85d4c78e96]['year'] = $year;
$this->functionData['mini_cal_mini_wrap'][$count_9c2925a8c3d3a38f8ef13c85d4c78e96]['events'] = $events;
$this->functionData['mini_cal_mini_wrap'][$count_9c2925a8c3d3a38f8ef13c85d4c78e96]['day_words'] = $day_words;
}
...
<table class='mini_cal'>
	...
	".$this->__f__47b5fc18d3f869bc8afcaea23f6cf0cd($month,$mid,$year,$events,$day_words)."	</tr>
	{$events}
</table>";
return $IPBHTML;
}
...
function __f__47b5fc18d3f869bc8afcaea23f6cf0cd($month="",$mid="",$year="",$events="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day_words as $day )
