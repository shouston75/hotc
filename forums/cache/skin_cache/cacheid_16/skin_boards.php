...
class skin_boards_16 extends skinMaster{
...
{
$count_a57a1aed4565baa60776a41ba1ef6890 = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_a57a1aed4565baa60776a41ba1ef6890]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_a57a1aed4565baa60776a41ba1ef6890]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_a57a1aed4565baa60776a41ba1ef6890]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_a57a1aed4565baa60776a41ba1ef6890]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_a57a1aed4565baa60776a41ba1ef6890]['side_blocks'] = $side_blocks;
}
...
" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		<categories>
		".$this->__f__3485ba4f86a608e02a349a8d76f7b55b($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</categories>
	") : ("")) . "
		<statistics>
...
function __f__11134d1312c07ace70f9334603c65f9d($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e7e3a4725ad62db46cf8693db5a21667($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
	{
		...
		$_ips___x_retval .= "
					<forum>
						...
						<subforums>
											".$this->__f__11134d1312c07ace70f9334603c65f9d($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."						</subforums>
						") : ("")) . "
					</forum>
...
function __f__3485ba4f86a608e02a349a8d76f7b55b($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			...
			<category>
				...
				<forums>
						".$this->__f__e7e3a4725ad62db46cf8693db5a21667($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."				</forums>
			</category>
			") : ("")) . "
