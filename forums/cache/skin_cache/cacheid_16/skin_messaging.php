...
class skin_messaging_16 extends skinMaster{
...
{
$count_9cc8da9621cf46e4adf0c2ff22041d37 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_9cc8da9621cf46e4adf0c2ff22041d37]['displayData'] = $displayData;
}
$IPBHTML .= "<postingForm>
...
{
$count_8740c3330b580294fa0ded269f5567e4 = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_8740c3330b580294fa0ded269f5567e4]['topic'] = $topic;
$this->functionData['showConversation'][$count_8740c3330b580294fa0ded269f5567e4]['replies'] = $replies;
$this->functionData['showConversation'][$count_8740c3330b580294fa0ded269f5567e4]['members'] = $members;
$this->functionData['showConversation'][$count_8740c3330b580294fa0ded269f5567e4]['jump'] = $jump;
}
...
<message>
	...
	".$this->__f__99c77fdd47baee8921635a76bb85becd($topic,$replies,$members,$jump)."</message>";
return $IPBHTML;
}


function __f__99c77fdd47baee8921635a76bb85becd($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8fce1ac482904929611a07ba6add98ba = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_8fce1ac482904929611a07ba6add98ba]['messages'] = $messages;
$this->functionData['showFolder'][$count_8fce1ac482904929611a07ba6add98ba]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_8fce1ac482904929611a07ba6add98ba]['pages'] = $pages;
$this->functionData['showFolder'][$count_8fce1ac482904929611a07ba6add98ba]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_8fce1ac482904929611a07ba6add98ba]['jumpFolderHTML'] = $jumpFolderHTML;
}
$IPBHTML .= "<template>popoverMessages</template>
<messages>
	".$this->__f__457076c26ad3bc3f1decaf1958390df1($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."</messages>";
return $IPBHTML;
}


function __f__457076c26ad3bc3f1decaf1958390df1($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
