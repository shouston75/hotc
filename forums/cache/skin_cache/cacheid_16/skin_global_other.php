...
class skin_global_other_16 extends skinMaster{
...
{
$count_de8ee542f2504513e59896986602ebca = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_de8ee542f2504513e59896986602ebca]['notifications'] = $notifications;
}
$IPBHTML .= "<template>popoverNotifications</template>
<notifications>
	".$this->__f__2747be6ac8cedeb9b0c9b5f587ba9916($notifications)."</notifications>";
return $IPBHTML;
}


function __f__2747be6ac8cedeb9b0c9b5f587ba9916($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_61bf275dd4f5b674445c42153a09f35d = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_61bf275dd4f5b674445c42153a09f35d]['member'] = $member;
$this->functionData['repButtons'][$count_61bf275dd4f5b674445c42153a09f35d]['data'] = $data;
}
