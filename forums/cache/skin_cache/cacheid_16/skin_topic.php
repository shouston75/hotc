...
class skin_topic_16 extends skinMaster{
...
{
$count_08251174823d29214bfb1539fa34cde2 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_08251174823d29214bfb1539fa34cde2]['post'] = $post;
$this->functionData['post'][$count_08251174823d29214bfb1539fa34cde2]['displayData'] = $displayData;
$this->functionData['post'][$count_08251174823d29214bfb1539fa34cde2]['topic'] = $topic;
$this->functionData['post'][$count_08251174823d29214bfb1539fa34cde2]['forum'] = $forum;
}
$IPBHTML .= "<post>
					<id>{$post['post']['pid']}</id>
...
{
$count_de20d13dda321965e513574c710a22d0 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_de20d13dda321965e513574c710a22d0]['title'] = $title;
$this->functionData['show_attachment_title'][$count_de20d13dda321965e513574c710a22d0]['data'] = $data;
$this->functionData['show_attachment_title'][$count_de20d13dda321965e513574c710a22d0]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__f2bc0f900e4c96b7d82e602a5c98ea1c($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__f2bc0f900e4c96b7d82e602a5c98ea1c($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_49c73e770664c8bd8c4ac566e220c67e = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_49c73e770664c8bd8c4ac566e220c67e]['data'] = $data;
}
...
{
$count_d4e70a61e24cac3ddfd8baf39e6920b8 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_d4e70a61e24cac3ddfd8baf39e6920b8]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_d4e70a61e24cac3ddfd8baf39e6920b8]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_d4e70a61e24cac3ddfd8baf39e6920b8]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_d4e70a61e24cac3ddfd8baf39e6920b8]['displayData'] = $displayData;
}
...
") : ("")) . "
		...
		<topic>
			...
			<posts>				
" . ((is_array( $post_data ) AND count( $post_data )) ? ("".$this->__f__6ff8bf89042566565a96cf3f1a867f9f($forum,$topic,$post_data,$displayData)."") : ("")) . "
			</posts>
		</topic>
	</forum>";
return $IPBHTML;
...
function __f__6ff8bf89042566565a96cf3f1a867f9f($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
