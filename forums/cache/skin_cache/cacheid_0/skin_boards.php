...
<div id='board_index' class='clearfix'>
	" . (($this->templateVars['sidebar_enabled']) ? ("<div id='index_stats' class='right clearfix' " . ((IPSCookie::get('hide_sidebar') == '1') ? ("style='display: none'") : ("")) . ">
			".$this->__f__ba09fde96c56e8708d40259438565212($lastvisit,$stats,$calendar_events,$birthdays,$chat_html,$news_data,$cat_data,$show_side_blocks,$side_blocks)."		</div>") : ("")) . "
	...
	<!-- CATS AND FORUMS -->
		" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
			".$this->__f__574e6ec18ba9517df7e095737ff3609b($lastvisit,$stats,$calendar_events,$birthdays,$chat_html,$news_data,$cat_data,$show_side_blocks,$side_blocks)."		") : ("")) . "
	</div>
</div>
...
function __f__ba09fde96c56e8708d40259438565212($lastvisit="", $stats=array(), $calendar_events=FALSE, $birthdays=FALSE, $chat_html='', $news_data=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
...
function __f__8fde95de62c130c972bb84def4ae6c83($lastvisit="", $stats=array(), $calendar_events=FALSE, $birthdays=FALSE, $chat_html='', $news_data=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
...
function __f__90c4380b2fad1c833f0d425a05b69d9f($lastvisit="", $stats=array(), $calendar_events=FALSE, $birthdays=FALSE, $chat_html='', $news_data=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
								...
								") : ("<tr class='" .  IPSLib::next( $this->registry->templateStriping["catTable"] ) . "'>
										...
										<td>
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												...
												<ol class='subforums'>
												".$this->__f__8fde95de62c130c972bb84def4ae6c83($lastvisit,$stats,$calendar_events,$birthdays,$chat_html,$news_data,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."												</ol>
											") : ("")) . "
...
function __f__574e6ec18ba9517df7e095737ff3609b($lastvisit="", $stats=array(), $calendar_events=FALSE, $birthdays=FALSE, $chat_html='', $news_data=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
		...
		$_ips___x_retval .= "
				" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
						...
						<table class='ipb_table' summary=\"{$this->lang->words['forums_in_cat']} '{$_data['cat_data']['name']}'\">
							...
							<!-- / CAT HEADER -->
							".$this->__f__90c4380b2fad1c833f0d425a05b69d9f($lastvisit,$stats,$calendar_events,$birthdays,$chat_html,$news_data,$cat_data,$show_side_blocks,$side_blocks,$_data)."						</table>
					</div>
				") : ("")) . "
...
$IPBHTML .= "<div class='general_box clearfix'>
	...
	<ul class='hfeed block_list'>
		" . ((is_array( $rows ) && count( $rows )) ? ("
						".$this->__f__c2125cb06cf7256661a8c04edd8f729b($rows)."		") : ("
...
function __f__c2125cb06cf7256661a8c04edd8f729b($rows)
{
	$_ips___x_retval = '';
	foreach( $rows as $r )
	{
...
$IPBHTML .= "<div class='general_box clearfix'>
		...
		<ul class='hfeed block_list'>
			" . ((is_array( $entries ) && count( $entries )) ? ("
								".$this->__f__39c74a20c0cf5b7554da927fd8fdf446($entries)."			") : ("
...
function __f__39c74a20c0cf5b7554da927fd8fdf446($entries)
{
	$_ips___x_retval = '';
...
<div id='attach_wrap' class='rounded clearfix'>
	<ul>
	".$this->__f__7fdafb1aedc066b4cc4e184e220fd5a1($rows)."	</ul>
</div>
<br style='clear:both;' />";
return $IPBHTML;
}
...
function __f__7fdafb1aedc066b4cc4e184e220fd5a1($rows)
{
	$_ips___x_retval = '';
	foreach( $rows as $r )
	{
...
$IPBHTML .= "<div class='general_box clearfix'>
		...
		<ul class='hfeed block_list'>
			" . ((is_array( $topics ) && count( $topics )) ? ("
								".$this->__f__1d16e272a4420e4a7723e2c4f457a5b8($topics)."			") : ("
...
function __f__1d16e272a4420e4a7723e2c4f457a5b8($topics)
{
	$_ips___x_retval = '';
	foreach( $topics as $r )
	{
...
$IPBHTML .= "<div class='general_box clearfix'>
		<h3><img src='{$this->settings['img_url']}/user_comment.png' alt='{$this->lang->words['icon']}' /> {$this->lang->words['todays_top_posters']}</h3>
			" . ((is_array($posters) AND count($posters)) ? ("
				...
				".$this->__f__0d6a925eef9083f9bc4aed41b85d930e($posters)."			</ol>
			") : ("")) . "
	</div>";
return $IPBHTML;
}
...
function __f__0d6a925eef9083f9bc4aed41b85d930e($posters)
{
	$_ips___x_retval = '';
		...
		<div class='recent_activity'>
			...
			<div id='tab_content_forums' class='tab_toggle_content'>
				" . ((is_array( $updatedForums ) && count( $updatedForums )) ? ("
					<ul class='clearfix'>
												".$this->__f__f1c1c4a8f4b84b9bfde7bf43ad123623($updatedTopics,$nUpdatedTopics,$updatedForums,$nUpdatedForums)."					</ul>
				") : ("<ul class='clearfix'>
				...
				" . ((is_array( $nUpdatedForums ) && count( $nUpdatedForums )) ? ("
					<div id='more-watched-forums-container' style='display:none;'>
						<ul>
							".$this->__f__22006070811d8aca6a42bae8f22fa9c5($updatedTopics,$nUpdatedTopics,$updatedForums,$nUpdatedForums)."						</ul>
					</div>
			...
			<div id='tab_content_topics' class='tab_toggle_content' style='display:none;'>
					...
					<ul class='hfeed'>
						".$this->__f__0cef6ff5c7e739a903dea5c6ee31d976($updatedTopics,$nUpdatedTopics,$updatedForums,$nUpdatedForums)."					</ul>
				...
				" . ((is_array( $nUpdatedTopics ) && count( $nUpdatedTopics )) ? ("
					<div id='more-watched-topics-container' style='display:none;'>
						<ul class='hfeed'>
							".$this->__f__1a7e903b87c172bce421a970372b550d($updatedTopics,$nUpdatedTopics,$updatedForums,$nUpdatedForums)."						</ul>
					</div>
					<fieldset class='submit'>
...
function __f__f1c1c4a8f4b84b9bfde7bf43ad123623($updatedTopics, $nUpdatedTopics, $updatedForums, $nUpdatedForums)
{
	$_ips___x_retval = '';
...
function __f__22006070811d8aca6a42bae8f22fa9c5($updatedTopics, $nUpdatedTopics, $updatedForums, $nUpdatedForums)
{
	$_ips___x_retval = '';
...
function __f__0cef6ff5c7e739a903dea5c6ee31d976($updatedTopics, $nUpdatedTopics, $updatedForums, $nUpdatedForums)
{
	$_ips___x_retval = '';
...
function __f__1a7e903b87c172bce421a970372b550d($updatedTopics, $nUpdatedTopics, $updatedForums, $nUpdatedForums)
{
	$_ips___x_retval = '';
