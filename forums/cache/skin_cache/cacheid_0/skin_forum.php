...
<table class='ipb_table'>
	<tr class='header'>
		...
		".$this->__f__1f218b68cce4597a3961b6f016a8d9ac($title,$rows)."</table>";
return $IPBHTML;
}


function __f__1f218b68cce4597a3961b6f016a8d9ac($title, $rows)
{
	$_ips___x_retval = '';
...
" . ((is_array( $sub_forum_data ) AND count( $sub_forum_data )) ? ("
	<div class='category_block block_wrap'>
		...
		<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$data['name']}'\">
			...
			".$this->__f__abbae55fd8069288b0fc93b76c2e3a8e($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		</table>
	</div>
	<br />
") : ("")) . "
" . (($forum_data['sub_can_post']) ? ("<div class='topic_controls'>
	...
	<div class='category_block block_wrap'>
		<table class='ipb_table topic_list' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
			...
			<!-- ANNOUNCEMENTS -->
			" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("".$this->__f__86307831c071a038034e9a75549bb78e($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				<tr class='subhead altbar'>
			...
			" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
								".$this->__f__a5a355136061d5e0b28bdbaf23bb9bb1($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			") : ("<tr> 
					" . (($this->memberData['is_mod'] == 1) ? ("
					...
					<fieldset>
						...
						<select name=\"tact\" id='mod_tact'>
							...
							" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
								...
								<option value=\"-1\">------------------------------</option>
								".$this->__f__99afbbb896cfe6dbba5ee2874e4468ad($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."							") : ("")) . "
						</select>&nbsp;
	...
	<div id='forum_footer' class='statistics general_box clear clearfix'>
		...
		" . ((!$this->settings['no_au_forum']) ? ("<div id='forum_active_users' class='active_users stats_list'>
				...
				<ul>
					" . ((is_array( $active_user_data['names'] ) AND count( $active_user_data['names'] )) ? ("
						".$this->__f__147e567a8002c049422e07a39982835e($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."					") : ("")) . "
				</ul>
			</div>") : ("")) . "
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='active_users stats_list'>
				...
				<ul>
					".$this->__f__d3aefdbe01ea6254ddfc60ed2d78c05c($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</ul>
			</div>
		") : ("")) . "
	</div>
	<br class='clear' />") : ("")) . "";
...
function __f__48afd28c3e41c9f16c55e2651191e9af($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
...
function __f__cd6adb14aed9a071d2766153d84cf069($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
						...
						") : ("<tr class='" .  IPSLib::next( $this->registry->templateStriping["catTable"] ) . "'>
								...
								<td>
									...
									" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
										...
										<ol class='subforums'>
										".$this->__f__48afd28c3e41c9f16c55e2651191e9af($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."										</ol>
									") : ("")) . "
...
function __f__abbae55fd8069288b0fc93b76c2e3a8e($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
...
$this->registry->templateStriping['catTable'] = array( FALSE, "row1","row2");
		...
		$_ips___x_retval .= "
				" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
										".$this->__f__cd6adb14aed9a071d2766153d84cf069($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."				") : ("")) . "
...
function __f__86307831c071a038034e9a75549bb78e($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
...
function __f__72c4bff0fb94644ebefc26271559d9f5($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$tid='',$data='')
{
	$_ips___x_retval = '';
...
function __f__a5a355136061d5e0b28bdbaf23bb9bb1($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	foreach( $topic_data as $tid => $data )
	{
		...
		$_ips___x_retval .= "
					...
					")) . "
						<td class='short altrow'>" . $this->registry->getClass('output')->getReplacement("{$data['folder_img']}") . "<!--<img src='{$this->settings['img_url']}/topic_icon.png' alt='icon' />--></td>
						<!--<td class='altrow short'><img src='../images_new/topic_icon.gif' alt='icon' /></td>-->
						<td " . (($this->memberData['is_mod'] == 1) ? ("class='with_mod_links'") : ("")) . ">
							...
							" . ((isset( $this->memberData['_cache']['report_temp']['post_marker']['topic'][$data['tid']]['gfx'] ) AND $this->memberData['_cache']['report_temp']['post_marker']['topic'][$data['tid']]['gfx'] > 0) ? ("
								<a href=\"{$this->settings['base_url']}app=core&amp;module=reports&amp;section=reports&amp;do=findfirst&amp;tid={$data['tid']}&amp;cid={$this->memberData['_cache']['report_temp']['post_marker']['topic'][$data['tid']]['info']['com_id']}\"> <img src=\"{$this->settings['img_url']}/reports/post_alert_{$this->memberData['_cache']['report_temp']['post_marker']['topic'][$data['tid']]['gfx']}.png\" alt='{$this->lang->words['icon']}' title='{$this->lang->words['view_reported_posts']}' /> </a>
							") : ("")) . "
							...
							" . (($data['topic_hasattach']) ? ("
								...
								<a href=\"{$this->settings['base_url']}app=forums&amp;module=forums&amp;section=attach&amp;tid={$data['tid']}\" title=\"" . intval($data['topic_hasattach']) . " {$this->lang->words['topic_attach']}\" onclick=\"return ipb.forums.retrieveAttachments( {$data['tid']} );\">" . $this->registry->getClass('output')->getReplacement("t_attach") . "</a>
							") : ("")) . "
							...
							" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
								...
								".$this->__f__72c4bff0fb94644ebefc26271559d9f5($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$tid,$data)."								</ul>
							") : ("")) . "
					...
					" . (($this->memberData['is_mod'] AND $data['_hasqueued']) ? ("<td class='stats moderated'>
						...
						" . (($this->memberData['is_mod'] == 1 and $inforum == 1 and $data['tidon'] == 0) ? ("
						<td class='short'><input type='checkbox' class='input_check topic_mod' id='tmod_{$data['real_tid']}' /></td>
						") : ("")) . "
					</tr>
...
function __f__99afbbb896cfe6dbba5ee2874e4468ad($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
...
function __f__147e567a8002c049422e07a39982835e($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
...
function __f__d3aefdbe01ea6254ddfc60ed2d78c05c($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
...
$IPBHTML = "";
$IPBHTML .= "<span class='mini_rate'>".$this->__f__66ed5b4bad54a23deb0b9774fff219d5($rating_id)."</span>";
return $IPBHTML;
}


function __f__66ed5b4bad54a23deb0b9774fff219d5($rating_id=1)
{
	$_ips___x_retval = '';
