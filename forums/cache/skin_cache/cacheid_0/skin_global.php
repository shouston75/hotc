...
$IPBHTML = "";
$IPBHTML .= "<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", 'public','' ), "false", "" ) . "' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'><img src='" . $this->registry->getClass('output')->getReplacement("logo_img") . "' alt='{$this->lang->words['logo']}' /></a>";
return $IPBHTML;
}
			...
			<div id='header'>
						...
						<div id='user_info'>
							...
							<ul id='user_link_menucontent'>
								...
								" . (($this->memberData['g_use_pm'] AND $this->memberData['members_disable_pm'] == 0) ? ("
									<li id='user_msg'><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=messaging", 'public','' ), "", "" ) . "' title='{$this->lang->words['your_messenger']}'>{$this->lang->words['your_messenger']} <span id='new_message'>({$this->memberData['msg_count_new']} {$this->lang->words['msg_new']})</span></a></li>
								") : ("")) . "
								...
								<li id='user_enemies'><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=members&amp;area=ignoredusers", 'public','' ), "", "" ) . "' title=\"{$this->lang->words['manage_ignored_users']}\" class='manage_enemies'>{$this->lang->words['manage_ignored_users']}</a></li>
				...
				<div id='primary_nav'>
					...
					<ul>
						...
						" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
							".$this->__f__8eba30f3706a8342c1d0a9896f613845($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						") : ("")) . "
					</ul>
				</div>
				...
				<div id='secondary_nav'>
					<ul id='breadcrumb' class='left'>
							...
							" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
						".$this->__f__6a6b545f21c9c1c8a0366c01fadfe29a($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."					</ul>
					<ul id='section_links' class='right'>
						...
						<li><a href='{$this->settings['base_url']}app=core&amp;module=search&amp;do=new_posts&amp;search_filter_app[" . (($this->registry->getCurrentApplication() != 'core' AND IPSSearchIndex::appIsSearchable( $this->registry->getCurrentApplication() )) ? ("{$this->registry->getCurrentApplication()}") : ("forums")) . "]=1' accesskey='2'>{$this->lang->words['view_new_posts']}</a></li>
...
function __f__8eba30f3706a8342c1d0a9896f613845($html, $documentHeadItems, $css, $jsModules, $metaTags, $header_items=array(), $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
...
function __f__6a6b545f21c9c1c8a0366c01fadfe29a($html, $documentHeadItems, $css, $jsModules, $metaTags, $header_items=array(), $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
...
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__46e16733ce54a53386ceae7bb6f0fa8d($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__c67cb9324fc717261277bdc4611a5a6c($css)."") : ("")) . "
<!--[if lte IE 7]>
...
function __f__46e16733ce54a53386ceae7bb6f0fa8d($css)
{
	$_ips___x_retval = '';
...
function __f__c67cb9324fc717261277bdc4611a5a6c($css)
{
	$_ips___x_retval = '';
...
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__8c8c0bb4edace6e190d2c4ae77c7037a($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__e035f42a2c7fe746375ad9efbfbe3b3f($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
...
function __f__8c8c0bb4edace6e190d2c4ae77c7037a($documentHeadItems)
{
	$_ips___x_retval = '';
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$_ips___x_retval .= "
		".$this->__f__e035f42a2c7fe746375ad9efbfbe3b3f($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	return $_ips___x_retval;
...
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__c56c6c5fdfae191e76f10ce817e23909($metaTags)."") : ("")) . "";
return $IPBHTML;
}


function __f__c56c6c5fdfae191e76f10ce817e23909($metaTags)
{
	$_ips___x_retval = '';
...
$IPBHTML .= "".$this->__f__b522e169369d1f6f06ca6ff52712eab9()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__b522e169369d1f6f06ca6ff52712eab9()
{
	$_ips___x_retval = '';
...
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<ul class='pagination left'>
		...
		" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
			".$this->__f__a0b14ace5d09e45356ad23183f2f770b($work,$data)."		") : ("")) . "
...
function __f__a0b14ace5d09e45356ad23183f2f770b($work, $data)
{
	$_ips___x_retval = '';
...
$IPBHTML .= "<ul class='user_details'>
	...
	<dl class='clearfix'>
		...
		" . (($author['member_id']) ? ("
			...
			<dd>" . $this->registry->getClass('class_localization')->formatNumber( intval( $author['posts'] ) ) . "</dd>
			<dt>{$this->lang->words['m_joined']}</dt>
			<dd>" . $this->registry->getClass('class_localization')->getDate($author['joined'],"joined", 0) . "</dd>
		") : ("")) . "
	
		" . (($author['custom_fields'] != "") ? ("
			".$this->__f__610e1c71aa12317d184568cddb74b811($author,$contentid,$options)."		") : ("")) . "
	</dl>
...
function __f__2a8899a247bf1d7ce76152376e494a5a($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
...
function __f__610e1c71aa12317d184568cddb74b811($author, $contentid, $options)
{
	$_ips___x_retval = '';
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$_ips___x_retval .= "
				".$this->__f__2a8899a247bf1d7ce76152376e494a5a($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	return $_ips___x_retval;
