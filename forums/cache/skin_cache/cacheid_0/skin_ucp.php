...
$IPBHTML .= "<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__df8c2f2e5bfb7531023761cb73efb779($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__df8c2f2e5bfb7531023761cb73efb779($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
					...
					<tr id=\"a{$data['attach_id']}\" class='" .  IPSLib::next( $this->registry->templateStriping["attach"] ) . "'>
							<td class='short altrow'>
								" . (($data['attach_thumb_location']) ? ("
									<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;section=attach&amp;module=attach&amp;type={$data['_type']}&amp;attach_id={$data['attach_id']}&amp;attach_rel_id={$data['attach_rel_id']}", 'public','' ), "", "" ) . "\" title=\"{$data['attach_file']}\"><img src=\"{$this->settings['upload_url']}/{$data['attach_thumb_location']}\" width=\"30\" height=\"30\" alt='{$this->lang->words['attached_file']}' /></a>
								") : ("
									<img src=\"{$this->settings['mime_img']}/{$data['image']}\" alt=\"{$this->lang->words['attached_file']}\" />
								")) . "
							</td>
							<td>
								<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;section=attach&amp;module=attach&amp;type={$data['_type']}&amp;attach_id={$data['attach_id']}&amp;attach_rel_id={$data['attach_rel_id']}", 'public','' ), "", "" ) . "\" title=\"{$data['attach_file']}\">{$data['short_name']}</a><br />
	...
	<ul>
		...
		<li class='field'>
			...
			<select name=\"postpage\" class='input_select' id='posts_per_page'>
				...
				".$this->__f__7b3a65fa043b87e57e47f4cc3ce28225($emailData,$data)."			</select>
		</li>
		<li class='field'>
			...
			<select name=\"topicpage\" class='input_select' id='topics_per_page'>
				<option value='-1'>{$this->lang->words['pp_use_default']}</option>
				".$this->__f__375a6134417684120b24d19288746ccf($emailData,$data)."			
			</select>
		</li>
	</ul>
</fieldset>
...
function __f__7b3a65fa043b87e57e47f4cc3ce28225($emailData, $data)
{
	$_ips___x_retval = '';
...
function __f__375a6134417684120b24d19288746ccf($emailData, $data)
{
	$_ips___x_retval = '';
...
$_count = 0;
$IPBHTML .= "<div class='clear'>".$this->__f__8d8d7265f13b8a2365d7117cfe140365($images,$dir)."</div>";
return $IPBHTML;
}


function __f__8d8d7265f13b8a2365d7117cfe140365($images=array(), $dir)
{
	$_ips___x_retval = '';
...
$IPBHTML .= "".$this->__f__95f3559b20fdd7dfa9f93e7c9f340f91($times)."" . (($this->hasOpenID) ? ("
	<fieldset class='row2'>
...
<fieldset class='row2'>
	...
	<ul>
		<li class='field'>
			...
			".$this->__f__0b5e6eba0920c8e6033be963ce3e52e1($times)."			</select>
...
function __f__95f3559b20fdd7dfa9f93e7c9f340f91($times)
{
	$_ips___x_retval = '';
...
function __f__0b5e6eba0920c8e6033be963ce3e52e1($times)
{
	$_ips___x_retval = '';
	...
	<ul>
		<li>
			...
			<select name='avatar_gallery' id='avatarCategory' class='input_select'>
				...
				".$this->__f__ff29847bf8710e8a4879c3071baf7b23($data)."			</select>
...
function __f__ff29847bf8710e8a4879c3071baf7b23($data="")
{
	$_ips___x_retval = '';
			...
			<fieldset class='row1'>
				...
				" . ((strstr( $this->memberData['email'], '@proxymail.facebook.com' )) ? ("
					<div class='message'>
						...
						<p>{$this->lang->words['fb_disassociate_info_1']} <a href='{$this->settings['base_url']}app=core&amp;module=usercp&amp;tab=core&amp;area=email'>{$this->lang->words['fb_disassociate_info_2']}</a> {$this->lang->words['fb_disassociate_info_3']}
						</p>
					</div>
					<br />
				") : ("")) . "
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__f47b1a3e492e588b4386d4af7cddbba6($members)."	</table>
</fieldset>
<fieldset class=\"row2\">
...
function __f__f47b1a3e492e588b4386d4af7cddbba6($members)
{
	$_ips___x_retval = '';
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__e7e8aeaacab12b24734f26d375e364d4($pages,$members)."	") : ("")) . "
</table>
<br />
<div class='topic_controls'>
	{$pages}
...
function __f__e7e8aeaacab12b24734f26d375e364d4($pages="",$members)
{
	$_ips___x_retval = '';
...
<br />
" . ((count($results)) ? ("
		".$this->__f__73bdfb2bf565ea11c9a57eb5a2a78ce6($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__73bdfb2bf565ea11c9a57eb5a2a78ce6($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	...
	<ul>
		...
		" . (($day AND $mon AND $year) ? ("
			<li class='field'>
				...
				<select name=\"month\">&nbsp;
					".$this->__f__7764b937c1b917878f15a51c76266edf($personal_statement,$required_output,$optional_output,$day,$mon,$year)."				</select>			
				<select name=\"day\">&nbsp;
					".$this->__f__2f5ac14b34856bca86e36b1827e002d7($personal_statement,$required_output,$optional_output,$day,$mon,$year)."				</select> 
				<select name=\"year\">&nbsp;
					".$this->__f__9d950a48c66659c82dcfe349f111b948($personal_statement,$required_output,$optional_output,$day,$mon,$year)."				</select> <br />
...
function __f__7764b937c1b917878f15a51c76266edf($personal_statement='',$required_output='',$optional_output='',$day='',$mon='',$year='')
{
	$_ips___x_retval = '';
	foreach( $mon as $m )
	{
...
function __f__2f5ac14b34856bca86e36b1827e002d7($personal_statement='',$required_output='',$optional_output='',$day='',$mon='',$year='')
{
	$_ips___x_retval = '';
	foreach( $day as $d )
	{
...
function __f__9d950a48c66659c82dcfe349f111b948($personal_statement='',$required_output='',$optional_output='',$day='',$mon='',$year='')
{
	$_ips___x_retval = '';
	foreach( $year as $y )
	{
...
<fieldset class='submit'>
	<input type=\"submit\" value=\"{$button}\" class=\"input_submit alt\" tabindex=\"7\" /> {$this->lang->words['or']} <a href='{$this->settings['base_url_with_app']}module=usercp&amp;tab=forums&amp;area=mod_announcements' title='{$this->lang->words['cancel_edit']}' class='cancel'>{$this->lang->words['cancel']}</a>
</fieldset>
</form>";
return $IPBHTML;
}
...
<fieldset class='row1'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__b79b9a988fe3c56b7a656658d629f263($announcements)."		") : ("
			<tr>
...
function __f__9ebfedd6460e81359ff4ae31b3091256($announcements,$announce='')
{
	$_ips___x_retval = '';
...
function __f__b79b9a988fe3c56b7a656658d629f263($announcements)
{
	$_ips___x_retval = '';
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("" . ((count( $announce['_forums'] ) > 5) ? ("
									...
									") : ("
										<ul>
										".$this->__f__9ebfedd6460e81359ff4ae31b3091256($announcements,$announce)."										</ul>
									")) . "") : ("")) . "")) . "
						</div>
					</td>
					<td class=\"short\">
						...
						&middot; <a href=\"{$this->settings['base_url']}app=core&amp;module=usercp&amp;tab=forums&amp;area=modDeleteAnnouncement&amp;do=edit&amp;announce_id={$announce['announce_id']}\" id=\"del_{$announce['announce_id']}\">{$this->lang->words['announce_delete']}</a>
						<script type='text/javascript'>
...
<ul class='tab_bar no_title'>
	".$this->__f__faba50b5106c33c4a32061cd2275358a($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."</ul>
<div class='tab_body usercp_body'>
	<ul id='usercp_menu'>
		" . ((is_array( $tabs[ $current_tab ]['_menu'] ) AND count( $tabs[ $current_tab ]['_menu'] )) ? ("
			".$this->__f__ea09ee04afa8755480193a459ab3ae82($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."		") : ("")) . "
	</ul>
	<div id='usercp_content'>
		" . ((is_array( $errors ) AND count( $errors )) ? ("
			<p class='message error'>
				".$this->__f__6987f2fc1a37696394f45d8ae32ed8f7($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."			</p>
		") : ("")) . "
...
function __f__faba50b5106c33c4a32061cd2275358a($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
...
function __f__ea09ee04afa8755480193a459ab3ae82($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
...
function __f__6987f2fc1a37696394f45d8ae32ed8f7($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
...
<fieldset class='row1'>
	...
	") : ("
		<h3>{$this->lang->words['subs_c_title']} {$this->lang->words['subs_for']} {$forum['name']}</h3>
		<br />
...
<fieldset class='submit'>
	<input type=\"submit\" value=\"{$this->lang->words['subs_submit']}\" class=\"input_submit\" /> or
	" . (($topic['tid'] != '') ? ("
...
<div class='row1'>
	...
	" . ((is_array( $forumArray ) AND count( $forumArray )) ? ("
		".$this->__f__61534a4edb260abcba9511f1ee9676b4($forumArray)."	") : ("
...
function __f__52da8dd83022149d63918b103e0fc677($forumArray,$parentID='',$catData='')
{
	$_ips___x_retval = '';
...
function __f__61534a4edb260abcba9511f1ee9676b4($forumArray)
{
	$_ips___x_retval = '';
			...
			<table class='ipb_table' summary=\"{$this->lang->words['ucp_watched_forums']}\">
				<tr class='header'>
					...
					<th scope='col' align=\"center\" width=\"5%\" class='short'><input id=\"checkAllForums_{$parentID}\" type=\"checkbox\" value=\"{$this->lang->words['check_all']}\" /><!-- SKINNOTE: add check all functionality back --></th>
								...
								".$this->__f__52da8dd83022149d63918b103e0fc677($forumArray,$parentID,$catData)."			</table>
			<script type='text/javascript'>
...
$IPBHTML .= "<fieldset class='row1'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		...
		" . ((is_array( $mainForumArray ) AND count( $mainForumArray )) ? ("
			".$this->__f__dfefef52c459f7bb061b4fd941c6b039($mainForumArray,$dateCut)."		") : ("
			<tr>
...
<div class='filter_bar rounded'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=forums&amp;area=topicsubs", 'public','' ), "", "" ) . "\" method=\"post\">
		<fieldset>
			...
			".$this->__f__90a223a97fb44e27b067ff1eb912407d($mainForumArray,$dateCut)."			" . (($dateCut == 1000) ? ("
...
function __f__dae4064206ffe97aa3228c3b43c10ffe($mainForumArray, $dateCut,$id='',$data='')
{
	$_ips___x_retval = '';
...
function __f__dfefef52c459f7bb061b4fd941c6b039($mainForumArray, $dateCut)
{
	$_ips___x_retval = '';
...
$this->registry->templateStriping['topics'] = array( FALSE, "row1","row2");
		...
		$_ips___x_retval .= "
				...
				" . ((is_array( $mainForumArray[ $id ]['_topics'] )) ? ("
										".$this->__f__dae4064206ffe97aa3228c3b43c10ffe($mainForumArray,$dateCut,$id,$data)."				") : ("")) . "
...
function __f__90a223a97fb44e27b067ff1eb912407d($mainForumArray, $dateCut)
{
	$_ips___x_retval = '';
