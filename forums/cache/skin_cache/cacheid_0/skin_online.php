...
<table class='ipb_table' summary=\"{$this->lang->words['users_online']}\">
	...
	" . ((count($rows)) ? ("
				".$this->__f__86a9aaf27fba18eee95a5bffa451d11b($rows,$links,$defaults,$our_mgroups)."	") : ("")) . "
</table>
<div id='forum_filter' class='filter_bar rounded'>
	<form method=\"post\" action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;section=online&amp;module=online", 'public','' ), "", "" ) . "\">
		...
		<select name=\"sort_key\" id='sort_key' class='input_select'>
			".$this->__f__2dfe77441b156f9262864ed53f9e7ee8($rows,$links,$defaults,$our_mgroups)."		</select>
		<select name=\"show_mem\" class='input_select'>
			".$this->__f__f031b5984ac6d76274f9b82b5c43482e($rows,$links,$defaults,$our_mgroups)."		</select>
		<select name=\"sort_order\" class='input_select'>
			".$this->__f__1caeeb079c669b7e8abf1317a7d62bfb($rows,$links,$defaults,$our_mgroups)."		</select>
...
function __f__86a9aaf27fba18eee95a5bffa451d11b($rows, $links="", $defaults=array(), $our_mgroups=array())
{
	$_ips___x_retval = '';
...
function __f__2dfe77441b156f9262864ed53f9e7ee8($rows, $links="", $defaults=array(), $our_mgroups=array())
{
	$_ips___x_retval = '';
...
function __f__f031b5984ac6d76274f9b82b5c43482e($rows, $links="", $defaults=array(), $our_mgroups=array())
{
	$_ips___x_retval = '';
...
function __f__1caeeb079c669b7e8abf1317a7d62bfb($rows, $links="", $defaults=array(), $our_mgroups=array())
{
	$_ips___x_retval = '';
