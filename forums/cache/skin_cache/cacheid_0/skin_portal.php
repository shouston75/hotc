...
$IPBHTML = "";
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "".$this->__f__71f4f3c7c045602d62fa9bd7decd6800($articles)."";
return $IPBHTML;
}


function __f__71f4f3c7c045602d62fa9bd7decd6800($articles)
{
	$_ips___x_retval = '';
...
$IPBHTML .= "<div class='general_box'>
	...
	<ul class='hfeed'>
				".$this->__f__e810e09207ead6fec55fb331b92acfd9($posts)."	</ul>
</div>
<br />";
return $IPBHTML;
}
...
function __f__e810e09207ead6fec55fb331b92acfd9($posts=array())
{
	$_ips___x_retval = '';
...
$IPBHTML .= "<div class='general_box'>
	...
	<ul>
		".$this->__f__7f3bcab71c12d5d6eefcabd45c8465f2($links)."	</ul>
</div>
<br />";
return $IPBHTML;
}
...
function __f__7f3bcab71c12d5d6eefcabd45c8465f2($links=array())
{
	$_ips___x_retval = '';
