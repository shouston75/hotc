...
$IPBHTML .= "<!--
	<tr>
  		<td colspan=\"2\" class=\"formsubtitle\">{$this->lang->words['cf_optional']}</td>
	</tr>
-->";
return $IPBHTML;
}
		...
		<fieldset class='general_box'>
			<h3>{$this->lang->words['coppa_info']}</h3>
				...
				<select name='m' class='input_select'>
			 		...
			 		".$this->__f__da622d7c91612b47e1274e454b052699()."				</select>
	
				<select name='d' class='input_select'>
			 		<option value='0'>{$this->lang->words['select_day']}</option>
			 		".$this->__f__4021362238ed1b5f923415f01c011ba0()."				</select>
	
				<select name='y' class='input_select'>
			 		<option value='0'>{$this->lang->words['select_year']}</option>
			 		".$this->__f__7d40d42e0f54cb0f53c2d66838118aea()."				</select>
		</fieldset>
		<fieldset class='submit'>
			<input type='submit' value='{$this->lang->words['coppa_continue_button']}' class='input_submit' /> {$this->lang->words['or']} <a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "", 'public','' ), "", "" ) . "' title='Cancel' class='cancel'>Cancel</a>
		</fieldset>
	</div>
</form>";
return $IPBHTML;
...
function __f__da622d7c91612b47e1274e454b052699()
{
	$_ips___x_retval = '';
...
function __f__4021362238ed1b5f923415f01c011ba0()
{
	$_ips___x_retval = '';
...
function __f__7d40d42e0f54cb0f53c2d66838118aea()
{
	$_ips___x_retval = '';
...
<div class='message error'>
	...
	<ul>
		".$this->__f__1274599feee809bc04ab2bd23ac40ce3($general_errors,$data,$inline_errors,$time_select,$custom_fields)."	</ul>
</div>
	...
	<div id='register_form' class='block_wrap left'>
			...
			<ul>
				...
				<li class='field'>
					...
					<select id='timezone' class='input_select' name='time_offset'>
						".$this->__f__1c2319fe8a1077402c11bd77d7910e0c($general_errors,$data,$inline_errors,$time_select,$custom_fields)."					</select>
				</li>
				<li class='field checkbox'>
		...
		" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<fieldset class='" .  IPSLib::next( $this->registry->templateStriping["register"] ) . "'>
			...
			" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
				".$this->__f__57b995789e6f2c3c9f102b1cd35a2218($general_errors,$data,$inline_errors,$time_select,$custom_fields)."			") : ("")) . "
			
			" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
				".$this->__f__87c20c6479becdbc41c54c96e7b92964($general_errors,$data,$inline_errors,$time_select,$custom_fields)."			") : ("")) . "
			<!--{SUBS.MANAGER}-->
			<!--IBF.MODULES.EXTRA-->
		</fieldset>") : ("")) . "
		{$data['qandaHTML']}
...
function __f__1274599feee809bc04ab2bd23ac40ce3($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array())
{
	$_ips___x_retval = '';
...
function __f__1c2319fe8a1077402c11bd77d7910e0c($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array())
{
	$_ips___x_retval = '';
...
function __f__57b995789e6f2c3c9f102b1cd35a2218($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array())
{
	$_ips___x_retval = '';
...
function __f__87c20c6479becdbc41c54c96e7b92964($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array())
{
	$_ips___x_retval = '';
