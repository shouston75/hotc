...
<table class='ipb_table'>
	...
	".$this->__f__64f61831f80161d2e187211e6931bfe9($rows)."</table>
...
function __f__64f61831f80161d2e187211e6931bfe9($rows)
{
	$_ips___x_retval = '';
	foreach( $rows as $row )
	{
...
$IPBHTML .= "<div class='full_emoticon'>
		<table class='ipb_table'>
			".$this->__f__fd3966cd788705233673e28928bf1e5e($editor_id,$rows)."		</table>
</div>";
return $IPBHTML;
}


function __f__fd3966cd788705233673e28928bf1e5e($editor_id, $rows)
{
	$_ips___x_retval = '';
	foreach( $rows as $row )
	{
