...
<table class='ipb_table report_center' summary='{$this->lang->words['reported_content_summary']}'>
	...
	" . ((count($reports)) ? ("
				".$this->__f__0be89221da713d68eeee6071990cf068($reports,$acts,$pages,$active,$statuses)."	") : ("
		<tr>
		...
		<div id='topic_active_users' class='active_users'>
			...
			<ol>
				" . ((is_array( $active['names'] ) AND count( $active['names'] )) ? ("
					".$this->__f__9893620ccb1b2a7cf29fe47efc1e02d7($reports,$acts,$pages,$active,$statuses)."				") : ("")) . "
			</ol>
		</div>
	</div>") : ("")) . "
<script type='text/javascript'>
...
function __f__774541e333d404c2234ce3eff8071457($reports=array(), $acts="", $pages="", $active=array(), $statuses=array(),$report='')
{
	$_ips___x_retval = '';
...
function __f__0be89221da713d68eeee6071990cf068($reports=array(), $acts="", $pages="", $active=array(), $statuses=array())
{
	$_ips___x_retval = '';
				...
				<td>
					...
					" . ((is_array( $statuses ) && count( $statuses )) ? ("
						<ul class='ipbmenu_content' id='change_status-{$report['id']}_menucontent'>
							".$this->__f__774541e333d404c2234ce3eff8071457($reports,$acts,$pages,$active,$statuses,$report)."						</ul>
					") : ("")) . "
				</td>
				<td class='altrow'>
					" . (($report['section']['url']) ? ("
...
function __f__9893620ccb1b2a7cf29fe47efc1e02d7($reports=array(), $acts="", $pages="", $active=array(), $statuses=array())
{
	$_ips___x_retval = '';
...
" . ((is_array( $options['statuses'] ) && count( $options['statuses'] )) ? ("
	<ul class='ipbmenu_content' id='change_status_menucontent'>
		".$this->__f__938cb28ebd55467287932fc11aa84444($options,$reports,$comments)."	</ul>
") : ("")) . "
<br />
<h2 class='maintitle'>{$this->lang->words['reports_h2']}</h2>
<div class='generic_bar'></div>
" . ((is_array($reports) AND count($reports)) ? ("
	".$this->__f__64b0f68515c38da1d81f50167e97ba1c($options,$reports,$comments)."") : ("")) . "
<br /><hr /><br />

<h2 class='maintitle'>{$this->lang->words['comments_h2']}</h2>
<div class='generic_bar'></div>
" . ((is_array($comments) AND count($comments)) ? ("
	".$this->__f__50d9cd5e6efe166c5d4116bb6375a092($options,$reports,$comments)."") : ("
	<p class='no_messages'>
...
function __f__938cb28ebd55467287932fc11aa84444($options=array(), $reports=array(), $comments=array())
{
	$_ips___x_retval = '';
...
function __f__64b0f68515c38da1d81f50167e97ba1c($options=array(), $reports=array(), $comments=array())
{
	$_ips___x_retval = '';
	foreach( $reports as $report )
	{
...
function __f__50d9cd5e6efe166c5d4116bb6375a092($options=array(), $reports=array(), $comments=array())
{
	$_ips___x_retval = '';
	foreach( $comments as $comment )
	{
		...
		<div class='post_block first hentry' id='post_id_{$comment['comment_id']}'>
			<div class='post_wrap'>
				<h3>
