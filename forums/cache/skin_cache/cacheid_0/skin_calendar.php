...
<div id='calendar_list' class='left general_box'>
	...
	<ol>
		".$this->__f__77462a4c9ef42601c3c9f0e29adf17d5($calendars,$date,$month,$year,$prev,$next,$cal_id)."	</ol>
	") : ("")) . "
...
function __f__77462a4c9ef42601c3c9f0e29adf17d5($calendars, $date="",$month="",$year="",$prev="",$next="", $cal_id=1)
{
	$_ips___x_retval = '';
...
<div class='general_box'>	<ul>
		".$this->__f__be1e03f0420dfd1b0120da799178c207($rows)."	</ul>
</div>";
return $IPBHTML;
}


function __f__be1e03f0420dfd1b0120da799178c207($rows)
{
	$_ips___x_retval = '';
	foreach( $rows as $r )
	{
...
<div id='calendar_list' class='left general_box'>
	...
	<p><strong>{$this->lang->words['select_calendar']}</strong></p>
	<ol>
		".$this->__f__8cd8067ec754dd7d3491ec1b07a4d723($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."	</ol>
	") : ("")) . "
	<strong>{$this->lang->words['jump_to']}</strong><br />
...
<div id='current_calendar' class='right calendar_wrap'>
	...
	<table id='calendar_table' class='ipb_table' summary=\"{$this->lang->words['calendar_for']} {$month} {$year}\">
		...
		<tr class='header'>
			...
			".$this->__f__95b89f717f20250d25166b1e430e4a44($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."			<!--IBF.DAYS_CONTENT-->
		</tr>
	</table>
...
function __f__8cd8067ec754dd7d3491ec1b07a4d723($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	foreach( $calendars as $cid => $cal )
	{
...
function __f__95b89f717f20250d25166b1e430e4a44($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
...
<table class='mini_cal'>
	<tr class='header'>
		...
		".$this->__f__084786c04f5757909e916540b6acd0f9($month,$mid,$year,$events,$day_words)."		{$events}
	</tr>
</table>";
return $IPBHTML;
}
...
function __f__084786c04f5757909e916540b6acd0f9($month="",$mid="",$year="",$events="",$day_words="")
{
	$_ips___x_retval = '';
	foreach( $day_words as $day )
	{
