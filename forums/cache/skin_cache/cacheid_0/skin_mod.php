...
$IPBHTML = "";
$IPBHTML .= "<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "&amp;module=moderate&amp;section=moderate", 'public','' ), "", "" ) . "' method='post'>
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul>
				...
				".$this->__f__a718513cd3245f78f13d596cfc35373b($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__a718513cd3245f78f13d596cfc35373b($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
...
<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "&amp;module=moderate&amp;section=moderate", 'public','' ), "", "" ) . "' method='post'>
<input type='hidden' name='auth_key' value='{$this->member->form_hash}' />
<input type='hidden' name='do' value='postchoice' />".$this->__f__2bc36d2cc9b62d9af0f7c8fc6cafbcb8($editor,$dates,$authors,$uploads,$seoTitle)."<input type=\"hidden\" name=\"t\" value=\"{$this->request['t']}\" />
...
<div class='post_form'>
			...
			<li class='field'>
				...
				<select name=\"postdate\" class=\"input_select\" id='post_date'>
					" . ((is_array($dates) AND count($dates)) ? ("
						".$this->__f__316e66a4453b386e6031669c632373d0($editor,$dates,$authors,$uploads,$seoTitle)."					") : ("")) . "
				</select>
			</li>
			<li class='field'>
				...
				<select name=\"postauthor\" class=\"input_select\" id='post_author'>
					" . ((is_array($authors) AND count($authors)) ? ("
						".$this->__f__b43a247b7e0a6eb56885f6c2b4f47cdf($editor,$dates,$authors,$uploads,$seoTitle)."					") : ("")) . "
				</select>
			</li>
		</ul>
	...
	" . ((count($uploads)) ? ("
		<fieldset>
			...
			<table>
				".$this->__f__00a22cf889583479f4383bf8e463ff95($editor,$dates,$authors,$uploads,$seoTitle)."			</table>
		</fieldset>
	") : ("")) . "
	<fieldset class='submit'>
...
function __f__2bc36d2cc9b62d9af0f7c8fc6cafbcb8($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
...
function __f__316e66a4453b386e6031669c632373d0($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
...
function __f__b43a247b7e0a6eb56885f6c2b4f47cdf($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
...
function __f__00a22cf889583479f4383bf8e463ff95($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__0d3a739bf4976f0b572c173b9b817978($forum,$topic,$posts,$error)."") : ("")) . "
<fieldset class='submit'>
...
function __f__0d3a739bf4976f0b572c173b9b817978($forum, $topic, $posts, $error='')
{
	$_ips___x_retval = '';
	...
	<fieldset class='row1'>
		...
		<ul>
			" . ((count($topics) AND is_array($topics)) ? ("
				".$this->__f__c6861dc294f9dce6122518d2957f6ddb($forum,$jump_html,$topics)."			") : ("")) . "
		</ul>
	</fieldset>
	<fieldset class='row1'>
		<h3 class='bar'>{$this->lang->words['move_topic_options']}</h3>
...
function __f__c6861dc294f9dce6122518d2957f6ddb($forum, $jump_html, $topics)
{
	$_ips___x_retval = '';
...
$IPBHTML = "";
$IPBHTML .= "<h2 class='maintitle'>{$this->lang->words['cp_prune']} {$forum['name']}</h2>
<div class='generic_bar'></div>
<div class='post_form'>
	" . (($confirm_data['show'] == 1) ? ("
		<fieldset>
		...
		<ul>
			...
			<li class='field'>
				...
				<select class='input_select' name='topic_type' id=\"topic_type\">
					".$this->__f__290d62c852cdaf216dddfe41592092c3($forum,$forums_html,$confirm_data,$complete_html)."				</select>
			</li>
			<li class='field'>
...
function __f__290d62c852cdaf216dddfe41592092c3($forum="", $forums_html="", $confirm_data="", $complete_html="")
{
	$_ips___x_retval = '';
...
<div class='generic_bar'></div>
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__acbdc80d37e591a11a675f0bbeb79250($forum,$topic,$posts,$jump)."") : ("")) . "
<fieldset class='submit'>
...
function __f__acbdc80d37e591a11a675f0bbeb79250($forum, $topic, $posts, $jump)
{
	$_ips___x_retval = '';
	foreach( $posts as $row )
	{
...
<table class='ipb_table' summary=\"{$this->lang->words['mod_logs_topic_summary']} '{$topic['title']}'\">
	...
	") : ("
				".$this->__f__8a27da324f5549c470559955081a4c7c($topic,$avg_post,$mod_logs)."	")) . "
</table>";
return $IPBHTML;
}


function __f__8a27da324f5549c470559955081a4c7c($topic, $avg_post, $mod_logs=array())
{
	$_ips___x_retval = '';
...
$IPBHTML .= "" . (($this->request['module']=='ajax') ? ("
	...
	<table class='ipb_table'>
		...
		") : ("
						".$this->__f__a252a6c3427df0fb5edecaf72c97c069($member,$rows,$links)."		")) . "
	</table>
...
function __f__a252a6c3427df0fb5edecaf72c97c069($member, $rows, $links='')
{
	$_ips___x_retval = '';
	foreach( $rows as $r )
	{
