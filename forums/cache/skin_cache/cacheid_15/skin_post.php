...
class skin_post_15 extends skinMaster{
...
{
$count_568adcb7a6503fbfa11acc601bb22f29 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_568adcb7a6503fbfa11acc601bb22f29]['data'] = $data;
}
...
{
$count_526bb7670788165d9de82b61ecc56540 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_526bb7670788165d9de82b61ecc56540]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_526bb7670788165d9de82b61ecc56540]['form'] = $form;
}
...
{
$count_a07fb90affe0eb818fc2d6da662f4ff5 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_a07fb90affe0eb818fc2d6da662f4ff5]['data'] = $data;
}
...
{
$count_ae04b845b6ac603a0afca01a8c564af4 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_ae04b845b6ac603a0afca01a8c564af4]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__963de7990b38d43f27aa2103ac991f37($posts)."") : ("")) . "
<p class='submit'>
...
function __f__963de7990b38d43f27aa2103ac991f37($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_13b8f352a6fc31bfe833827210f232a3 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_13b8f352a6fc31bfe833827210f232a3]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_13b8f352a6fc31bfe833827210f232a3]['type'] = $type;
$this->functionData['uploadForm'][$count_13b8f352a6fc31bfe833827210f232a3]['stats'] = $stats;
$this->functionData['uploadForm'][$count_13b8f352a6fc31bfe833827210f232a3]['id'] = $id;
$this->functionData['uploadForm'][$count_13b8f352a6fc31bfe833827210f232a3]['forum_id'] = $forum_id;
}
