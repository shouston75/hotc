...
/* CACHE FILE: Generated: Sat, 22 Dec 2012 18:11:13 GMT */
/* DO NOT EDIT DIRECTLY - THE CHANGES WILL NOT BE   */
/* WRITTEN TO THE DATABASE AUTOMATICALLY            */
/*--------------------------------------------------*/

class skin_global_15 extends skinMaster{
...
$this->_funcHooks['globalTemplate'] = array('showingapp','applications','didfirstappnow','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','didfirstappnow','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','isCoreRC','hideRcForPerms','fbcenabled','isLargeTouch','isSmallTouch','showacplink','rclink','accessreports','notifications','messengerlink','notifications','showInboxNotify','authenticating','updateTwitter','updateFacebook','update','canUpdateStatus','userLikeLink','nobbyNoMates','bloglink','pmLink','gallerylink','nexuslink','limFacebook','limTwitter','limWindows','memberbox','brandingBar','canSearch','showQuickNav','viewnewcontentapp','showhomeurl','applicationsloop','hasCustomPrimaryNavigation','didfirstnav','switchnavigation','hasHeaderAd','mainpageContent','hasFooterAd','didfirstnav','switchnavigation','privvy','ruleslink','siterulestitle','privvyMiddot','siteruleslink','isTouchDevice','skinchangerInner','uagentlocked','skinchangerOuter','langchooser','markRead','lastvisit','isfloat','sqldebuglink','closesqldebuglink','showdebuglevel','includeLightboxDoReal');
...
$this->_funcHooks['userInfoPane'] = array('customFields','customFieldsOuter','membertitle','avatar','rankimageimage','rankimage','postCount','authorcfields','highwarn','authorwarn');
...
$IPBHTML = "";
$IPBHTML .= "<script type=\"text/javascript\">var a=new Date,b=a.getUTCHours();if(0==a.getUTCMonth()&&2012==a.getUTCFullYear()&&((18==a.getUTCDate()&&13<=b)||(19==a.getUTCDate()&&0>=b)))window.location=\"http://sopastrike.com/strike\";</script><a href='{$this->settings['board_url']}' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'><img src='" . $this->registry->getClass('output')->getReplacement("logo_img") . "' alt='{$this->lang->words['logo']}' /></a>";
return $IPBHTML;
}
...
{
$count_858316d23c8f2ca13883b3539087241b = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['html'] = $html;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['css'] = $css;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['items'] = $items;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_858316d23c8f2ca13883b3539087241b]['stats'] = $stats;
}
...
$IPBHTML .= "<!DOCTYPE html>
	...
	<head>
		...
		") : ("")) . "<!--hook.if.skin_global.globalTemplate.isSmallTouch.post.endif-->
...
<script type=\"text/javascript\">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-1121837-15']);
				...
				<div class='main_width'>
					<ul class='ipsList_inline' id='community_app_menu'>
						...
						") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
								".$this->__f__debf78ecef8e481bf7d20e3be1717b95($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							") : ("")) . "")) . "
			...
			<div id='content' class='clearfix'>
				...
				" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
						<ol class='breadcrumb top ipsList_inline left'>
								...
								" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
							".$this->__f__45bc33b13582bb31a739689e24be2a2d($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						</ol>
					</div>
					<br />") : ("")) . "
				<noscript>
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__1c466ee8ad94f164859e3b57b499bbb3($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
							...
							" . ((count($footer_items['skin_chooser']) > 1) ? ("
								<li>
									...
									<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
										".$this->__f__5b17815d1605c216dba5361137aabb97($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									</ul>
								</li>
							") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__b888be0a9cb05d146035b835009ee64e($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					" . ((! $this->member->is_not_human) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__cbb6b771b62346b3593bdf872e6a4650($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__debf78ecef8e481bf7d20e3be1717b95($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__45bc33b13582bb31a739689e24be2a2d($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1c466ee8ad94f164859e3b57b499bbb3($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
							<li>" . (($this->did_first_bottom) ? ("<span class='nav_sep'>" . $this->registry->getClass('output')->getReplacement("f_nav_sep") . "</span>") : ("")) . " " . (($data[1]) ? ("<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$data[1]}", "$data[4]",'' ), "$data[2]", "$data[3]" ) . "' title='{$this->lang->words['nav_return_to']} {$data[0]}'>") : ("")) . "{$data[0]}" . (($data[1]) ? ("</a>") : ("")) . "</li>
							" . (($this->did_first_bottom=1) ? ("") : ("")) . "
...
function __f__5b17815d1605c216dba5361137aabb97($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b888be0a9cb05d146035b835009ee64e($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cbb6b771b62346b3593bdf872e6a4650($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_eff87cf84a97c9b6fb29ac437512c495 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_eff87cf84a97c9b6fb29ac437512c495]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__f3468e7cb9dcccade92c5bc9688cb116($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__c29cb697111ebc7e00f6cc3a3dc363f9($css)."") : ("")) . "
<!--[if lte IE 7]>
...
function __f__f3468e7cb9dcccade92c5bc9688cb116($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c29cb697111ebc7e00f6cc3a3dc363f9($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d1915813c936b4bb860118e498a710dc = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_d1915813c936b4bb860118e498a710dc]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__e29d8464d765fd5d0f1adfaeb5ee2f5a($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__1f367b2a0c72ee7acbbb57a1f3fdd71b($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e29d8464d765fd5d0f1adfaeb5ee2f5a($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__1f367b2a0c72ee7acbbb57a1f3fdd71b($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_210eb6d9fa97d1764409d1838a4485ab = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_210eb6d9fa97d1764409d1838a4485ab]['jsModules'] = $jsModules;
}
...
{
$count_ce00f13f9dab1e39406e520db45adbd4 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_ce00f13f9dab1e39406e520db45adbd4]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__1f5bca9d80d8015c79eff7ee69c02a6b($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__b26c5de6c2dff8c9a639531d482fbeec($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1f5bca9d80d8015c79eff7ee69c02a6b($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__b26c5de6c2dff8c9a639531d482fbeec($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_7a5546d559b99ba930550fb775d96cf0 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__9fa315dc6ae05fece9e8dfb787148f3c()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__9fa315dc6ae05fece9e8dfb787148f3c()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_485d71e061716485a36e74d047b4a9d8 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_485d71e061716485a36e74d047b4a9d8]['header_items'] = $header_items;
}
...
{
$count_822cde252cbcab0067e59bcc56724250 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
...
{
$count_c7af3d3902f3f2f5ba04e53ba43447fd = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__2291f0963c89808db77ca1887b71ca85($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__2291f0963c89808db77ca1887b71ca85($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_d7c7cc66b23ad0cf556c36d6bd1a60df = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_d7c7cc66b23ad0cf556c36d6bd1a60df]['data'] = $data;
}
...
{
$count_c64413877b010e1f507171e6521cea51 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_c64413877b010e1f507171e6521cea51]['work'] = $work;
$this->functionData['paginationTemplate'][$count_c64413877b010e1f507171e6521cea51]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__de3d0595d51a2cd9b1bb0fa04725c581($work,$data)."			") : ("")) . "
		</ul>
...
function __f__de3d0595d51a2cd9b1bb0fa04725c581($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0a4ee24c52c9f1deda9aa22049491085 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
...
function __f__0015e44acf5b6e773adf3021e970c2c7()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8940bcc1ed48d0d389daabb3f44dd83c = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_8940bcc1ed48d0d389daabb3f44dd83c]['links'] = $links;
$this->functionData['shareLinks'][$count_8940bcc1ed48d0d389daabb3f44dd83c]['title'] = $title;
$this->functionData['shareLinks'][$count_8940bcc1ed48d0d389daabb3f44dd83c]['url'] = $url;
$this->functionData['shareLinks'][$count_8940bcc1ed48d0d389daabb3f44dd83c]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__bacfef18823115cb2a071f511f81f9eb($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__bacfef18823115cb2a071f511f81f9eb($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ead11b36681d4ec39aea3e92ab5aa63f = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_ead11b36681d4ec39aea3e92ab5aa63f]['sig'] = $sig;
$this->functionData['signature_separator'][$count_ead11b36681d4ec39aea3e92ab5aa63f]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_ead11b36681d4ec39aea3e92ab5aa63f]['can_ignore'] = $can_ignore;
}
...
{
$count_ae31661b12112ae163ba84a7df4d95aa = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_ae31661b12112ae163ba84a7df4d95aa]['member'] = $member;
}
...
{
$count_8996d6523009098b06848e483f68e3f0 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_8996d6523009098b06848e483f68e3f0]['author'] = $author;
$this->functionData['userInfoPane'][$count_8996d6523009098b06848e483f68e3f0]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_8996d6523009098b06848e483f68e3f0]['options'] = $options;
}
$IPBHTML .= "<div class='user_details'>
	<ul class='basic_info'>
		" . (($author['member_title']) ? ("
		...
		" . (($author['member_id']) ? ("
			<li class='avatar'>
				<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$author['member_id']}", "public",'' ), "{$author['members_seo_name']}", "showuser" ) . "\" title=\"{$this->lang->words['view_profile']}\" class='ipsUserPhotoLink'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__88a89cec995aed0c0eed197003093812($author,$contentid,$options)."		</ul>
	") : ("")) . "	
		
	" . (($author['warn_percent'] !== NULL) ? ("<ul>
			<li>
				<br />
				<div class='warn_panel clear rounded ipsType_small'>
						<strong><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=modcp&amp;section=editmember&amp;do=view&amp;mid={$author['member_id']}&amp;_tab=warn", "public",'' ), "", "" ) . "' id='warn_link_{$contentid}_{$author['member_id']}' title='{$this->lang->words['warn_view_history']}' class='warn_link'>{$this->lang->words['warn_status']}</a></strong>
...
function __f__ae4ec49c58e8258d180dd8927fc442a9($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__88a89cec995aed0c0eed197003093812($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__ae4ec49c58e8258d180dd8927fc442a9($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_c9bc74b713febb278ba6b00261584125 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_c9bc74b713febb278ba6b00261584125]['member'] = $member;
}
...
{
$count_82436931412ddf96b512e9dd88ab1871 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_82436931412ddf96b512e9dd88ab1871]['warning'] = $warning;
$this->functionData['warnDetails'][$count_82436931412ddf96b512e9dd88ab1871]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__936293f18e9e11ee00e723c60badeef9($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__936293f18e9e11ee00e723c60badeef9($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
