...
/* CACHE FILE: Generated: Sat, 22 Dec 2012 18:11:24 GMT */
/* DO NOT EDIT DIRECTLY - THE CHANGES WILL NOT BE   */
/* WRITTEN TO THE DATABASE AUTOMATICALLY            */
/*--------------------------------------------------*/

class skin_twitterBar_15 extends skinMaster{
	...
	<ul>
		<div id=\"friendsList\">
			<div id='friendsResult_{$page}'>
				".$this->__f__e83ed488ad4bc93995155aaa803bfabd($data,$page)."			</div>
		</div>
...
function __f__e83ed488ad4bc93995155aaa803bfabd($data, $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $u )
...
$IPBHTML .= "<div id='friendsResult_{$page}' style=\"display:none;\">
	".$this->__f__d03cfc1dc2bfce3daf4def0c4204670d($data,$page)."</div>";
return $IPBHTML;
}


function __f__d03cfc1dc2bfce3daf4def0c4204670d($data, $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $u )
...
$IPBHTML .= "" . ((is_array( $data ) && count( $data )) ? ("
	<div id='searchResult_{$page}' style=\"display:none;\">
		".$this->__f__7b895c538f63030671dcbc9582aaf058($data,$page)."	</div>
") : ("
...
function __f__7b895c538f63030671dcbc9582aaf058($data=array(), $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
...
$IPBHTML = "";
$IPBHTML .= "" . ((is_array( $data ) && count( $data ) && !isset( $data['error'] )) ? ("".$this->__f__cf2e365fa213397589ae33f07e413ce5($data)."") : ("<li class='row1'>
	" . ((isset( $data['error'] )) ? ("
		{$data['error']}
	") : ("
...
function __f__cf2e365fa213397589ae33f07e413ce5($data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
...
$IPBHTML .= "" . ((is_array( $data ) && count( $data ) && !isset( $data['error'] )) ? ("<div id=\"userInfoBlock\">
	...
	".$this->__f__b8020a4435b1ec3ae90d3aff8789462a($data,$userData)."") : ("<li class='row1'>
	" . ((isset( $data['error'] )) ? ("
		{$data['error']}
	") : ("
		{$this->lang->words['errorNoTweets']}
...
function __f__b8020a4435b1ec3ae90d3aff8789462a($data, $userData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
