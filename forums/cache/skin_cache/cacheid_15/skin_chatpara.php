...
class skin_chatpara_15 extends skinMaster{
...
<div id='parachat'>
	" . ( method_exists( $this->registry->getClass('output')->getTemplate('chatpara'), '$template' ) ? $this->registry->getClass('output')->getTemplate('chatpara')->$template($options) : '' ) . "
</div>
