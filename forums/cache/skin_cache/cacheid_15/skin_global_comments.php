...
class skin_global_comments_15 extends skinMaster{
...
{
$count_25b0341abfc3e6db31d40548f8855973 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_25b0341abfc3e6db31d40548f8855973]['r'] = $r;
$this->functionData['comment'][$count_25b0341abfc3e6db31d40548f8855973]['parent'] = $parent;
$this->functionData['comment'][$count_25b0341abfc3e6db31d40548f8855973]['settings'] = $settings;
}
...
{
$count_5048031f60c046e3f0d8ae528112f5e6 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_5048031f60c046e3f0d8ae528112f5e6]['r'] = $r;
$this->functionData['commentHidden'][$count_5048031f60c046e3f0d8ae528112f5e6]['parent'] = $parent;
$this->functionData['commentHidden'][$count_5048031f60c046e3f0d8ae528112f5e6]['settings'] = $settings;
}
...
{
$count_6e0c4391b5b40c167208483ce2e67b2e = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_6e0c4391b5b40c167208483ce2e67b2e]['comments'] = $comments;
$this->functionData['commentsList'][$count_6e0c4391b5b40c167208483ce2e67b2e]['settings'] = $settings;
$this->functionData['commentsList'][$count_6e0c4391b5b40c167208483ce2e67b2e]['pages'] = $pages;
$this->functionData['commentsList'][$count_6e0c4391b5b40c167208483ce2e67b2e]['parent'] = $parent;
$this->functionData['commentsList'][$count_6e0c4391b5b40c167208483ce2e67b2e]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__017864cca0e2c83f158fbe426d12e41c($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__017864cca0e2c83f158fbe426d12e41c($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1b3660575ee3ca7158e1aa4f3c16eb69 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_1b3660575ee3ca7158e1aa4f3c16eb69]['comment'] = $comment;
$this->functionData['form'][$count_1b3660575ee3ca7158e1aa4f3c16eb69]['parent'] = $parent;
$this->functionData['form'][$count_1b3660575ee3ca7158e1aa4f3c16eb69]['editor'] = $editor;
$this->functionData['form'][$count_1b3660575ee3ca7158e1aa4f3c16eb69]['settings'] = $settings;
$this->functionData['form'][$count_1b3660575ee3ca7158e1aa4f3c16eb69]['errors'] = $errors;
$this->functionData['form'][$count_1b3660575ee3ca7158e1aa4f3c16eb69]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
