...
class skin_global_other_15 extends skinMaster{
...
{
$count_e3d49aaa729a4ba856eb13774033a615 = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_e3d49aaa729a4ba856eb13774033a615]['msg'] = $msg;
}
...
{
$count_5bd47228bffdbd51208c73174e4c66f1 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_5bd47228bffdbd51208c73174e4c66f1]['message'] = $message;
}
...
{
$count_8e2e31b27f6d9071105028ce920ae81e = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_8e2e31b27f6d9071105028ce920ae81e]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_8e2e31b27f6d9071105028ce920ae81e]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_8e2e31b27f6d9071105028ce920ae81e]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_8e2e31b27f6d9071105028ce920ae81e]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_8e2e31b27f6d9071105028ce920ae81e]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__621390609da8dbfb03f89b704b59f4f7($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__836007053dac70dfe22d00c1e5455b9b($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__fb386069bb936f87439c95f8223737ed($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<script type='text/javascript'>
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__7ae62ab08924190f2cd381823cf2216f($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__621390609da8dbfb03f89b704b59f4f7($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__836007053dac70dfe22d00c1e5455b9b($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fb386069bb936f87439c95f8223737ed($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1fabd94a8ec18337db5afe6ab0a3d313($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7ae62ab08924190f2cd381823cf2216f($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__1fabd94a8ec18337db5afe6ab0a3d313($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_e99aa06efb20b38b78cbc28376192c0d = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_e99aa06efb20b38b78cbc28376192c0d]['message'] = $message;
$this->functionData['Error'][$count_e99aa06efb20b38b78cbc28376192c0d]['code'] = $code;
$this->functionData['Error'][$count_e99aa06efb20b38b78cbc28376192c0d]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_e99aa06efb20b38b78cbc28376192c0d]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_e99aa06efb20b38b78cbc28376192c0d]['title'] = $title;
}
...
{
$count_d1047e0d7ab5026b7a4d3437ceca42b7 = is_array($this->functionData['facebookPop']) ? count($this->functionData['facebookPop']) : 0;
$this->functionData['facebookPop'][$count_d1047e0d7ab5026b7a4d3437ceca42b7]['user'] = $user;
}
...
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad_double ipsType_textblock'>
		...
		<p>
			...
			{$this->lang->words['or']}
			<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=search&amp;do=followed", "public",'' ), "", "" ) . "' title='{$this->lang->words['cancel']}' class='cancel'>{$this->lang->words['cancel']}</a>
		</p>
	</div>
</div>
</form>";
...
{
$count_d29bff6607871f1373e0e5d470467342 = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_d29bff6607871f1373e0e5d470467342]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_d29bff6607871f1373e0e5d470467342]['unreadUrl'] = $unreadUrl;
}
...
{
$count_45ca2ebee117d9fa3a19bf7418f43121 = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_45ca2ebee117d9fa3a19bf7418f43121]['stats'] = $stats;
}
...
{
$count_7a2c6b4aaf7835fff8080d290ffc53f0 = is_array($this->functionData['inboxList']) ? count($this->functionData['inboxList']) : 0;
$this->functionData['inboxList'][$count_7a2c6b4aaf7835fff8080d290ffc53f0]['topics'] = $topics;
}
$IPBHTML .= "<h4 class='ipsType_sectiontitle'>{$this->lang->words['inbox_at_the_top']}<p class='ipsPad_half ipsType_smaller right'><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=messaging", "public",'' ), "", "" ) . "' class='configure'>{$this->lang->words['inbox_list_view']}</a> &middot; <a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=messaging&amp;section=send&amp;do=form", "publicWithApp",'' ), "", "" ) . "' title='{$this->lang->words['compose_new']}'>{$this->lang->words['compose_new']}</a></p></h4>
<ul class='ipsList_withminiphoto'>
	" . ((count($topics)) ? ("
		".$this->__f__e485b462a016a6fb5a16f983f7d32d32($topics)."	") : ("
...
function __f__e485b462a016a6fb5a16f983f7d32d32($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $topic )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		<li class='" . (($topic['map_has_unread']) ? ("unread") : ("")) . " ipsType_small clearfix'>
			<img src='{$topic['_starterMemberData']['pp_mini_photo']}' alt=\"" . sprintf($this->lang->words['users_photo'],$topic['_starterMemberData']['members_display_name']) . "\" class='ipsUserPhoto ipsUserPhoto_mini left' />
			<div class='list_content'>
				...
				<br />
				<span class='ipsType_smaller desc lighter'>{$topic['_starterMemberData']['members_display_name']} - " . $this->registry->getClass('class_localization')->getDate($topic['msg_date'],"short", 0) . "</span>
			</div>
		</li>
...
{
$count_b0e8dc1c4df65da19c2352ca07950653 = is_array($this->functionData['likeMoreDialogue']) ? count($this->functionData['likeMoreDialogue']) : 0;
$this->functionData['likeMoreDialogue'][$count_b0e8dc1c4df65da19c2352ca07950653]['data'] = $data;
$this->functionData['likeMoreDialogue'][$count_b0e8dc1c4df65da19c2352ca07950653]['relId'] = $relId;
$this->functionData['likeMoreDialogue'][$count_b0e8dc1c4df65da19c2352ca07950653]['cache'] = $cache;
}
$IPBHTML .= "<h3>{$this->lang->words['followed_by']}</h3>
<div class='likepop fixed_inner'>
	" . ((is_array($data) && count($data)) ? ("
		<ul class='ipsList_withminiphoto'>
			".$this->__f__7573d35cc1e435ad3c9b28c3bea367f0($data,$relId,$cache)."		</ul>
	") : ("")) . "
...
function __f__7573d35cc1e435ad3c9b28c3bea367f0($data, $relId, $cache)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		<li class='ipsField ipsField_checkbox'>
			...
			<p class='ipsField_content'>
				...
				<select name=\"freq\" id=\"like_freq\" class=\"input_select\">
					".$this->__f__33f1ff0f1df67244f28ad435794fcd91($app,$area,$relid,$data)."				</select>
			</p>
		</li>
		<li class='ipsField ipsField_checkbox'>
...
function __f__33f1ff0f1df67244f28ad435794fcd91($app, $area, $relid, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d9e0e94e9c6eb2448b9b4d13b82ca8b3 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_d9e0e94e9c6eb2448b9b4d13b82ca8b3]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_d9e0e94e9c6eb2448b9b4d13b82ca8b3]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_d9e0e94e9c6eb2448b9b4d13b82ca8b3]['opts'] = $opts;
}
...
{
$count_b04ec21b4b25d07c458203ccdf1a233a = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_b04ec21b4b25d07c458203ccdf1a233a]['notifications'] = $notifications;
}
$IPBHTML .= "<h4 class='ipsType_sectiontitle'>{$this->lang->words['notifications_at_the_top']}
	<p class='ipsPad_half ipsType_smaller right'>
	<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=notificationlog", "public",'' ), "", "" ) . "' class='configure'>{$this->lang->words['notifications_viewall']}</a>
	&middot; <a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=notifications", "public",'' ), "", "" ) . "' class='configure'>{$this->lang->words['generic_opts_link']}</a>
	</p>
</h4>
<ul class='ipsList_withminiphoto'>
	" . ((count($notifications)) ? ("
		".$this->__f__55ff55e4392ecdb15a33dd20baf7bf74($notifications)."	") : ("
...
function __f__55ff55e4392ecdb15a33dd20baf7bf74($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $notifications as $notify )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		<li class='" . ((!$notify['notify_read']) ? ("unread") : ("")) . " ipsType_small clearfix'>
			<img src='{$notify['member']['pp_mini_photo']}' alt=\"" . sprintf($this->lang->words['users_photo'],$notify['member']['members_display_name']) . "\" class='ipsUserPhoto ipsUserPhoto_mini left' />
			<div class='list_content'>
				...
				") : ("")) . "
				<br />
				<span class='ipsType_smaller desc lighter'>" . $this->registry->getClass('class_localization')->getDate($notify['notify_sent'],"short", 0) . "</span>
			</div>
		</li>
...
{
$count_3f3ae140e8ed958d2f1397d176b6a77d = is_array($this->functionData['questionAndAnswer']) ? count($this->functionData['questionAndAnswer']) : 0;
$this->functionData['questionAndAnswer'][$count_3f3ae140e8ed958d2f1397d176b6a77d]['data'] = $data;
}
	...
	<ul class='ipsForm ipsForm_horizontal'>
		<li class='ipsField'>
			...
			<div class='ipsField_content'>
				...
				<input type=\"text\" class='input_text' size=\"45\" maxlength=\"100\" value=\"" . (($this->request['qanda_id'] AND $this->request['qanda_id']==$data['qa_id']) ? ("{$this->request['qa_answer']}") : ("")) . "\" name=\"qa_answer\" id='qna' tabindex='7' /><br />
...
{
$count_5e4d3e97ac33e936360175937bef35d2 = is_array($this->functionData['quickNavigationPanel']) ? count($this->functionData['quickNavigationPanel']) : 0;
$this->functionData['quickNavigationPanel'][$count