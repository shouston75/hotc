...
class skin_ibEconomy_15 extends skinMaster{
...
{
$count_4c70d81a2103463c7b6609ed6033c6fd = is_array($this->functionData['area_side_bar']) ? count($this->functionData['area_side_bar']) : 0;
$this->functionData['area_side_bar'][$count_4c70d81a2103463c7b6609ed6033c6fd]['isActive'] = $isActive;
$this->functionData['area_side_bar'][$count_4c70d81a2103463c7b6609ed6033c6fd]['areaLangName'] = $areaLangName;
$this->functionData['area_side_bar'][$count_4c70d81a2103463c7b6609ed6033c6fd]['title'] = $title;
$this->functionData['area_side_bar'][$count_4c70d81a2103463c7b6609ed6033c6fd]['moreURL'] = $moreURL;
}
...
{
$count_7cf9234b58dd1ef3fbd360c750d3582f = is_array($this->functionData['blockRowLotto']) ? count($this->functionData['blockRowLotto']) : 0;
$this->functionData['blockRowLotto'][$count_7cf9234b58dd1ef3fbd360c750d3582f]['row'] = $row;
$this->functionData['blockRowLotto'][$count_7cf9234b58dd1ef3fbd360c750d3582f]['block'] = $block;
}
...
{
$count_32d520d3361eadb3a645620a1d3a8fce = is_array($this->functionData['blocks']) ? count($this->functionData['blocks']) : 0;
$this->functionData['blocks'][$count_32d520d3361eadb3a645620a1d3a8fce]['blocks'] = $blocks;
}
...
{
$count_74a5e843fb654429add878385ca2d5be = is_array($this->functionData['button_row']) ? count($this->functionData['button_row']) : 0;
$this->functionData['button_row'][$count_74a5e843fb654429add878385ca2d5be]['my_points'] = $my_points;
$this->functionData['button_row'][$count_74a5e843fb654429add878385ca2d5be]['leftButtons'] = $leftButtons;
}
...
{
$count_6e4e64a362855bf6e6d81cf382548a93 = is_array($this->functionData['cart_wrapper']) ? count($this->functionData['cart_wrapper']) : 0;
$this->functionData['cart_wrapper'][$count_6e4e64a362855bf6e6d81cf382548a93]['content'] = $content;
$this->functionData['cart_wrapper'][$count_6e4e64a362855bf6e6d81cf382548a93]['totals'] = $totals;
}
...
{
$count_3d5fbc2bf3431a214e70b850160de9be = is_array($this->functionData['editMemPtsPop']) ? count($this->functionData['editMemPtsPop']) : 0;
$this->functionData['editMemPtsPop'][$count_3d5fbc2bf3431a214e70b850160de9be]['member'] = $member;
$this->functionData['editMemPtsPop'][$count_3d5fbc2bf3431a214e70b850160de9be]['url'] = $url;
}
...
{
$count_d155849cd93a37ed5e84f074c9d97b39 = is_array($this->functionData['init_js_css']) ? count($this->functionData['init_js_css']) : 0;
}
$IPBHTML .= "<!--JS-->
...
{
$count_6687bfe37af3d62d5548c7b71cfe9437 = is_array($this->functionData['memberInfoPane']) ? count($this->functionData['memberInfoPane']) : 0;
$this->functionData['memberInfoPane'][$count_6687bfe37af3d62d5548c7b71cfe9437]['member'] = $member;
$this->functionData['memberInfoPane'][$count_6687bfe37af3d62d5548c7b71cfe9437]['miniShopItemBox'] = $miniShopItemBox;
}
...
{
$count_5f30e02c984ec9af1b48173b5a0a4a5c = is_array($this->functionData['memberProfileDonate']) ? count($this->functionData['memberProfileDonate']) : 0;
$this->functionData['memberProfileDonate'][$count_5f30e02c984ec9af1b48173b5a0a4a5c]['memberID'] = $memberID;
}
...
{
$count_2a8466bad7daa54627a6127723bd811d = is_array($this->functionData['memPanePop']) ? count($this->functionData['memPanePop']) : 0;
$this->functionData['memPanePop'][$count_2a8466bad7daa54627a6127723bd811d]['member'] = $member;
$this->functionData['memPanePop'][$count_2a8466bad7daa54627a6127723bd811d]['url'] = $url;
}
$IPBHTML .= "<form action='{$this->settings['base_url']}app=ibEconomy&amp;do=donate' method='post'>
		<table class='ipb_table'>
			<tr class='header'>
...
{
$count_dc58845346533094d9288cfc552afaf2 = is_array($this->functionData['pointButton']) ? count($this->functionData['pointButton']) : 0;
$this->functionData['pointButton'][$count_dc58845346533094d9288cfc552afaf2]['member'] = $member;
}
...
{
$count_e00b08e80a39299a5cefadc6434699d4 = is_array($this->functionData['profileTab']) ? count($this->functionData['profileTab']) : 0;
$this->functionData['profileTab'][$count_e00b08e80a39299a5cefadc6434699d4]['assets'] = $assets;
$this->functionData['profileTab'][$count_e00b08e80a39299a5cefadc6434699d4]['transactions'] = $transactions;
$this->functionData['profileTab'][$count_e00b08e80a39299a5cefadc6434699d4]['member'] = $member;
$this->functionData['profileTab'][$count_e00b08e80a39299a5cefadc6434699d4]['shopItems'] = $shopItems;
}
...
{
$count_c282e92833f77e55d36f792560bfff98 = is_array($this->functionData['settings']) ? count($this->functionData['settings']) : 0;
$this->functionData['settings'][$count_c282e92833f77e55d36f792560bfff98]['mySettings'] = $mySettings;
$this->functionData['settings'][$count_c282e92833f77e55d36f792560bfff98]['myPluginSettings'] = $myPluginSettings;
}
...
{
$count_5ec5ab58e5c319d0aa3846f64597b3ff = is_array($this->functionData['standings_row']) ? count($this->functionData['standings_row']) : 0;
$this->functionData['standings_row'][$count_5ec5ab58e5c319d0aa3846f64597b3ff]['member'] = $member;
}
...
{
$count_2d7c5aa21cbd3e690b5401b75e906094 = is_array($this->functionData['standings_wrapper']) ? count($this->functionData['standings_wrapper']) : 0;
$this->functionData['standings_wrapper'][$count_2d7c5aa21cbd3e690b5401b75e906094]['content'] = $content;
$this->functionData['standings_wrapper'][$count_2d7c5aa21cbd3e690b5401b75e906094]['pages'] = $pages;
$this->functionData['standings_wrapper'][$count_2d7c5aa21cbd3e690b5401b75e906094]['active'] = $active;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("memberlist", "0" ) . "
...
{
$count_7f5ea128a84ea1566ceeca160d6a26c3 = is_array($this->functionData['stats']) ? count($this->functionData['stats']) : 0;
$this->functionData['stats'][$count_7f5ea128a84ea1566ceeca160d6a26c3]['active'] = $active;
$this->functionData['stats'][$count_7f5ea128a84ea1566ceeca160d6a26c3]['totals'] = $totals;
}
...
{
$count_21fbed006eb3b2cb52d99d7fbdd5ba6c = is_array($this->functionData['tab']) ? count($this->functionData['tab']) : 0;
$this->functionData['tab'][$count_21fbed006eb3b2cb52d99d7fbdd5ba6c]['isActive'] = $isActive;
$this->functionData['tab'][$count_21fbed006eb3b2cb52d99d7fbdd5ba6c]['tabName'] = $tabName;
$this->functionData['tab'][$count_21fbed006eb3b2cb52d99d7fbdd5ba6c]['tabLangName'] = $tabLangName;
$this->functionData['tab'][$count_21fbed006eb3b2cb52d99d7fbdd5ba6c]['title'] = $title;
}
$IPBHTML .= "<li " . (($isActive) ? ("class='active'") : ("")) . ">
...
{
$count_658985e04fdac96ee5def81e865335a8 = is_array($this->functionData['transactions_wrapper']) ? count($this->functionData['transactions_wrapper']) : 0;
$this->functionData['transactions_wrapper'][$count_658985e04fdac96ee5def81e865335a8]['content'] = $content;
$this->functionData['transactions_wrapper'][$count_658985e04fdac96ee5def81e865335a8]['otherSW'] = $otherSW;
$this->functionData['transactions_wrapper'][$count_658985e04fdac96ee5def81e865335a8]['pages'] = $pages;
$this->functionData['transactions_wrapper'][$count_658985e04fdac96ee5def81e865335a8]['showMember'] = $showMember;
}
$IPBHTML .= "<div class='maintitle ipsFilterbar'>
			<ul class='ipsList_inline ipsType_smaller'>
...
{
$count_8160cb813a1d39ac65d1a63f85a845f8 = is_array($this->functionData['wrapper']) ? count($this->functionData['wrapper']) : 0;
$this->functionData['wrapper'][$count_8160cb813a1d39ac65d1a63f85a845f8]['active'] = $active;
$this->functionData['wrapper'][$count_8160cb813a1d39ac65d1a63f85a845f8]['showpage'] = $showpage;
}
