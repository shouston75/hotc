...
/* CACHE FILE: Generated: Sat, 22 Dec 2012 18:11:10 GMT */
/* DO NOT EDIT DIRECTLY - THE CHANGES WILL NOT BE   */
/* WRITTEN TO THE DATABASE AUTOMATICALLY            */
/*--------------------------------------------------*/

class skin_editors_15 extends skinMaster{
...
{
$count_edd040e543cd2a3ba658de96738477b4 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_edd040e543cd2a3ba658de96738477b4]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_edd040e543cd2a3ba658de96738477b4]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_edd040e543cd2a3ba658de96738477b4]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_edd040e543cd2a3ba658de96738477b4]['extraData'] = $extraData;
}
...
{
$count_8c58d76a52108880303a45857c5305f0 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_8c58d76a52108880303a45857c5305f0]['formField'] = $formField;
$this->functionData['editor'][$count_8c58d76a52108880303a45857c5305f0]['content'] = $content;
$this->functionData['editor'][$count_8c58d76a52108880303a45857c5305f0]['options'] = $options;
$this->functionData['editor'][$count_8c58d76a52108880303a45857c5305f0]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_8c58d76a52108880303a45857c5305f0]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_8c58d76a52108880303a45857c5305f0]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_8c58d76a52108880303a45857c5305f0]['bbcodeVersion'] = $bbcodeVersion;
}
...
{
$count_8aff75f92f90f20fa49fa51077aeb03b = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_8aff75f92f90f20fa49fa51077aeb03b]['options'] = $options;
$this->functionData['editorLoadJs'][$count_8aff75f92f90f20fa49fa51077aeb03b]['inlineLoad'] = $inlineLoad;
}
...
{
$count_791029f3b907dfd9a3ba7677a56207f4 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_791029f3b907dfd9a3ba7677a56207f4]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_791029f3b907dfd9a3ba7677a56207f4]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_791029f3b907dfd9a3ba7677a56207f4]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_791029f3b907dfd9a3ba7677a56207f4]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__e6576d32b1cd7bee334a72c629b52c07($rows,$pages,$app,$plugin)."		") : ("
...
function __f__e6576d32b1cd7bee334a72c629b52c07($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_3af9e167f769ce88d2d7ffd1db14cbfa = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_3af9e167f769ce88d2d7ffd1db14cbfa]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__9b74e6651e380222fb8f87593799dc56($tabs)."			</ul>
		</div>
...
function __f__9b74e6651e380222fb8f87593799dc56($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
