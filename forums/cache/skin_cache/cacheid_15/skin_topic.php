...
/* CACHE FILE: Generated: Sat, 22 Dec 2012 18:11:23 GMT */
/* DO NOT EDIT DIRECTLY - THE CHANGES WILL NOT BE   */
/* WRITTEN TO THE DATABASE AUTOMATICALLY            */
/*--------------------------------------------------*/

class skin_topic_15 extends skinMaster{
...
$this->_funcHooks['post'] = array('sDeleted','isSolvedCss','postQueued','noRep','posRep','negRep','repIgnored','userIgnoredLang','userIgnoredLangTwo','userIgnored','isNotIgnoring','postMid','hasPages','postModSelected','postModCheckbox','postMember','accessModCP','postAdmin','postIp','isSolvedSausage','repHighlight','postEditByReason','postEditBy','repButtonsLike','postSignature','canDelete','approveUnapprove','canEdit','controlsForUnapprovedPost','hideNormalControlsForUnapprovedPost','canUnanswer','notAnswered','isAnswered','canAnswerTopic','multiquote','replyButton','replyButtonWarn','canDelete','canHide','canEdit','postIsReported','canReportPost','reportedPostData','sDeletedNot','initIgnoredPost','adCodeCheck','sDeletedNotMQ');
...
{
$count_7269fceb4ffe6d8d18c5fa6b7ac08d2d = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_7269fceb4ffe6d8d18c5fa6b7ac08d2d]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_7269fceb4ffe6d8d18c5fa6b7ac08d2d]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_7269fceb4ffe6d8d18c5fa6b7ac08d2d]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_7269fceb4ffe6d8d18c5fa6b7ac08d2d]['sharelinks'] = $sharelinks;
}
...
{
$count_a6ccc700957692d06355fc13dbace447 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_a6ccc700957692d06355fc13dbace447]['announce'] = $announce;
$this->functionData['announcement_show'][$count_a6ccc700957692d06355fc13dbace447]['author'] = $author;
}
...
{
$count_80a55705f6049c0b7efeeb38dad2bdef = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_80a55705f6049c0b7efeeb38dad2bdef]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_80a55705f6049c0b7efeeb38dad2bdef]['forum'] = $forum;
}
...
{
$count_ed3314a7aaa7e0745b6856681ae0c8cc = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_d4b5ec7e24ee703161756d9ec8915688 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_d4b5ec7e24ee703161756d9ec8915688]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_d4b5ec7e24ee703161756d9ec8915688]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_d4b5ec7e24ee703161756d9ec8915688]['opts'] = $opts;
}
...
{
$count_64c0a40c9ba7e97346ce27d2003aeeca = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_64c0a40c9ba7e97346ce27d2003aeeca]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_64c0a40c9ba7e97346ce27d2003aeeca]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_64c0a40c9ba7e97346ce27d2003aeeca]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_64c0a40c9ba7e97346ce27d2003aeeca]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_64c0a40c9ba7e97346ce27d2003aeeca]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_64c0a40c9ba7e97346ce27d2003aeeca]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__2dd53f416e5e564fece255f9f87c1a96($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__aa81e60c217903ebe883a3e15bcc9b83($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__27a8d133bfea52f2053163ec6cc241f7($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__aa81e60c217903ebe883a3e15bcc9b83($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__2dd53f416e5e564fece255f9f87c1a96($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__27a8d133bfea52f2053163ec6cc241f7($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_95bb86007e2f8654f7022b796a286e76 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_95bb86007e2f8654f7022b796a286e76]['post'] = $post;
$this->functionData['post'][$count_95bb86007e2f8654f7022b796a286e76]['displayData'] = $displayData;
$this->functionData['post'][$count_95bb86007e2f8654f7022b796a286e76]['topic'] = $topic;
$this->functionData['post'][$count_95bb86007e2f8654f7022b796a286e76]['forum'] = $forum;
}
...
{
$count_0251558ccf584b82fde0dbc1be3384da = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_0251558ccf584b82fde0dbc1be3384da]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_77cbbcecdaa19441d0727f0a1995846e = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_77cbbcecdaa19441d0727f0a1995846e]['title'] = $title;
$this->functionData['show_attachment_title'][$count_77cbbcecdaa19441d0727f0a1995846e]['data'] = $data;
$this->functionData['show_attachment_title'][$count_77cbbcecdaa19441d0727f0a1995846e]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__77aa59777daafa36e3f0ceebb96915c1($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__77aa59777daafa36e3f0ceebb96915c1($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_64d7f6a49d5129c6021e86874f9ba088 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_64d7f6a49d5129c6021e86874f9ba088]['data'] = $data;
}
...
{
$count_d695bb5adf78c256a53f7e69b41d56d2 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_d695bb5adf78c256a53f7e69b41d56d2]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_d695bb5adf78c256a53f7e69b41d56d2]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_d695bb5adf78c256a53f7e69b41d56d2]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__d4169f6f252a10e4ec4f6b1854ab4f17($topic,$posts)."<br class='clear' />
...
function __f__d4169f6f252a10e4ec4f6b1854ab4f17($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a25244a27c119ab77276d309f41099d1 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_a25244a27c119ab77276d309f41099d1]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_a25244a27c119ab77276d309f41099d1]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_a25244a27c119ab77276d309f41099d1]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_a25244a27c119ab77276d309f41099d1]['displayData'] = $displayData;
}
...
<div itemscope itemtype=\"http://schema.org/Article\" class='ipsBox_withphoto'>
	...
	<div class='desc lighter blend_links'>
		 {$this->lang->words['started_by']} <span itemprop=\"creator\">" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($topic['_starter']) : '' ) . "</span>, <span itemprop=\"dateCreated\" datetime=\"" . $this->registry->getClass('class_localization')->getDate($topic['start_date'],"YMD", 1) . "\">" . $this->registry->getClass('class_localization')->getDate($topic['start_date'],"SHORT", 0) . "</span>
	</div>
	" . ((is_array($topic['tags'])) ? ("
...
<div class='post post_block feature_box'>
	...
	<p class='ipsType_sectiontitle'>
		...
		" . ((isset($post_data[ $displayData['best_answer_post_data']['post']['pid'] ])) ? ("" . (($this->request['page']) ? ("
				<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$topic['tid']}&amp;page={$this->request['page']}{$post_data[ $displayData['best_answer_post_data']['post']['pid'] ]['post']['PermalinkUrlBit']}#entry{$displayData['best_answer_post_data']['post']['pid']}", "public",'' ), "{$topic['title_seo']}", "showtopic" ) . "'>" . $this->registry->getClass('class_localization')->getDate($displayData['best_answer_post_data']['post']['post_date'],"long", 0) . "</a>
			") : ("
				<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$topic['tid']}{$post_data[ $displayData['best_answer_post_data']['post']['pid'] ]['post']['PermalinkUrlBit']}#entry{$displayData['best_answer_post_data']['post']['pid']}", "public",'' ), "{$topic['title_seo']}", "showtopic" ) . "'>" . $this->registry->getClass('class_localization')->getDate($displayData['best_answer_post_data']['post']['post_date'],"long", 0) . "</a>
			")) . "") : ("
			<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=forums&amp;section=findpost&amp;pid={$displayData['best_answer_post_data']['post']['pid']}", "public",'' ), "", "" ) . "\">" . $this->registry->getClass('class_localization')->getDate($displayData['best_answer_post_data']['post']['post_date'],"long", 0) . "</a>
		")) . "
	</p>
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__91b747562172802f3d7a61d782473718($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__cd4f84cd16b3f1356599f2e89eab307b($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__ce6ff025b48b5221b5ff105e867d4b1e($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__d9e93027ae8d0f01b882362cd63a8fb4($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__30bb9fb9471d5419af169606ed9b3764($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__91b747562172802f3d7a61d782473718($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['mod_links'] as $_mod_link )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		<li><a " . (($_mod_link['option'] == '08') ? (" data-confirmaction=\"true\"") : ("")) . " href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=moderate&amp;section=moderate&amp;t={$topic['tid']}&amp;f={$topic['forum_id']}&amp;page={$this->request['page']}&amp;auth_key={$this->member->form_hash}&amp;_fromTopic=1&amp;do={$_mod_link['option']}", "public",'' ), "", "" ) . "\" class='modlink_{$_mod_link['option']}'>{$_mod_link['value']}</a></li>
...
function __f__cd4f84cd16b3f1356599f2e89eab307b($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ce6ff025b48b5221b5ff105e867d4b1e($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->caches['reputation_levels'] as $k => $v )
	{
		...
		$_ips___x_retval .= "
				<li " . ((isset( $this->memberData['_members_cache']['rep_filter'] ) AND $v['level_points'] == $this->memberData['_members_cache']['rep_filter']) ? ("class='selected'") : ("")) . ">
					<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=forums&amp;section=topics&amp;rep_filter=update&amp;f={$topic['forum_id']}&amp;t={$topic['tid']}&amp;secure_key={$this->member->form_hash}&amp;page={$this->request['page']}&amp;rep_filter_set={$v['level_points']}", "public",'' ), "", "" ) . "' rel='nofollow'>
...
function __f__d9e93027ae8d0f01b882362cd63a8fb4($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__30bb9fb9471d5419af169606ed9b3764($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
