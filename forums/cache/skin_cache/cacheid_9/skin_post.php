...
class skin_post_9 extends skinMaster{
...
{
$count_0a56f172560dd9b7b8666acadd8bc07e = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_0a56f172560dd9b7b8666acadd8bc07e]['data'] = $data;
}
...
{
$count_35f6bb75c044f5fbd097cf1b0406c64a = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_35f6bb75c044f5fbd097cf1b0406c64a]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_35f6bb75c044f5fbd097cf1b0406c64a]['form'] = $form;
}
...
{
$count_703eb8adf934eb939dbfecba2d041a14 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_703eb8adf934eb939dbfecba2d041a14]['data'] = $data;
}
...
{
$count_c8219857ad2e048ba317d7b4d240791b = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_c8219857ad2e048ba317d7b4d240791b]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__1c18ecb9047eafe4f2b894e7030ee5bf($posts)."") : ("")) . "
<p class='submit'>
...
function __f__1c18ecb9047eafe4f2b894e7030ee5bf($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_aceacf8546638949fb4f3c5b0b060af3 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_aceacf8546638949fb4f3c5b0b060af3]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_aceacf8546638949fb4f3c5b0b060af3]['type'] = $type;
$this->functionData['uploadForm'][$count_aceacf8546638949fb4f3c5b0b060af3]['stats'] = $stats;
$this->functionData['uploadForm'][$count_aceacf8546638949fb4f3c5b0b060af3]['id'] = $id;
$this->functionData['uploadForm'][$count_aceacf8546638949fb4f3c5b0b060af3]['forum_id'] = $forum_id;
}
