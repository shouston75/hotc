...
class skin_twitterBar_9 extends skinMaster{
	...
	<ul>
		<div id=\"friendsList\">
			<div id='friendsResult_{$page}'>
				".$this->__f__500ccd106933b5f067285cf1a0bc90e4($data,$page)."			</div>
		</div>
...
function __f__500ccd106933b5f067285cf1a0bc90e4($data, $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $u )
...
$IPBHTML .= "<div id='friendsResult_{$page}' style=\"display:none;\">
	".$this->__f__dce41b3818301e54f6b14dafd476aa7b($data,$page)."</div>";
return $IPBHTML;
}


function __f__dce41b3818301e54f6b14dafd476aa7b($data, $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $u )
...
$IPBHTML .= "" . ((is_array( $data ) && count( $data )) ? ("
	<div id='searchResult_{$page}' style=\"display:none;\">
		".$this->__f__712b21d93d4851bfba3a18a2cd92fc11($data,$page)."	</div>
") : ("
...
function __f__712b21d93d4851bfba3a18a2cd92fc11($data=array(), $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
...
$IPBHTML = "";
$IPBHTML .= "" . ((is_array( $data ) && count( $data ) && !isset( $data['error'] )) ? ("".$this->__f__e5bed40c87165c86d2b479c4e4e64152($data)."") : ("<li class='row1'>
	" . ((isset( $data['error'] )) ? ("
		{$data['error']}
	") : ("
...
function __f__e5bed40c87165c86d2b479c4e4e64152($data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
...
$IPBHTML .= "" . ((is_array( $data ) && count( $data ) && !isset( $data['error'] )) ? ("<div id=\"userInfoBlock\">
	...
	".$this->__f__7117bdaa6be016b481bed151f05f93bb($data,$userData)."") : ("<li class='row1'>
	" . ((isset( $data['error'] )) ? ("
		{$data['error']}
	") : ("
		{$this->lang->words['errorNoTweets']}
...
function __f__7117bdaa6be016b481bed151f05f93bb($data, $userData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
