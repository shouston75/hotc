...
class skin_editors_9 extends skinMaster{
...
{
$count_8c1c9720c6df87b3142c78e797c582c1 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_8c1c9720c6df87b3142c78e797c582c1]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_8c1c9720c6df87b3142c78e797c582c1]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_8c1c9720c6df87b3142c78e797c582c1]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_8c1c9720c6df87b3142c78e797c582c1]['extraData'] = $extraData;
}
...
{
$count_e66fcbb826fd26bf4d657e11bf382aa3 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_e66fcbb826fd26bf4d657e11bf382aa3]['formField'] = $formField;
$this->functionData['editor'][$count_e66fcbb826fd26bf4d657e11bf382aa3]['content'] = $content;
$this->functionData['editor'][$count_e66fcbb826fd26bf4d657e11bf382aa3]['options'] = $options;
$this->functionData['editor'][$count_e66fcbb826fd26bf4d657e11bf382aa3]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_e66fcbb826fd26bf4d657e11bf382aa3]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_e66fcbb826fd26bf4d657e11bf382aa3]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_e66fcbb826fd26bf4d657e11bf382aa3]['bbcodeVersion'] = $bbcodeVersion;
}
...
{
$count_a7720576fa1ec24d3c879a0fce8ffe99 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_a7720576fa1ec24d3c879a0fce8ffe99]['options'] = $options;
$this->functionData['editorLoadJs'][$count_a7720576fa1ec24d3c879a0fce8ffe99]['inlineLoad'] = $inlineLoad;
}
...
{
$count_d067a6db958614fd087e37d0582818da = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_d067a6db958614fd087e37d0582818da]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_d067a6db958614fd087e37d0582818da]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_d067a6db958614fd087e37d0582818da]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_d067a6db958614fd087e37d0582818da]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__95d9e8e906be37e35aa3ef4437aa3732($rows,$pages,$app,$plugin)."		") : ("
...
function __f__95d9e8e906be37e35aa3ef4437aa3732($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_06b1321d474e698faefa5e83bf961c65 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_06b1321d474e698faefa5e83bf961c65]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__ae39bc7c5c5feb8213bd0dc62dfce941($tabs)."			</ul>
		</div>
...
function __f__ae39bc7c5c5feb8213bd0dc62dfce941($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
