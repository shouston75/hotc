...
class skin_ibEconomy_9 extends skinMaster{
...
{
$count_88ec0f358d8fb2623db734d14e37bd32 = is_array($this->functionData['area_side_bar']) ? count($this->functionData['area_side_bar']) : 0;
$this->functionData['area_side_bar'][$count_88ec0f358d8fb2623db734d14e37bd32]['isActive'] = $isActive;
$this->functionData['area_side_bar'][$count_88ec0f358d8fb2623db734d14e37bd32]['areaLangName'] = $areaLangName;
$this->functionData['area_side_bar'][$count_88ec0f358d8fb2623db734d14e37bd32]['title'] = $title;
$this->functionData['area_side_bar'][$count_88ec0f358d8fb2623db734d14e37bd32]['moreURL'] = $moreURL;
}
...
{
$count_77d67fa1074528d27e16559d38572f97 = is_array($this->functionData['blockRowLotto']) ? count($this->functionData['blockRowLotto']) : 0;
$this->functionData['blockRowLotto'][$count_77d67fa1074528d27e16559d38572f97]['row'] = $row;
$this->functionData['blockRowLotto'][$count_77d67fa1074528d27e16559d38572f97]['block'] = $block;
}
...
{
$count_daab4ecdc18afbfb8162e4528347685a = is_array($this->functionData['blocks']) ? count($this->functionData['blocks']) : 0;
$this->functionData['blocks'][$count_daab4ecdc18afbfb8162e4528347685a]['blocks'] = $blocks;
}
...
{
$count_d2e90e3ba2b33bd4966ac40de0b9a77a = is_array($this->functionData['button_row']) ? count($this->functionData['button_row']) : 0;
$this->functionData['button_row'][$count_d2e90e3ba2b33bd4966ac40de0b9a77a]['my_points'] = $my_points;
$this->functionData['button_row'][$count_d2e90e3ba2b33bd4966ac40de0b9a77a]['leftButtons'] = $leftButtons;
}
...
{
$count_f3ec8075b72db7f73654e35ce6abaff5 = is_array($this->functionData['cart_wrapper']) ? count($this->functionData['cart_wrapper']) : 0;
$this->functionData['cart_wrapper'][$count_f3ec8075b72db7f73654e35ce6abaff5]['content'] = $content;
$this->functionData['cart_wrapper'][$count_f3ec8075b72db7f73654e35ce6abaff5]['totals'] = $totals;
}
...
{
$count_9e19c6fa5950e910906eb7a37e66f2d3 = is_array($this->functionData['editMemPtsPop']) ? count($this->functionData['editMemPtsPop']) : 0;
$this->functionData['editMemPtsPop'][$count_9e19c6fa5950e910906eb7a37e66f2d3]['member'] = $member;
$this->functionData['editMemPtsPop'][$count_9e19c6fa5950e910906eb7a37e66f2d3]['url'] = $url;
}
...
{
$count_e6a4e57c27ef61a9858ae9ee5874f752 = is_array($this->functionData['init_js_css']) ? count($this->functionData['init_js_css']) : 0;
}
$IPBHTML .= "<!--JS-->
...
{
$count_33523847b6baeec05f52ce2df914142a = is_array($this->functionData['memberInfoPane']) ? count($this->functionData['memberInfoPane']) : 0;
$this->functionData['memberInfoPane'][$count_33523847b6baeec05f52ce2df914142a]['member'] = $member;
$this->functionData['memberInfoPane'][$count_33523847b6baeec05f52ce2df914142a]['miniShopItemBox'] = $miniShopItemBox;
}
...
{
$count_166f591686e3b89f77401b23a67cc21b = is_array($this->functionData['memberProfileDonate']) ? count($this->functionData['memberProfileDonate']) : 0;
$this->functionData['memberProfileDonate'][$count_166f591686e3b89f77401b23a67cc21b]['memberID'] = $memberID;
}
...
{
$count_9497ba2cf959f6f008ea5c2024d8f723 = is_array($this->functionData['memPanePop']) ? count($this->functionData['memPanePop']) : 0;
$this->functionData['memPanePop'][$count_9497ba2cf959f6f008ea5c2024d8f723]['member'] = $member;
$this->functionData['memPanePop'][$count_9497ba2cf959f6f008ea5c2024d8f723]['url'] = $url;
}
$IPBHTML .= "<form action='{$this->settings['base_url']}app=ibEconomy&amp;do=donate' method='post'>
		<table class='ipb_table'>
			<tr class='header'>
...
{
$count_f3e082a68c0683aa81169b48610bb75b = is_array($this->functionData['pointButton']) ? count($this->functionData['pointButton']) : 0;
$this->functionData['pointButton'][$count_f3e082a68c0683aa81169b48610bb75b]['member'] = $member;
}
...
{
$count_b4a242c859cd04c3b9d498ba45e8e470 = is_array($this->functionData['profileTab']) ? count($this->functionData['profileTab']) : 0;
$this->functionData['profileTab'][$count_b4a242c859cd04c3b9d498ba45e8e470]['assets'] = $assets;
$this->functionData['profileTab'][$count_b4a242c859cd04c3b9d498ba45e8e470]['transactions'] = $transactions;
$this->functionData['profileTab'][$count_b4a242c859cd04c3b9d498ba45e8e470]['member'] = $member;
$this->functionData['profileTab'][$count_b4a242c859cd04c3b9d498ba45e8e470]['shopItems'] = $shopItems;
}
...
{
$count_d6b892fbaf4ae6725f52bd5b4b44bdfc = is_array($this->functionData['settings']) ? count($this->functionData['settings']) : 0;
$this->functionData['settings'][$count_d6b892fbaf4ae6725f52bd5b4b44bdfc]['mySettings'] = $mySettings;
$this->functionData['settings'][$count_d6b892fbaf4ae6725f52bd5b4b44bdfc]['myPluginSettings'] = $myPluginSettings;
}
...
{
$count_8148511c1cbdc71fca14951ab587cd47 = is_array($this->functionData['standings_row']) ? count($this->functionData['standings_row']) : 0;
$this->functionData['standings_row'][$count_8148511c1cbdc71fca14951ab587cd47]['member'] = $member;
}
...
{
$count_7e7a7ad4d106dc3d7fe058e1daca97b8 = is_array($this->functionData['standings_wrapper']) ? count($this->functionData['standings_wrapper']) : 0;
$this->functionData['standings_wrapper'][$count_7e7a7ad4d106dc3d7fe058e1daca97b8]['content'] = $content;
$this->functionData['standings_wrapper'][$count_7e7a7ad4d106dc3d7fe058e1daca97b8]['pages'] = $pages;
$this->functionData['standings_wrapper'][$count_7e7a7ad4d106dc3d7fe058e1daca97b8]['active'] = $active;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("memberlist", "0" ) . "
...
{
$count_7e9ff1c92fa972e0e060c2446c89fa66 = is_array($this->functionData['stats']) ? count($this->functionData['stats']) : 0;
$this->functionData['stats'][$count_7e9ff1c92fa972e0e060c2446c89fa66]['active'] = $active;
$this->functionData['stats'][$count_7e9ff1c92fa972e0e060c2446c89fa66]['totals'] = $totals;
}
...
{
$count_fd4fb5e853589eb53a68abc20bb9bd23 = is_array($this->functionData['tab']) ? count($this->functionData['tab']) : 0;
$this->functionData['tab'][$count_fd4fb5e853589eb53a68abc20bb9bd23]['isActive'] = $isActive;
$this->functionData['tab'][$count_fd4fb5e853589eb53a68abc20bb9bd23]['tabName'] = $tabName;
$this->functionData['tab'][$count_fd4fb5e853589eb53a68abc20bb9bd23]['tabLangName'] = $tabLangName;
$this->functionData['tab'][$count_fd4fb5e853589eb53a68abc20bb9bd23]['title'] = $title;
}
$IPBHTML .= "<li " . (($isActive) ? ("class='active'") : ("")) . ">
...
{
$count_8a7414ff71ea71febe7a863d45dee04d = is_array($this->functionData['transactions_wrapper']) ? count($this->functionData['transactions_wrapper']) : 0;
$this->functionData['transactions_wrapper'][$count_8a7414ff71ea71febe7a863d45dee04d]['content'] = $content;
$this->functionData['transactions_wrapper'][$count_8a7414ff71ea71febe7a863d45dee04d]['otherSW'] = $otherSW;
$this->functionData['transactions_wrapper'][$count_8a7414ff71ea71febe7a863d45dee04d]['pages'] = $pages;
$this->functionData['transactions_wrapper'][$count_8a7414ff71ea71febe7a863d45dee04d]['showMember'] = $showMember;
}
$IPBHTML .= "<div class='maintitle ipsFilterbar'>
			<ul class='ipsList_inline ipsType_smaller'>
...
{
$count_c40910f3fdda1fc41654eba0870a8806 = is_array($this->functionData['wrapper']) ? count($this->functionData['wrapper']) : 0;
$this->functionData['wrapper'][$count_c40910f3fdda1fc41654eba0870a8806]['active'] = $active;
$this->functionData['wrapper'][$count_c40910f3fdda1fc41654eba0870a8806]['showpage'] = $showpage;
}
