...
class skin_ipchat_9 extends skinMaster{
...
{
$count_80b4f62ed81c751f16ccc47cafa3b849 = is_array($this->functionData['ajaxNewUser']) ? count($this->functionData['ajaxNewUser']) : 0;
$this->functionData['ajaxNewUser'][$count_80b4f62ed81c751f16ccc47cafa3b849]['data'] = $data;
}
...
{
$count_127a5a99b934fe7b1fc3838a2314a8c3 = is_array($this->functionData['chatRoom']) ? count($this->functionData['chatRoom']) : 0;
$this->functionData['chatRoom'][$count_127a5a99b934fe7b1fc3838a2314a8c3]['options'] = $options;
$this->functionData['chatRoom'][$count_127a5a99b934fe7b1fc3838a2314a8c3]['chatters'] = $chatters;
$this->functionData['chatRoom'][$count_127a5a99b934fe7b1fc3838a2314a8c3]['emoticons'] = $emoticons;
}
$IPBHTML .= "<script type='text/javascript'>
	...
	".$this->__f__3251b440f3740339f67fa4f554a3f54c($options,$chatters,$emoticons)."	// Ignore private chats from..
	".$this->__f__0b93fa57db6b66d7ddf7fc7b12a7546b($options,$chatters,$emoticons)."	
	" . ((isset( $this->memberData['_cache']['ignore_chat'] )) ? ("
		".$this->__f__9c9dfe364f2e28b6dfe9a3f79e8dd330($options,$chatters,$emoticons)."	") : ("")) . "
	
	// Badwords
	" . ((is_array($this->caches['badwords']) AND count($this->caches['badwords'])) ? ("
		".$this->__f__91c62fc4469ec3ddb69b7884338255a6($options,$chatters,$emoticons)."	") : ("")) . "
	
	// Groups
	".$this->__f__de75907370020e93406e7baabb6ab887($options,$chatters,$emoticons)."</script>
	...
	<div id='chat-online' class='general_box alt'>
		...
		<div id='chatters-online-wrap'>
			<ul id='chatters-online'>
				".$this->__f__251b40308155ee67e237cda56ba0645b($options,$chatters,$emoticons)."			</ul>
		</div>
...
<div id='mod-menu-container'>
	".$this->__f__9c471cf9e31ac4ba3b98f491093d7307($options,$chatters,$emoticons)."</div>
...
function __f__3251b440f3740339f67fa4f554a3f54c($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0b93fa57db6b66d7ddf7fc7b12a7546b($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__9c9dfe364f2e28b6dfe9a3f79e8dd330($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__91c62fc4469ec3ddb69b7884338255a6($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__de75907370020e93406e7baabb6ab887($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__251b40308155ee67e237cda56ba0645b($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__9c471cf9e31ac4ba3b98f491093d7307($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
{
$count_35e4b4cd7d3bab0b3cb248aebf83084f = is_array($this->functionData['chatRules']) ? count($this->functionData['chatRules']) : 0;
$this->functionData['chatRules'][$count_35e4b4cd7d3bab0b3cb248aebf83084f]['rules'] = $rules;
}
...
{
$count_852f22e9d240249c0df2afab010268db = is_array($this->functionData['ignoredUsersForm']) ? count($this->functionData['ignoredUsersForm']) : 0;
$this->functionData['ignoredUsersForm'][$count_852f22e9d240249c0df2afab010268db]['members'] = $members;
}
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__1b154076a003e39adee3dd434694085b($members)."	</table>
</fieldset>
<fieldset class=\"row2\">
...
function __f__1b154076a003e39adee3dd434694085b($members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
