...
class skin_global_comments_9 extends skinMaster{
...
{
$count_30ce4172441ebb7c46a5f6e762b47d14 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_30ce4172441ebb7c46a5f6e762b47d14]['r'] = $r;
$this->functionData['comment'][$count_30ce4172441ebb7c46a5f6e762b47d14]['parent'] = $parent;
$this->functionData['comment'][$count_30ce4172441ebb7c46a5f6e762b47d14]['settings'] = $settings;
}
...
{
$count_fae9d9432b1b66f0abaf041ffded69ff = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_fae9d9432b1b66f0abaf041ffded69ff]['r'] = $r;
$this->functionData['commentHidden'][$count_fae9d9432b1b66f0abaf041ffded69ff]['parent'] = $parent;
$this->functionData['commentHidden'][$count_fae9d9432b1b66f0abaf041ffded69ff]['settings'] = $settings;
}
...
{
$count_c160fbdbc1a05d45f4e96c5bfb0efbc4 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_c160fbdbc1a05d45f4e96c5bfb0efbc4]['comments'] = $comments;
$this->functionData['commentsList'][$count_c160fbdbc1a05d45f4e96c5bfb0efbc4]['settings'] = $settings;
$this->functionData['commentsList'][$count_c160fbdbc1a05d45f4e96c5bfb0efbc4]['pages'] = $pages;
$this->functionData['commentsList'][$count_c160fbdbc1a05d45f4e96c5bfb0efbc4]['parent'] = $parent;
$this->functionData['commentsList'][$count_c160fbdbc1a05d45f4e96c5bfb0efbc4]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__9e7f3bff8d4860b7c3c01541273e9e4a($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__9e7f3bff8d4860b7c3c01541273e9e4a($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c61dac6c848a6504e8666c2776e45d89 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_c61dac6c848a6504e8666c2776e45d89]['comment'] = $comment;
$this->functionData['form'][$count_c61dac6c848a6504e8666c2776e45d89]['parent'] = $parent;
$this->functionData['form'][$count_c61dac6c848a6504e8666c2776e45d89]['editor'] = $editor;
$this->functionData['form'][$count_c61dac6c848a6504e8666c2776e45d89]['settings'] = $settings;
$this->functionData['form'][$count_c61dac6c848a6504e8666c2776e45d89]['errors'] = $errors;
$this->functionData['form'][$count_c61dac6c848a6504e8666c2776e45d89]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
