...
class skin_ipchat_14 extends skinMaster{
...
{
$count_7a53c1a51a1819bdadf65714ca7362c0 = is_array($this->functionData['ajaxNewUser']) ? count($this->functionData['ajaxNewUser']) : 0;
$this->functionData['ajaxNewUser'][$count_7a53c1a51a1819bdadf65714ca7362c0]['data'] = $data;
}
...
{
$count_31af89230826ba5fa285ea16d383d1b2 = is_array($this->functionData['chatRoom']) ? count($this->functionData['chatRoom']) : 0;
$this->functionData['chatRoom'][$count_31af89230826ba5fa285ea16d383d1b2]['options'] = $options;
$this->functionData['chatRoom'][$count_31af89230826ba5fa285ea16d383d1b2]['chatters'] = $chatters;
$this->functionData['chatRoom'][$count_31af89230826ba5fa285ea16d383d1b2]['emoticons'] = $emoticons;
}
$IPBHTML .= "<script type='text/javascript'>
	...
	".$this->__f__c30a1abbc66b6b8b301c90868cf203f9($options,$chatters,$emoticons)."	// Ignore private chats from..
	".$this->__f__4927f3505263a3adbe855d67edd7535c($options,$chatters,$emoticons)."	
	" . ((isset( $this->memberData['_cache']['ignore_chat'] )) ? ("
		".$this->__f__83326c7018b4c916ba7b9e3c05763d71($options,$chatters,$emoticons)."	") : ("")) . "
	
	// Badwords
	" . ((is_array($this->caches['badwords']) AND count($this->caches['badwords'])) ? ("
		".$this->__f__cfed6fb3048000b509a18fbedbb362dd($options,$chatters,$emoticons)."	") : ("")) . "
	
	// Groups
	".$this->__f__323a24dc468dcf9cb4289556c70a5ada($options,$chatters,$emoticons)."</script>
	...
	<div id='chat-online' class='general_box alt'>
		...
		<div id='chatters-online-wrap'>
			<ul id='chatters-online'>
				".$this->__f__474cf40cb32cd7da3fd59dda73be8ece($options,$chatters,$emoticons)."			</ul>
		</div>
...
<div id='mod-menu-container'>
	".$this->__f__6a6ec46b5aad4ba74241901d1605701b($options,$chatters,$emoticons)."</div>
...
function __f__c30a1abbc66b6b8b301c90868cf203f9($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4927f3505263a3adbe855d67edd7535c($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__83326c7018b4c916ba7b9e3c05763d71($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cfed6fb3048000b509a18fbedbb362dd($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__323a24dc468dcf9cb4289556c70a5ada($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__474cf40cb32cd7da3fd59dda73be8ece($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__6a6ec46b5aad4ba74241901d1605701b($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
{
$count_24804a80d95167d3a209903070208d9e = is_array($this->functionData['chatRules']) ? count($this->functionData['chatRules']) : 0;
$this->functionData['chatRules'][$count_24804a80d95167d3a209903070208d9e]['rules'] = $rules;
}
...
{
$count_396294d3c2035358eef276a5119fcaf2 = is_array($this->functionData['ignoredUsersForm']) ? count($this->functionData['ignoredUsersForm']) : 0;
$this->functionData['ignoredUsersForm'][$count_396294d3c2035358eef276a5119fcaf2]['members'] = $members;
}
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__bcf50b722849a842de08ce5cdb517430($members)."	</table>
</fieldset>
<fieldset class=\"row2\">
...
function __f__bcf50b722849a842de08ce5cdb517430($members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
