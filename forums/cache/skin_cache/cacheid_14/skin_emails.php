...
class skin_emails_14 extends skinMaster{
...
{
$count_b0e061292d515b1af6e00c10e23202d8 = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_b0e061292d515b1af6e00c10e23202d8]['title'] = $title;
$this->functionData['forward_form'][$count_b0e061292d515b1af6e00c10e23202d8]['text'] = $text;
$this->functionData['forward_form'][$count_b0e061292d515b1af6e00c10e23202d8]['lang'] = $lang;
$this->functionData['forward_form'][$count_b0e061292d515b1af6e00c10e23202d8]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_b0e061292d515b1af6e00c10e23202d8]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__ffc136bf1542e85ff8da6d09ea9d1201($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__ffc136bf1542e85ff8da6d09ea9d1201($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
