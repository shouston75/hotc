...
class skin_global_comments_14 extends skinMaster{
...
{
$count_d8032df6485f365a5e7092c4e2674b61 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_d8032df6485f365a5e7092c4e2674b61]['r'] = $r;
$this->functionData['comment'][$count_d8032df6485f365a5e7092c4e2674b61]['parent'] = $parent;
$this->functionData['comment'][$count_d8032df6485f365a5e7092c4e2674b61]['settings'] = $settings;
}
...
{
$count_ac193dd0e1b9bbd47e8a1abcc43e0b91 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_ac193dd0e1b9bbd47e8a1abcc43e0b91]['r'] = $r;
$this->functionData['commentHidden'][$count_ac193dd0e1b9bbd47e8a1abcc43e0b91]['parent'] = $parent;
$this->functionData['commentHidden'][$count_ac193dd0e1b9bbd47e8a1abcc43e0b91]['settings'] = $settings;
}
...
{
$count_7f68db40a63fd534619297ca34a17f40 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_7f68db40a63fd534619297ca34a17f40]['comments'] = $comments;
$this->functionData['commentsList'][$count_7f68db40a63fd534619297ca34a17f40]['settings'] = $settings;
$this->functionData['commentsList'][$count_7f68db40a63fd534619297ca34a17f40]['pages'] = $pages;
$this->functionData['commentsList'][$count_7f68db40a63fd534619297ca34a17f40]['parent'] = $parent;
$this->functionData['commentsList'][$count_7f68db40a63fd534619297ca34a17f40]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__fac47669fa65652a73fb22555752a613($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__fac47669fa65652a73fb22555752a613($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1c4d1ea7278583238c8f2626e561acba = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_1c4d1ea7278583238c8f2626e561acba]['comment'] = $comment;
$this->functionData['form'][$count_1c4d1ea7278583238c8f2626e561acba]['parent'] = $parent;
$this->functionData['form'][$count_1c4d1ea7278583238c8f2626e561acba]['editor'] = $editor;
$this->functionData['form'][$count_1c4d1ea7278583238c8f2626e561acba]['settings'] = $settings;
$this->functionData['form'][$count_1c4d1ea7278583238c8f2626e561acba]['errors'] = $errors;
$this->functionData['form'][$count_1c4d1ea7278583238c8f2626e561acba]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
