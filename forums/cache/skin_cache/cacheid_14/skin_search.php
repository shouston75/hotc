...
class skin_search_14 extends skinMaster{
...
$this->_funcHooks['asForumPosts'] = array('notLastFt','topicsForumTrail','gotonewpost','hasForumTrail','postQueued','postMid','postOnline','postMember','isAdmin','postIcon','postEditByReason','postEditBy','showReason','sDeleted','postSignature');
...
{
$count_5e6400f229bf3f9114047112853d8f8f = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_5e6400f229bf3f9114047112853d8f8f]['data'] = $data;
}
$IPBHTML .= "<!--Begin Msg Number {$data['pid']}-->
<br />
<div class='maintitle links'>
	" . ((!$data['_isRead']) ? ("<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$data['tid']}&amp;view=getnewpost", "public",'' ), "{$data['title_seo']}", "showtopic" ) . "' title='{$this->lang->words['first_unread_post']}'>" . $this->registry->getClass('output')->getReplacement("f_newpost") . "</a>") : ("")) . "
	" . (($data['_forum_trail']) ? ("
			".$this->__f__d6ae2fcf2f4d1f4d48c0c8146c811f71($data)."	") : ("")) . "
	&gt; <a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$data['tid']}", "public",'' ), "{$data['title_seo']}", "showtopic" ) . "\">{$data['topic_title']}</a>
</div>
<div class='post_block hentry mmod clear " . (($data['queued'] OR $data['approved'] != 1) ? ("moderated") : ("")) . "' id='post_id_{$data['pid']}'>
	<a id='entry{$data['pid']}'></a>
	<div class='post_wrap'>
		" . (($data['member_id']) ? ("
			<h3>
		") : ("
			<h3 class='guest'>
		")) . "
			<span class='post_id'><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$data['topic_id']}&amp;view=findpost&amp;p={$data['pid']}", "public",'' ), "{$topic['title_seo']}", "showtopic" ) . "' rel='bookmark' title='{$this->lang->words['link_to_post']} #{$data['pid']}'>#{$data['pid']}</a></span>
			" . (($data['member_id']) ? ("" . (($data['_online']) ? ("
					" . $this->registry->getClass('output')->getReplacement("user_online") . "
				") : ("
					" . $this->registry->getClass('output')->getReplacement("user_offline") . "
				")) . " &nbsp;
					<span class=\"author vcard\"><a class=\"url fn\" href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$data['member_id']}", "public",'' ), "{$data['members_seo_name']}", "showuser" ) . "'>{$data['members_display_name']}</a>" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'user_popup' ) ? $this->registry->getClass('output')->getTemplate('global')->user_popup($data['member_id'], $data['members_seo_name']) : '' ) . "</span>") : ("
				{$data['members_display_name']}
			")) . "
		</h3>
		<div class='author_info'>
			" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userInfoPane' ) ? $this->registry->getClass('output')->getTemplate('global')->userInfoPane(array_merge( $data, array( 'posts' => $data['m_posts'] ) ), $data['pid'], array()) : '' ) . "
		</div>
		<div class='post_body'>
			<p class='posted_info'>
				" . (($this->memberData['g_is_supmod']) ? ("<input type='checkbox' id='checkbox_{$data['pid']}' name='selectedpids[]' value='{$data['pid']}' class='post_mod' />") : ("")) . "
				" . (($data['icon_id']) ? ("
					<img src=\"{$this->settings['public_dir']}style_extra/post_icons/icon{$data['icon_id']}.gif\" alt=\"{$this->lang->words['post_icon']}\" />&nbsp;
				") : ("")) . "
				{$this->lang->words['posted']} <abbr class=\"published\" title=\"" . date( 'c', $data['_post_date'] ) . "\">" . $this->registry->getClass('class_localization')->getDate($data['_post_date'],"long", 0) . "</abbr>
			</p>
			<div class='post entry-content search'>
				{$data['post']}
				{$data['attachmentHtml']}
				<br />
				" . (($data['edit_by']) ? ("<p class='edit'>
						{$data['edit_by']}
						" . (($data['post_edit_reason'] != '') ? ("
							<br />
							<span class='reason'>{$this->lang->words['reason_for_edit']} {$data['post_edit_reason']}</span>
						") : ("")) . "
					</p>") : ("")) . "
				" . (($data['_p_isDeleted'] AND $data['permissions']['PostSoftDeleteSee']) ? ("<br />
					<div class='desc'>
					" . $this->registry->getClass('output')->getReplacement("delete_post_icon") . " {$this->lang->words['post_deleted_by']} <a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$data['sData']['sdl_obj_member_id']}", "public",'' ), "{$data['sData']['members_seo_name']}", "showuser" ) . "'>{$data['sData']['members_display_name']}</a>" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'user_popup' ) ? $this->registry->getClass('output')->getTemplate('global')->user_popup($data['sData']['member_id'], $data['sData']['members_seo_name']) : '' ) . " on " . $this->registry->getClass('class_localization')->getDate($data['sData']['sdl_obj_date'],"long", 0) . ".
					" . (($data['permissions']['SoftDeleteReason']) ? ("" . (($data['sData']['sdl_obj_reason']) ? ("{$data['sData']['sdl_obj_reason']}") : ("{$this->lang->words['no_reason_given']}")) . "") : ("")) . "
					</div>") : ("")) . "
			</div>
			" . (($data['signature']) ? ("
				" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'signature_separator' ) ? $this->registry->getClass('output')->getTemplate('global')->signature_separator($data['signature']) : '' ) . "
			") : ("")) . "
		</div>
...
function __f__d6ae2fcf2f4d1f4d48c0c8146c811f71($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$f[1]}", "public",'' ), "{$f[2]}", "showforum" ) . "'>{$f[0]}</a> " . (($i+1 != count( $data['_forum_trail'] )) ? ("&gt;") : ("")) . "
...
{
$count_2eb2655774015888e12992d4fd78b4ea = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_2eb2655774015888e12992d4fd78b4ea]['data'] = $data;
}
$IPBHTML .= "<tr class='_recordRow __topic __tid{$data['tid']} " . ((!$data['_icon']['is_read']) ? ("unread") : ("")) . " expandable " . (($data['approved'] != 1) ? (" moderated") : ("")) . "' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
	...
	<td>
		...
		<span class='desc blend_links'>
			".$this->__f__8e3acec7efb807c76e8d115b01edea88($data)."		</span>
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__5b786d2bd7b951ca9b40a4f661458fc2($data)."			</ul>
		") : ("")) . "
	...
	<td class='col_f_post'>
		...
		<ul class='last_post ipsType_small'>
			" . ((IPSSearchRegistry::get('set.searchResultType') == 'both') ? ("
				...
				<li>
					<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$data['tid']}&amp;findpost={$data['pid']}", "public",'' ), "{$data['title_seo']}", "showtopic" ) . "' title='{$this->lang->words['goto_matching_post']}'>{$this->lang->words['n_posted']} " . $this->registry->getClass('class_localization')->getDate($data['_post_date'],"DATE", 0) . "</a>
				</li>
			") : ("
				<li>" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($data['last_poster']) : '' ) . "</li>
				<li>
...
function __f__8e3acec7efb807c76e8d115b01edea88($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
function __f__5b786d2bd7b951ca9b40a4f661458fc2($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1fc9c44124b890bcdf920da42bcf4626 = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_1fc9c44124b890bcdf920da42bcf4626]['followData'] = $followData;
}
...
{
$count_c221125678b4d49869ec48ca7de827c5 = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count