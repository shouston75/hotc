...
class skin_calendar_14 extends skinMaster{
...
{
$count_53e692c8f5de8242418970adf544dfe2 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_53e692c8f5de8242418970adf544dfe2]['month_day'] = $month_day;
$this->functionData['cal_date_cell'][$count_53e692c8f5de8242418970adf544dfe2]['events'] = $events;
$this->functionData['cal_date_cell'][$count_53e692c8f5de8242418970adf544dfe2]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_53e692c8f5de8242418970adf544dfe2]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_53e692c8f5de8242418970adf544dfe2]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
" . (($queued != 0) ? ("
...
{
$count_55b169e1333853e6fe6bdc510116f164 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_55b169e1333853e6fe6bdc510116f164]['month_day'] = $month_day;
$this->functionData['cal_date_cell_today'][$count_55b169e1333853e6fe6bdc510116f164]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_55b169e1333853e6fe6bdc510116f164]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_55b169e1333853e6fe6bdc510116f164]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_55b169e1333853e6fe6bdc510116f164]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
" . (($queued != 0) ? ("
...
$this->row_class = ( $this->row_class == 'calrow1' ) ? 'calrow2' : 'calrow1';
$IPBHTML .= "</tr>
<!-- NEW ROW--><tr class='{$this->row_class}'>
	<th class='view_week calendar_header' scope='row'>
...
{
$count_429806fa8b8d9b6ae6bc14d5d728423b = is_array($this->functionData['cal_show_event']) ? count($this->functionData['cal_show_event']) : 0;
$this->functionData['cal_show_event'][$count_429806fa8b8d9b6ae6bc14d5d728423b]['event'] = $event;
$this->functionData['cal_show_event'][$count_429806fa8b8d9b6ae6bc14d5d728423b]['member'] = $member;
$this->functionData['cal_show_event'][$count_429806fa8b8d9b6ae6bc14d5d728423b]['event_type'] = $event_type;
$this->functionData['cal_show_event'][$count_429806fa8b8d9b6ae6bc14d5d728423b]['edit_button'] = $edit_button;
$this->functionData['cal_show_event'][$count_429806fa8b8d9b6ae6bc14d5d728423b]['approve_button'] = $approve_button;
$this->functionData['cal_show_event'][$count_429806fa8b8d9b6ae6bc14d5d728423b]['type'] = $type;
$this->functionData['cal_show_event'][$count_429806fa8b8d9b6ae6bc14d5d728423b]['date_ends'] = $date_ends;
}
...
{
$count_0b329961ef553b23d3b982445dc535a7 = is_array($this->functionData['cal_week_content']) ? count($this->functionData['cal_week_content']) : 0;
$this->functionData['cal_week_content'][$count_0b329961ef553b23d3b982445dc535a7]['calendars'] = $calendars;
$this->functionData['cal_week_content'][$count_0b329961ef553b23d3b982445dc535a7]['date'] = $date;
$this->functionData['cal_week_content'][$count_0b329961ef553b23d3b982445dc535a7]['month'] = $month;
$this->functionData['cal_week_content'][$count_0b329961ef553b23d3b982445dc535a7]['year'] = $year;
$this->functionData['cal_week_content'][$count_0b329961ef553b23d3b982445dc535a7]['prev'] = $prev;
$this->functionData['cal_week_content'][$count_0b329961ef553b23d3b982445dc535a7]['next'] = $next;
$this->functionData['cal_week_content'][$count_0b329961ef553b23d3b982445dc535a7]['cal_id'] = $cal_id;
}
...
<div id='mini_calendars' class='left calendar_wrap'>
	<div id='calendar_list' class='left general_box'>
		...
		<ol>
			".$this->__f__40185b13838cf5f5ed321dbb870e7f5a($calendars,$date,$month,$year,$prev,$next,$cal_id)."		</ol>
		") : ("")) . "
...
function __f__40185b13838cf5f5ed321dbb870e7f5a($calendars, $date="",$month="",$year="",$prev="",$next="", $cal_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ede8827a2a4aca1abad7045254ac1eca = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_ede8827a2a4aca1abad7045254ac1eca]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_ede8827a2a4aca1abad7045254ac1eca]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_ede8827a2a4aca1abad7045254ac1eca]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_ede8827a2a4aca1abad7045254ac1eca]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_ede8827a2a4aca1abad7045254ac1eca]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_ede8827a2a4aca1abad7045254ac1eca]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_ede8827a2a4aca1abad7045254ac1eca]['queued'] = $queued;
}
...
{
$count_850fdec723eb1add89d1612f10be7b77 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_850fdec723eb1add89d1612f10be7b77]['rows'] = $rows;
}
...
<div class='general_box'>	<ul>
		".$this->__f__174f5f2b3812d64f3f15bfdb13e2c119($rows)."	</ul>
</div>";
return $IPBHTML;
}


function __f__174f5f2b3812d64f3f15bfdb13e2c119($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_053ed16203e10f26732b1173989d2739 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['code'] = $code;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['calendar_id'] = $calendar_id;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['formtype'] = $formtype;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['event_id'] = $event_id;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['event_title'] = $event_title;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['form_title'] = $form_title;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['event_date'] = $event_date;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['event_type'] = $event_type;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['groups'] = $groups;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['button'] = $button;
$this->functionData['calendarEventForm'][$count_053ed16203e10f26732b1173989d2739]['editor'] = $editor;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
...
{
$count_5fe7dc4a32735caed119a2120899f5b5 = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_5fe7dc4a32735caed119a2120899f5b5]['calendars'] = $calendars;
$this->functionData['calendarMainContent'][$count_5fe7dc4a32735caed119a2120899f5b5]['month'] = $month;
$this->functionData['calendarMainContent'][$count_5fe7dc4a32735caed119a2120899f5b5]['year'] = $year;
$this->functionData['calendarMainContent'][$count_5fe7dc4a32735caed119a2120899f5b5]['prev'] = $prev;
$this->functionData['calendarMainContent'][$count_5fe7dc4a32735caed119a2120899f5b5]['next'] = $next;
$this->functionData['calendarMainContent'][$count_5fe7dc4a32735caed119a2120899f5b5]['cal_jump'] = $cal_jump;
$this->functionData['calendarMainContent'][$count_5fe7dc4a32735caed119a2120899f5b5]['cal_id'] = $cal_id;
$this->functionData['calendarMainContent'][$count_5fe7dc4a32735caed119a2120899f5b5]['day_words'] = $day_words;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<h2>{$this->lang->words['calendars']}</h2>
<div id='calendar_list' class='left general_box'>
	...
	<p><strong>{$this->lang->words['select_calendar']}</strong></p>
	<ol>
		".$this->__f__b0547b5d3dd8576b5d2e925af8dcfd65($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."	</ol>
	") : ("")) . "
	<strong>{$this->lang->words['jump_to']}</strong><br />
...
<div id='current_calendar' class='right calendar_wrap'>
	...
	<table id='calendar_table' class='ipb_table' summary=\"{$this->lang->words['calendar_for']} {$month} {$year}\">
		...
		<tr class='header2'>
			...
			".$this->__f__6d06f8d61235f6c4bbd3552a465746d7($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."			<!--IBF.DAYS_CONTENT-->
		</tr>
	</table>
...
function __f__b0547b5d3dd8576b5d2e925af8dcfd65($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $calendars as $cid => $cal )
...
function __f__6d06f8d61235f6c4bbd3552a465746d7($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c97d5e2384ad02c2a224efa832616575 = is_array($this->functionData['mini_cal_mini_wrap']) ? count($this->functionData['mini_cal_mini_wrap']) : 0;
$this->functionData['mini_cal_mini_wrap'][$count_c97d5e2384ad02c2a224efa832616575]['month'] = $month;
$this->functionData['mini_cal_mini_wrap'][$count_c97d5e2384ad02c2a224efa832616575]['mid'] = $mid;
$this->functionData['mini_cal_mini_wrap'][$count_c97d5e2384ad02c2a224efa832616575]['year'] = $year;
$this->functionData['mini_cal_mini_wrap'][$count_c97d5e2384ad02c2a224efa832616575]['events'] = $events;
$this->functionData['mini_cal_mini_wrap'][$count_c97d5e2384ad02c2a224efa832616575]['day_words'] = $day_words;
}
...
<h3 class='minimaintitle'>{$month} {$year}</h3>
<table class='mini_cal'>
	<tr class='header2'>
		<th class='head_week'>&nbsp;</th>
	".$this->__f__ab979be33f790eeac82cabf6fb519032($month,$mid,$year,$events,$day_words)."	</tr>
	{$events}
</table>";
return $IPBHTML;
}
...
function __f__ab979be33f790eeac82cabf6fb519032($month="",$mid="",$year="",$events="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day_words as $day )
...
$this->mini_cal = ( $this->mini_cal == 'minicalrow1' ) ? 'minicalrow2' : 'minicalrow1';
		$this->request['_cal_id'] = ( $this->request['_cal_id'] ) ? $this->request['_cal_id'] : 1;
$IPBHTML .= "</tr>
	<!-- NEW ROW-->
	<tr class='{$this->mini_cal}'>
	<th class='view_week minicalendar_header'>
		<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$this->request['_cal_id']}&amp;do=showweek&amp;week={$week}", "public",'' ), "false", "cal_week" ) . "\" title='{$this->lang->words['view_this_week']}' ><img src=\"{$this->settings['img_url']}/next.png\" alt='{$this->lang->words['icon']}' /></a>
	</th>";
return $IPBHTML;
}
