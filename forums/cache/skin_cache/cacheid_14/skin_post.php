...
class skin_post_14 extends skinMaster{
...
{
$count_418d7b07f59a0d04d3f9ab6849a9d958 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_418d7b07f59a0d04d3f9ab6849a9d958]['data'] = $data;
}
...
{
$count_5452389c563556eb0c461cc32a80de53 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_5452389c563556eb0c461cc32a80de53]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_5452389c563556eb0c461cc32a80de53]['form'] = $form;
}
...
{
$count_eef56a435601a69911e1eea2aa30ed05 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_eef56a435601a69911e1eea2aa30ed05]['data'] = $data;
}
...
{
$count_0e3f4127dc182a78fe557b06db15d407 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_0e3f4127dc182a78fe557b06db15d407]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__418f448b42bc06f719b9ed0e9e025ada($posts)."") : ("")) . "
<p class='submit'>
...
function __f__418f448b42bc06f719b9ed0e9e025ada($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9180ae123ca4afcae1159aae0ede940c = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_9180ae123ca4afcae1159aae0ede940c]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_9180ae123ca4afcae1159aae0ede940c]['type'] = $type;
$this->functionData['uploadForm'][$count_9180ae123ca4afcae1159aae0ede940c]['stats'] = $stats;
$this->functionData['uploadForm'][$count_9180ae123ca4afcae1159aae0ede940c]['id'] = $id;
$this->functionData['uploadForm'][$count_9180ae123ca4afcae1159aae0ede940c]['forum_id'] = $forum_id;
}
