...
class skin_portal_14 extends skinMaster{
...
{
$count_9b3074fdb531239dc2c6de735748a2f7 = is_array($this->functionData['articles']) ? count($this->functionData['articles']) : 0;
$this->functionData['articles'][$count_9b3074fdb531239dc2c6de735748a2f7]['articles'] = $articles;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
<div class='ipsBox clear'>

    ".$this->__f__fe314bb792df16c85b4270ec65b89abe($articles)."</div>";
return $IPBHTML;
}


function __f__fe314bb792df16c85b4270ec65b89abe($articles)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_325309172e52f526186ee175970b9274 = is_array($this->functionData['latestPosts']) ? count($this->functionData['latestPosts']) : 0;
$this->functionData['latestPosts'][$count_325309172e52f526186ee175970b9274]['topics'] = $topics;
}
$IPBHTML .= "<div class='ipsSideBlock'>
     <h3>{$this->lang->words['discuss_title']}</h3>
		<ul class='ipsList_withminiphoto'>
		".$this->__f__efd7e82cb0733a3526b8c642997c17ef($topics)."		</ul>
</div>";
return $IPBHTML;
}


function __f__efd7e82cb0733a3526b8c642997c17ef($topics=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_85756634b9c910c3c79439ea853c650d = is_array($this->functionData['siteNavigation']) ? count($this->functionData['siteNavigation']) : 0;
$this->functionData['siteNavigation'][$count_85756634b9c910c3c79439ea853c650d]['links'] = $links;
}
$IPBHTML .= "<div class='ipsSideBlock'>
        <h3>{$this->lang->words['links_title']}</h3>
	<ul>
		".$this->__f__873f03719709d97146c74f677463fb10($links)."	</ul>
</div>";
return $IPBHTML;
}


function __f__873f03719709d97146c74f677463fb10($links=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_09bb18522c539272e3a9cb1d2b5bcbe6 = is_array($this->functionData['skeletonTemplate']) ? count($this->functionData['skeletonTemplate']) : 0;
}
