...
class skin_editors_14 extends skinMaster{
...
{
$count_fc6dd333bbe8cdabb490a5c25d3cc52b = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_fc6dd333bbe8cdabb490a5c25d3cc52b]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_fc6dd333bbe8cdabb490a5c25d3cc52b]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_fc6dd333bbe8cdabb490a5c25d3cc52b]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_fc6dd333bbe8cdabb490a5c25d3cc52b]['extraData'] = $extraData;
}
...
{
$count_ab9908c9f1965882ead3d4cbee50af6a = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_ab9908c9f1965882ead3d4cbee50af6a]['formField'] = $formField;
$this->functionData['editor'][$count_ab9908c9f1965882ead3d4cbee50af6a]['content'] = $content;
$this->functionData['editor'][$count_ab9908c9f1965882ead3d4cbee50af6a]['options'] = $options;
$this->functionData['editor'][$count_ab9908c9f1965882ead3d4cbee50af6a]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_ab9908c9f1965882ead3d4cbee50af6a]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_ab9908c9f1965882ead3d4cbee50af6a]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_ab9908c9f1965882ead3d4cbee50af6a]['bbcodeVersion'] = $bbcodeVersion;
}
...
{
$count_ed41fdb6b85304866974604c1da985ed = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_ed41fdb6b85304866974604c1da985ed]['options'] = $options;
$this->functionData['editorLoadJs'][$count_ed41fdb6b85304866974604c1da985ed]['inlineLoad'] = $inlineLoad;
}
...
{
$count_e9c25ffb2873bc60fc460f85382f7d15 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_e9c25ffb2873bc60fc460f85382f7d15]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_e9c25ffb2873bc60fc460f85382f7d15]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_e9c25ffb2873bc60fc460f85382f7d15]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_e9c25ffb2873bc60fc460f85382f7d15]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__e74638548ba2d8001a04d89c5763040f($rows,$pages,$app,$plugin)."		") : ("
...
function __f__e74638548ba2d8001a04d89c5763040f($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_4b756bff643827b299cd8165ee730385 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_4b756bff643827b299cd8165ee730385]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__4fc46c426e6af8dab5c5f0e1643b71ae($tabs)."			</ul>
		</div>
...
function __f__4fc46c426e6af8dab5c5f0e1643b71ae($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
