...
class skin_ibEconomy_1 extends skinMaster{
...
{
$count_67eac7df8dace4cc1492e6ba86a51af1 = is_array($this->functionData['area_side_bar']) ? count($this->functionData['area_side_bar']) : 0;
$this->functionData['area_side_bar'][$count_67eac7df8dace4cc1492e6ba86a51af1]['isActive'] = $isActive;
$this->functionData['area_side_bar'][$count_67eac7df8dace4cc1492e6ba86a51af1]['areaLangName'] = $areaLangName;
$this->functionData['area_side_bar'][$count_67eac7df8dace4cc1492e6ba86a51af1]['title'] = $title;
$this->functionData['area_side_bar'][$count_67eac7df8dace4cc1492e6ba86a51af1]['moreURL'] = $moreURL;
}
...
{
$count_3e225913f3055b8e3ab7d46c34475a01 = is_array($this->functionData['blockRowLotto']) ? count($this->functionData['blockRowLotto']) : 0;
$this->functionData['blockRowLotto'][$count_3e225913f3055b8e3ab7d46c34475a01]['row'] = $row;
$this->functionData['blockRowLotto'][$count_3e225913f3055b8e3ab7d46c34475a01]['block'] = $block;
}
...
{
$count_89c2d4d66a430a00b6facbec7843b8eb = is_array($this->functionData['blocks']) ? count($this->functionData['blocks']) : 0;
$this->functionData['blocks'][$count_89c2d4d66a430a00b6facbec7843b8eb]['blocks'] = $blocks;
}
...
{
$count_98b6fe097a4e921ceef007e714399430 = is_array($this->functionData['button_row']) ? count($this->functionData['button_row']) : 0;
$this->functionData['button_row'][$count_98b6fe097a4e921ceef007e714399430]['my_points'] = $my_points;
$this->functionData['button_row'][$count_98b6fe097a4e921ceef007e714399430]['leftButtons'] = $leftButtons;
}
...
{
$count_0bcef4e75b2c3a345120c9be810a5b4c = is_array($this->functionData['cart_wrapper']) ? count($this->functionData['cart_wrapper']) : 0;
$this->functionData['cart_wrapper'][$count_0bcef4e75b2c3a345120c9be810a5b4c]['content'] = $content;
$this->functionData['cart_wrapper'][$count_0bcef4e75b2c3a345120c9be810a5b4c]['totals'] = $totals;
}
...
{
$count_25ac4d7f51a6901e260eb158e8b8ac2b = is_array($this->functionData['editMemPtsPop']) ? count($this->functionData['editMemPtsPop']) : 0;
$this->functionData['editMemPtsPop'][$count_25ac4d7f51a6901e260eb158e8b8ac2b]['member'] = $member;
$this->functionData['editMemPtsPop'][$count_25ac4d7f51a6901e260eb158e8b8ac2b]['url'] = $url;
}
...
{
$count_a0ccaa3472da45632e33a60289817f03 = is_array($this->functionData['init_js_css']) ? count($this->functionData['init_js_css']) : 0;
}
$IPBHTML .= "<!--JS-->
...
{
$count_d8ed600f4279e182a84c8e0775d89b42 = is_array($this->functionData['memberInfoPane']) ? count($this->functionData['memberInfoPane']) : 0;
$this->functionData['memberInfoPane'][$count_d8ed600f4279e182a84c8e0775d89b42]['member'] = $member;
$this->functionData['memberInfoPane'][$count_d8ed600f4279e182a84c8e0775d89b42]['miniShopItemBox'] = $miniShopItemBox;
}
...
{
$count_2ff882cbd7746acffa1b3b51ca3dc6aa = is_array($this->functionData['memberProfileDonate']) ? count($this->functionData['memberProfileDonate']) : 0;
$this->functionData['memberProfileDonate'][$count_2ff882cbd7746acffa1b3b51ca3dc6aa]['memberID'] = $memberID;
}
...
{
$count_5b78c4b138093bb5056dca7affbb76b7 = is_array($this->functionData['memPanePop']) ? count($this->functionData['memPanePop']) : 0;
$this->functionData['memPanePop'][$count_5b78c4b138093bb5056dca7affbb76b7]['member'] = $member;
$this->functionData['memPanePop'][$count_5b78c4b138093bb5056dca7affbb76b7]['url'] = $url;
}
$IPBHTML .= "<form action='{$this->settings['base_url']}app=ibEconomy&amp;do=donate' method='post'>
		<table class='ipb_table'>
			<tr class='header'>
...
{
$count_55a007f8abbce8c0f5ecfd9cddc22230 = is_array($this->functionData['pointButton']) ? count($this->functionData['pointButton']) : 0;
$this->functionData['pointButton'][$count_55a007f8abbce8c0f5ecfd9cddc22230]['member'] = $member;
}
...
{
$count_dc1e184331b3bcbeb7c4bf137590edc3 = is_array($this->functionData['profileTab']) ? count($this->functionData['profileTab']) : 0;
$this->functionData['profileTab'][$count_dc1e184331b3bcbeb7c4bf137590edc3]['assets'] = $assets;
$this->functionData['profileTab'][$count_dc1e184331b3bcbeb7c4bf137590edc3]['transactions'] = $transactions;
$this->functionData['profileTab'][$count_dc1e184331b3bcbeb7c4bf137590edc3]['member'] = $member;
$this->functionData['profileTab'][$count_dc1e184331b3bcbeb7c4bf137590edc3]['shopItems'] = $shopItems;
}
...
{
$count_a813a1e5bf016a287ac40ac0a2d01dd2 = is_array($this->functionData['settings']) ? count($this->functionData['settings']) : 0;
$this->functionData['settings'][$count_a813a1e5bf016a287ac40ac0a2d01dd2]['mySettings'] = $mySettings;
$this->functionData['settings'][$count_a813a1e5bf016a287ac40ac0a2d01dd2]['myPluginSettings'] = $myPluginSettings;
}
...
{
$count_6a597b8eb7ee91be84c9ef67aafbafd8 = is_array($this->functionData['standings_row']) ? count($this->functionData['standings_row']) : 0;
$this->functionData['standings_row'][$count_6a597b8eb7ee91be84c9ef67aafbafd8]['member'] = $member;
}
...
{
$count_b2043214d502e1a7a43a4e889c03a8d6 = is_array($this->functionData['standings_wrapper']) ? count($this->functionData['standings_wrapper']) : 0;
$this->functionData['standings_wrapper'][$count_b2043214d502e1a7a43a4e889c03a8d6]['content'] = $content;
$this->functionData['standings_wrapper'][$count_b2043214d502e1a7a43a4e889c03a8d6]['pages'] = $pages;
$this->functionData['standings_wrapper'][$count_b2043214d502e1a7a43a4e889c03a8d6]['active'] = $active;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("memberlist", "0" ) . "
...
{
$count_2c6fa5356fe4949af098f7b6d56fbf70 = is_array($this->functionData['stats']) ? count($this->functionData['stats']) : 0;
$this->functionData['stats'][$count_2c6fa5356fe4949af098f7b6d56fbf70]['active'] = $active;
$this->functionData['stats'][$count_2c6fa5356fe4949af098f7b6d56fbf70]['totals'] = $totals;
}
...
{
$count_ad3716e74cdb403d61b52186e767e414 = is_array($this->functionData['tab']) ? count($this->functionData['tab']) : 0;
$this->functionData['tab'][$count_ad3716e74cdb403d61b52186e767e414]['isActive'] = $isActive;
$this->functionData['tab'][$count_ad3716e74cdb403d61b52186e767e414]['tabName'] = $tabName;
$this->functionData['tab'][$count_ad3716e74cdb403d61b52186e767e414]['tabLangName'] = $tabLangName;
$this->functionData['tab'][$count_ad3716e74cdb403d61b52186e767e414]['title'] = $title;
}
$IPBHTML .= "<li " . (($isActive) ? ("class='active'") : ("")) . ">
...
{
$count_f4491b92bd7b8270753f8d9782a03d7f = is_array($this->functionData['transactions_wrapper']) ? count($this->functionData['transactions_wrapper']) : 0;
$this->functionData['transactions_wrapper'][$count_f4491b92bd7b8270753f8d9782a03d7f]['content'] = $content;
$this->functionData['transactions_wrapper'][$count_f4491b92bd7b8270753f8d9782a03d7f]['otherSW'] = $otherSW;
$this->functionData['transactions_wrapper'][$count_f4491b92bd7b8270753f8d9782a03d7f]['pages'] = $pages;
$this->functionData['transactions_wrapper'][$count_f4491b92bd7b8270753f8d9782a03d7f]['showMember'] = $showMember;
}
$IPBHTML .= "<div class='maintitle ipsFilterbar'>
			<ul class='ipsList_inline ipsType_smaller'>
...
{
$count_26c5dd22a1c3940c8136627aedd8ea4d = is_array($this->functionData['wrapper']) ? count($this->functionData['wrapper']) : 0;
$this->functionData['wrapper'][$count_26c5dd22a1c3940c8136627aedd8ea4d]['active'] = $active;
$this->functionData['wrapper'][$count_26c5dd22a1c3940c8136627aedd8ea4d]['showpage'] = $showpage;
}
