...
class skin_twitterBar_1 extends skinMaster{
	...
	<ul>
		<div id=\"friendsList\">
			<div id='friendsResult_{$page}'>
				".$this->__f__5c260217de53f6a947050ae34a2a3ec4($data,$page)."			</div>
		</div>
...
function __f__5c260217de53f6a947050ae34a2a3ec4($data, $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $u )
...
$IPBHTML .= "<div id='friendsResult_{$page}' style=\"display:none;\">
	".$this->__f__4ebefb4f310cf9c6f8e76859ef1401eb($data,$page)."</div>";
return $IPBHTML;
}


function __f__4ebefb4f310cf9c6f8e76859ef1401eb($data, $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $u )
...
$IPBHTML .= "" . ((is_array( $data ) && count( $data )) ? ("
	<div id='searchResult_{$page}' style=\"display:none;\">
		".$this->__f__40cc2290006355f120b4b10ada1c1ad4($data,$page)."	</div>
") : ("
...
function __f__40cc2290006355f120b4b10ada1c1ad4($data=array(), $page)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
...
$IPBHTML = "";
$IPBHTML .= "" . ((is_array( $data ) && count( $data ) && !isset( $data['error'] )) ? ("".$this->__f__728f2cb76c596752d3572ffdf06696b1($data)."") : ("<li class='row1'>
	" . ((isset( $data['error'] )) ? ("
		{$data['error']}
	") : ("
...
function __f__728f2cb76c596752d3572ffdf06696b1($data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
...
$IPBHTML .= "" . ((is_array( $data ) && count( $data ) && !isset( $data['error'] )) ? ("<div id=\"userInfoBlock\">
	...
	".$this->__f__890f029bbaf60a65b0dee16db8bef67c($data,$userData)."") : ("<li class='row1'>
	" . ((isset( $data['error'] )) ? ("
		{$data['error']}
	") : ("
		{$this->lang->words['errorNoTweets']}
...
function __f__890f029bbaf60a65b0dee16db8bef67c($data, $userData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $r )
