...
{
$count_096dee7719cf718ed16e7c98a5c3431a = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_096dee7719cf718ed16e7c98a5c3431a]['r'] = $r;
$this->functionData['comment'][$count_096dee7719cf718ed16e7c98a5c3431a]['parent'] = $parent;
$this->functionData['comment'][$count_096dee7719cf718ed16e7c98a5c3431a]['settings'] = $settings;
}
...
{
$count_a6308cdb1b07c89f760e0d4e80fecb63 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_a6308cdb1b07c89f760e0d4e80fecb63]['r'] = $r;
$this->functionData['commentHidden'][$count_a6308cdb1b07c89f760e0d4e80fecb63]['parent'] = $parent;
$this->functionData['commentHidden'][$count_a6308cdb1b07c89f760e0d4e80fecb63]['settings'] = $settings;
}
...
{
$count_cfcd14318ae1b1fa67e8fa321aaf2e68 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_cfcd14318ae1b1fa67e8fa321aaf2e68]['comments'] = $comments;
$this->functionData['commentsList'][$count_cfcd14318ae1b1fa67e8fa321aaf2e68]['settings'] = $settings;
$this->functionData['commentsList'][$count_cfcd14318ae1b1fa67e8fa321aaf2e68]['pages'] = $pages;
$this->functionData['commentsList'][$count_cfcd14318ae1b1fa67e8fa321aaf2e68]['parent'] = $parent;
$this->functionData['commentsList'][$count_cfcd14318ae1b1fa67e8fa321aaf2e68]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__a275585dd8304098a66992493d8e570d($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__a275585dd8304098a66992493d8e570d($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_431fd4d86108c2c33d51b838b8ee4ca4 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_431fd4d86108c2c33d51b838b8ee4ca4]['comment'] = $comment;
$this->functionData['form'][$count_431fd4d86108c2c33d51b838b8ee4ca4]['parent'] = $parent;
$this->functionData['form'][$count_431fd4d86108c2c33d51b838b8ee4ca4]['editor'] = $editor;
$this->functionData['form'][$count_431fd4d86108c2c33d51b838b8ee4ca4]['settings'] = $settings;
$this->functionData['form'][$count_431fd4d86108c2c33d51b838b8ee4ca4]['errors'] = $errors;
$this->functionData['form'][$count_431fd4d86108c2c33d51b838b8ee4ca4]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
