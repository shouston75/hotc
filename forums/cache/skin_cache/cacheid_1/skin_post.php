...
{
$count_9f5a3b1199c1fc5bf217bdce144cad73 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_9f5a3b1199c1fc5bf217bdce144cad73]['data'] = $data;
}
...
{
$count_08c4ab661ead4970632935e3563fa424 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_08c4ab661ead4970632935e3563fa424]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_08c4ab661ead4970632935e3563fa424]['form'] = $form;
}
...
{
$count_6d3ad8242cd33a87851988131ccee5ad = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_6d3ad8242cd33a87851988131ccee5ad]['data'] = $data;
}
...
{
$count_3e60f3fbfd60e8327c1d813d1a49b918 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_3e60f3fbfd60e8327c1d813d1a49b918]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__3e5a7f034e41c8761b5c709c4924b9c1($posts)."") : ("")) . "
<p class='submit'>
...
function __f__3e5a7f034e41c8761b5c709c4924b9c1($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_de19780e83546656b552ca579e3acd19 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_de19780e83546656b552ca579e3acd19]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_de19780e83546656b552ca579e3acd19]['type'] = $type;
$this->functionData['uploadForm'][$count_de19780e83546656b552ca579e3acd19]['stats'] = $stats;
$this->functionData['uploadForm'][$count_de19780e83546656b552ca579e3acd19]['id'] = $id;
$this->functionData['uploadForm'][$count_de19780e83546656b552ca579e3acd19]['forum_id'] = $forum_id;
}
