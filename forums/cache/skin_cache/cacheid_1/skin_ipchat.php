...
{
$count_98b396618d49ae06dc579c661d6b1b3f = is_array($this->functionData['ajaxNewUser']) ? count($this->functionData['ajaxNewUser']) : 0;
$this->functionData['ajaxNewUser'][$count_98b396618d49ae06dc579c661d6b1b3f]['data'] = $data;
}
...
{
$count_3721710485acbeb3e8062c68525945cd = is_array($this->functionData['chatRoom']) ? count($this->functionData['chatRoom']) : 0;
$this->functionData['chatRoom'][$count_3721710485acbeb3e8062c68525945cd]['options'] = $options;
$this->functionData['chatRoom'][$count_3721710485acbeb3e8062c68525945cd]['chatters'] = $chatters;
$this->functionData['chatRoom'][$count_3721710485acbeb3e8062c68525945cd]['emoticons'] = $emoticons;
}
$IPBHTML .= "<script type='text/javascript'>
	...
	".$this->__f__ec1abf3e2744014d7ea9a2528bf7d773($options,$chatters,$emoticons)."	// Ignore private chats from..
	".$this->__f__5c53155c6393cdfdee75707c8c61523b($options,$chatters,$emoticons)."	
	" . ((isset( $this->memberData['_cache']['ignore_chat'] )) ? ("
		".$this->__f__742d9622b2ac45e2fd8c8dd3c76b52cc($options,$chatters,$emoticons)."	") : ("")) . "
	
	// Badwords
	" . ((is_array($this->caches['badwords']) AND count($this->caches['badwords'])) ? ("
		".$this->__f__a1e5590b3c597157641d1b287915206b($options,$chatters,$emoticons)."	") : ("")) . "
	
	// Groups
	".$this->__f__7dbeb5b5914833e6b20b33acbb0441d8($options,$chatters,$emoticons)."</script>
	...
	<div id='chat-online' class='general_box alt'>
		...
		<div id='chatters-online-wrap'>
			<ul id='chatters-online'>
				".$this->__f__8116d66fd4650d6bd89290edc5058d5f($options,$chatters,$emoticons)."			</ul>
		</div>
...
<div id='mod-menu-container'>
	".$this->__f__004b1c4f699e8c5f74ce5c73d6c0ef05($options,$chatters,$emoticons)."</div>
...
function __f__ec1abf3e2744014d7ea9a2528bf7d773($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5c53155c6393cdfdee75707c8c61523b($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__742d9622b2ac45e2fd8c8dd3c76b52cc($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a1e5590b3c597157641d1b287915206b($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7dbeb5b5914833e6b20b33acbb0441d8($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8116d66fd4650d6bd89290edc5058d5f($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__004b1c4f699e8c5f74ce5c73d6c0ef05($options=array(), $chatters=array(), $emoticons)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
{
$count_1c064f64d224cb4637b677dbb47d1317 = is_array($this->functionData['chatRules']) ? count($this->functionData['chatRules']) : 0;
$this->functionData['chatRules'][$count_1c064f64d224cb4637b677dbb47d1317]['rules'] = $rules;
}
...
{
$count_74b7235845c5ad300a8e45679e06afe2 = is_array($this->functionData['ignoredUsersForm']) ? count($this->functionData['ignoredUsersForm']) : 0;
$this->functionData['ignoredUsersForm'][$count_74b7235845c5ad300a8e45679e06afe2]['members'] = $members;
}
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__9a35b63c2dcd6dd4950108de31c85cf4($members)."	</table>
</fieldset>
<fieldset class=\"row2\">
...
function __f__9a35b63c2dcd6dd4950108de31c85cf4($members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
