...
class skin_register_1 extends skinMaster{
...
{
$count_d690badc646ffc8dae21a2a74aac9a5f = is_array($this->functionData['completePartialLogin']) ? count($this->functionData['completePartialLogin']) : 0;
$this->functionData['completePartialLogin'][$count_d690badc646ffc8dae21a2a74aac9a5f]['mid'] = $mid;
$this->functionData['completePartialLogin'][$count_d690badc646ffc8dae21a2a74aac9a5f]['key'] = $key;
$this->functionData['completePartialLogin'][$count_d690badc646ffc8dae21a2a74aac9a5f]['custom_fields'] = $custom_fields;
$this->functionData['completePartialLogin'][$count_d690badc646ffc8dae21a2a74aac9a5f]['errors'] = $errors;
$this->functionData['completePartialLogin'][$count_d690badc646ffc8dae21a2a74aac9a5f]['reg'] = $reg;
$this->functionData['completePartialLogin'][$count_d690badc646ffc8dae21a2a74aac9a5f]['userFromService'] = $userFromService;
}
						...
						<ul class='ipsForm ipsForm_horizontal ipsPad'>
							...
							" . (($custom_fields != '') ? ("<fieldset class='rcomplete'>
								" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
									".$this->__f__6975f86c3f91b9938da0a0153e292bbf($mid,$key,$custom_fields,$errors,$reg,$userFromService)."								") : ("")) . "
	
								" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
									".$this->__f__a72fb9cf1373eb5434ed328734c24373($mid,$key,$custom_fields,$errors,$reg,$userFromService)."								") : ("")) . "
								</fieldset>") : ("")) . "
						</ul>
					</fieldset>
...
function __f__6975f86c3f91b9938da0a0153e292bbf($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a72fb9cf1373eb5434ed328734c24373($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d1e5ee7a92199a6e5735d7e33d1a3c69 = is_array($this->functionData['lostPasswordForm']) ? count($this->functionData['lostPasswordForm']) : 0;
$this->functionData['lostPasswordForm'][$count_d1e5ee7a92199a6e5735d7e33d1a3c69]['errors'] = $errors;
}
...
{
$count_d050734d539c92ce41a56bb798f34d73 = is_array($this->functionData['registerCoppaForm']) ? count($this->functionData['registerCoppaForm']) : 0;
}
$IPBHTML .= "<html>
	<head>
...
{
$count_68ae8cb5db82ed82e4a0881b13d19fd0 = is_array($this->functionData['registerCoppaStart']) ? count($this->functionData['registerCoppaStart']) : 0;
}
	...
	<fieldset class='general_box'>
		...
		<div class='ipsPad ipsForm_center'>
			...
			<select name='month' id='coppa_bday_m'>
				".$this->__f__dba8eac92ff4318aeec93672bfc00ce4()."			</select>
			&nbsp;
			<select name='day' id='coppa_bday_d'>
				".$this->__f__986100e15eedd7bf780a513ad02b6a12()."			</select>
			&nbsp;
			<select name='year' id='coppa_bday_y'>
				".$this->__f__80d502388fea44117b9298fef02a43a4()."			</select>
			</form>
		</div>
	</fieldset>
...
function __f__dba8eac92ff4318aeec93672bfc00ce4()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__986100e15eedd7bf780a513ad02b6a12()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__80d502388fea44117b9298fef02a43a4()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d8b2f3c42af6c9f4847b47c26c58911f = is_array($this->functionData['registerForm']) ? count($this->functionData['registerForm']) : 0;
$this->functionData['registerForm'][$count_d8b2f3c42af6c9f4847b47c26c58911f]['general_errors'] = $general_errors;
$this->functionData['registerForm'][$count_d8b2f3c42af6c9f4847b47c26c58911f]['data'] = $data;
$this->functionData['registerForm'][$count_d8b2f3c42af6c9f4847b47c26c58911f]['inline_errors'] = $inline_errors;
$this->functionData['registerForm'][$count_d8b2f3c42af6c9f4847b47c26c58911f]['time_select'] = $time_select;
$this->functionData['registerForm'][$count_d8b2f3c42af6c9f4847b47c26c58911f]['custom_fields'] = $custom_fields;
$this->functionData['registerForm'][$count_d8b2f3c42af6c9f4847b47c26c58911f]['nexusFields'] = $nexusFields;
$this->functionData['registerForm'][$count_d8b2f3c42af6c9f4847b47c26c58911f]['nexusStates'] = $nexusStates;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("register", "0" ) . "
<script type='text/javascript'>
//<![CDATA[
...
<div id='register_form'>
	...
	<div class='message error'>
		...
		<ul>
			".$this->__f__35c86630554927573723f351c5742c8e($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."		</ul>
	</div>
	<br />
	") : ("")) . "
			...
			<div class='ipsBox_container ipsPad'>
				...
				" . ((!empty( $nexusFields )) ? ("
					<script type='text/javascript'>
						...
						".$this->__f__052e8d7f922b86451e958eca2a88ced1($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."					</script>
					<hr />
					<fieldset>
						<ul class='ipsForm ipsForm_horizontal'>
							".$this->__f__8254ae51e5b7c7972ed51cbac152948a($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						</ul>
					</fieldset>
					<script type='text/javascript'>
						function states()
						{
				...
				" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<hr />
					<fieldset>
						<ul class='ipsForm ipsForm_horizontal'>
						" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
							".$this->__f__fc972c8b17be79ed52b6d8b5acf88070($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
			
						" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
							".$this->__f__5ccf1ee87da0d7fd3b9b940b9b35f6a7($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
					</fieldset>") : ("")) . "
				<hr />
				{$data['qandaHTML']}
				{$data['captchaHTML']}
...
function __f__35c86630554927573723f351c5742c8e($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__052e8d7f922b86451e958eca2a88ced1($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5ba71f39f902658b3bccaa65ec8d6b04($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( explode( "\n", $f['f_extra'] ) as $k => $v )
...
function __f__cad47590e00a1730ab84eea9a7c30fb7($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='',$country='',$_states='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a0ca014d9569081ce0d0429c19b90ca2($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $nexusStates as $country => $_states )
	{
		...
		$_ips___x_retval .= "
												<select name='_cm_state' id='{$country}-states' class='input_select' style='display:none'>
													".$this->__f__cad47590e00a1730ab84eea9a7c30fb7($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f,$country,$_states)."												</select>
...
function __f__8254ae51e5b7c7972ed51cbac152948a($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
								...
								" . (($f['f_type'] == 'dropdown') ? ("<li class='ipsField clear'>
										...
										<div class='ipsField_content'>
											<select name='{$f['f_column']}' id='{$f['f_column']}' tabindex='5' " . (($f['f_column'] == 'cm_country') ? ("onchange='states()'") : ("")) . ">
												".$this->__f__5ba71f39f902658b3bccaa65ec8d6b04($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f)."											</select>
										</div>
										" . (($f['f_reg_require'] and $this->request['do'] == 'process_form' and !$this->request[ $f['f_column'] ]) ? ("
											<span class='error'>{$this->lang->words['err_complete_form']}</span>
										") : ("")) . "
								...
								" . (($f['f_type'] == 'special') ? ("<li class='ipsField clear'>
										...
										<div class='ipsField_content'>
											...
											".$this->__f__a0ca014d9569081ce0d0429c19b90ca2($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f)."										</div>
										" . (($f['f_reg_require'] and $this->request['do'] == 'process_form' and !$this->request[ $f['f_column'] ]) ? ("
											<span class='error'>{$this->lang->words['err_complete_form']}</span>
										") : ("")) . "
									</li>") : ("")) . "
...
function __f__fc972c8b17be79ed52b6d8b5acf88070($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['required'] as $_field )
...
function __f__5ccf1ee87da0d7fd3b9b940b9b35f6a7($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['optional'] as $_field )
...
{
$count_9c743648b3f0e5b616e6ac8fe12f9196 = is_array($this->functionData['showLostpassForm']) ? count($this->functionData['showLostpassForm']) : 0;
$this->functionData['showLostpassForm'][$count_9c743648b3f0e5b616e6ac8fe12f9196]['error'] = $error;
}
...
{
$count_d64bff07a2586db51259f9574b1efbef = is_array($this->functionData['showRevalidateForm']) ? count($this->functionData['showRevalidateForm']) : 0;
$this->functionData['showRevalidateForm'][$count_d64bff07a2586db51259f9574b1efbef]['name'] = $name;
$this->functionData['showRevalidateForm'][$count_d64bff07a2586db51259f9574b1efbef]['error'] = $error;
}
$IPBHTML .= "<h1 class='ipsType_pagetitle'>{$this->lang->words['rv_title']}</h1>
<br />
" . (($error) ? ("
