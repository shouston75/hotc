...
{
$count_3c7326d9fedfbdbc32a35c65d319d78c = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_3c7326d9fedfbdbc32a35c65d319d78c]['month_day'] = $month_day;
$this->functionData['cal_date_cell'][$count_3c7326d9fedfbdbc32a35c65d319d78c]['events'] = $events;
$this->functionData['cal_date_cell'][$count_3c7326d9fedfbdbc32a35c65d319d78c]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_3c7326d9fedfbdbc32a35c65d319d78c]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_3c7326d9fedfbdbc32a35c65d319d78c]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
" . (($queued != 0) ? ("
...
{
$count_c3d6733ab52fc0223fb96cbcfab585fc = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_c3d6733ab52fc0223fb96cbcfab585fc]['month_day'] = $month_day;
$this->functionData['cal_date_cell_today'][$count_c3d6733ab52fc0223fb96cbcfab585fc]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_c3d6733ab52fc0223fb96cbcfab585fc]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_c3d6733ab52fc0223fb96cbcfab585fc]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_c3d6733ab52fc0223fb96cbcfab585fc]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
" . (($queued != 0) ? ("
...
{
$count_228f6ac99451831b31bc19bb2a8ffbf2 = is_array($this->functionData['cal_show_event']) ? count($this->functionData['cal_show_event']) : 0;
$this->functionData['cal_show_event'][$count_228f6ac99451831b31bc19bb2a8ffbf2]['event'] = $event;
$this->functionData['cal_show_event'][$count_228f6ac99451831b31bc19bb2a8ffbf2]['member'] = $member;
$this->functionData['cal_show_event'][$count_228f6ac99451831b31bc19bb2a8ffbf2]['event_type'] = $event_type;
$this->functionData['cal_show_event'][$count_228f6ac99451831b31bc19bb2a8ffbf2]['edit_button'] = $edit_button;
$this->functionData['cal_show_event'][$count_228f6ac99451831b31bc19bb2a8ffbf2]['approve_button'] = $approve_button;
$this->functionData['cal_show_event'][$count_228f6ac99451831b31bc19bb2a8ffbf2]['type'] = $type;
$this->functionData['cal_show_event'][$count_228f6ac99451831b31bc19bb2a8ffbf2]['date_ends'] = $date_ends;
}
...
{
$count_8b5716957b7f9034f95db39dc9c36cd1 = is_array($this->functionData['cal_week_content']) ? count($this->functionData['cal_week_content']) : 0;
$this->functionData['cal_week_content'][$count_8b5716957b7f9034f95db39dc9c36cd1]['calendars'] = $calendars;
$this->functionData['cal_week_content'][$count_8b5716957b7f9034f95db39dc9c36cd1]['date'] = $date;
$this->functionData['cal_week_content'][$count_8b5716957b7f9034f95db39dc9c36cd1]['month'] = $month;
$this->functionData['cal_week_content'][$count_8b5716957b7f9034f95db39dc9c36cd1]['year'] = $year;
$this->functionData['cal_week_content'][$count_8b5716957b7f9034f95db39dc9c36cd1]['prev'] = $prev;
$this->functionData['cal_week_content'][$count_8b5716957b7f9034f95db39dc9c36cd1]['next'] = $next;
$this->functionData['cal_week_content'][$count_8b5716957b7f9034f95db39dc9c36cd1]['cal_id'] = $cal_id;
}
...
<div id='mini_calendars' class='left calendar_wrap'>
	<div id='calendar_list' class='left general_box'>
		...
		<ol>
			".$this->__f__bbb7c476b5611697a8ce6d688fdaf446($calendars,$date,$month,$year,$prev,$next,$cal_id)."		</ol>
		") : ("")) . "
...
function __f__bbb7c476b5611697a8ce6d688fdaf446($calendars, $date="",$month="",$year="",$prev="",$next="", $cal_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_62c6d6c5e0d7bdc6ff0f696509ca5582 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_62c6d6c5e0d7bdc6ff0f696509ca5582]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_62c6d6c5e0d7bdc6ff0f696509ca5582]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_62c6d6c5e0d7bdc6ff0f696509ca5582]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_62c6d6c5e0d7bdc6ff0f696509ca5582]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_62c6d6c5e0d7bdc6ff0f696509ca5582]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_62c6d6c5e0d7bdc6ff0f696509ca5582]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_62c6d6c5e0d7bdc6ff0f696509ca5582]['queued'] = $queued;
}
...
{
$count_4a6d03a95d0c032ea1a7b07a8ea8810f = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_4a6d03a95d0c032ea1a7b07a8ea8810f]['rows'] = $rows;
}
...
<div class='general_box'>	<ul>
		".$this->__f__86aa49b9d0e3d82a009e41b2c7eb87d7($rows)."	</ul>
</div>";
return $IPBHTML;
}


function __f__86aa49b9d0e3d82a009e41b2c7eb87d7($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_5ef93c0df337a578fe59e116204b5086 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['code'] = $code;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['calendar_id'] = $calendar_id;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['formtype'] = $formtype;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['event_id'] = $event_id;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['event_title'] = $event_title;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['form_title'] = $form_title;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['event_date'] = $event_date;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['event_type'] = $event_type;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['groups'] = $groups;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['button'] = $button;
$this->functionData['calendarEventForm'][$count_5ef93c0df337a578fe59e116204b5086]['editor'] = $editor;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
...
{
$count_ea7be2f3c7f92a161e81db2cc19c6833 = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_ea7be2f3c7f92a161e81db2cc19c6833]['calendars'] = $calendars;
$this->functionData['calendarMainContent'][$count_ea7be2f3c7f92a161e81db2cc19c6833]['month'] = $month;
$this->functionData['calendarMainContent'][$count_ea7be2f3c7f92a161e81db2cc19c6833]['year'] = $year;
$this->functionData['calendarMainContent'][$count_ea7be2f3c7f92a161e81db2cc19c6833]['prev'] = $prev;
$this->functionData['calendarMainContent'][$count_ea7be2f3c7f92a161e81db2cc19c6833]['next'] = $next;
$this->functionData['calendarMainContent'][$count_ea7be2f3c7f92a161e81db2cc19c6833]['cal_jump'] = $cal_jump;
$this->functionData['calendarMainContent'][$count_ea7be2f3c7f92a161e81db2cc19c6833]['cal_id'] = $cal_id;
$this->functionData['calendarMainContent'][$count_ea7be2f3c7f92a161e81db2cc19c6833]['day_words'] = $day_words;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<h2>{$this->lang->words['calendars']}</h2>
<div id='current_calendar' class='right calendar_wrap'>
	...
	<table id='calendar_table' class='ipb_table' summary=\"{$this->lang->words['calendar_for']} {$month} {$year}\">
		...
		<tr class='header'>
			...
			".$this->__f__392759f40116ce7295bab4ff08609744($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."			<!--IBF.DAYS_CONTENT-->
		</tr>
	</table>
...
<div id='mini_calendars' class='left calendar_wrap'>
	<div id='calendar_list' class='general_box'>
		...
		<p><strong>{$this->lang->words['select_calendar']}</strong></p>
		<ol>
			".$this->__f__da210bcf11ef17c514bf1247d421f62a($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."		</ol>
		") : ("")) . "
		<strong>{$this->lang->words['jump_to']}</strong><br />
...
function __f__392759f40116ce7295bab4ff08609744($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__da210bcf11ef17c514bf1247d421f62a($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $calendars as $cid => $cal )
...
{
$count_3cc9e3ec10b999f390c14865e6c7ebc1 = is_array($this->functionData['mini_cal_mini_wrap']) ? count($this->functionData['mini_cal_mini_wrap']) : 0;
$this->functionData['mini_cal_mini_wrap'][$count_3cc9e3ec10b999f390c14865e6c7ebc1]['month'] = $month;
$this->functionData['mini_cal_mini_wrap'][$count_3cc9e3ec10b999f390c14865e6c7ebc1]['mid'] = $mid;
$this->functionData['mini_cal_mini_wrap'][$count_3cc9e3ec10b999f390c14865e6c7ebc1]['year'] = $year;
$this->functionData['mini_cal_mini_wrap'][$count_3cc9e3ec10b999f390c14865e6c7ebc1]['events'] = $events;
$this->functionData['mini_cal_mini_wrap'][$count_3cc9e3ec10b999f390c14865e6c7ebc1]['day_words'] = $day_words;
}
...
$IPBHTML .= "<!-- <a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&amp;cal_id={$this->request['_cal_id']}&amp;m={$mid}&amp;y=$year", "public",'' ), "", "" ) . "\"> --><div class='mini-cal-wrap'>
	...
	<table class='mini_cal'>
		<tr class='header'>
			...
			".$this->__f__57c6f6b1bc98ac6fa6f62cab4d4e34fc($month,$mid,$year,$events,$day_words)."	
			{$events}
		</tr>
	</table>
</div>";
...
function __f__57c6f6b1bc98ac6fa6f62cab4d4e34fc($month="",$mid="",$year="",$events="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day_words as $day )
