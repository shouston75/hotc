...
/* CACHE FILE: Generated: Sat, 22 Dec 2012 18:11:04 GMT */
...
$this->_funcHooks['emailPasswordChangeForm'] = array('emailIsAdmin','passFbUser','emailIsNotAdmin','removeUser','changePasswordNotAdmin');
...
$this->_funcHooks['membersIgnoredUsersForm'] = array('ignoreMemberTopics','ignoreMemberPms','members','topPagination','bottomPagination');
...
{
$count_31716b5ebf82f6a6ad40a22231d3d6c3 = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_31716b5ebf82f6a6ad40a22231d3d6c3]['info'] = $info;
$this->functionData['coreAttachments'][$count_31716b5ebf82f6a6ad40a22231d3d6c3]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_31716b5ebf82f6a6ad40a22231d3d6c3]['attachments'] = $attachments;
}
...
$IPBHTML .= "<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__dc82700dc42836834c82c6068d2bba6c($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__dc82700dc42836834c82c6068d2bba6c($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_37d27e86b940d74c07cbda811b9cdafa = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_37d27e86b940d74c07cbda811b9cdafa]['form'] = $form;
$this->functionData['displayNameForm'][$count_37d27e86b940d74c07cbda811b9cdafa]['error'] = $error;
$this->functionData['displayNameForm'][$count_37d27e86b940d74c07cbda811b9cdafa]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_37d27e86b940d74c07cbda811b9cdafa]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_61619ff7473cd0f79ad4fa5fb50127f9 = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_61619ff7473cd0f79ad4fa5fb50127f9]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_61619ff7473cd0f79ad4fa5fb50127f9]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_61619ff7473cd0f79ad4fa5fb50127f9]['isFB'] = $isFB;
}
...
{
$count_d5d345da741edce994fa7f492e0cb601 = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_d5d345da741edce994fa7f492e0cb601]['title'] = $title;
$this->functionData['field_entry'][$count_d5d345da741edce994fa7f492e0cb601]['desc'] = $desc;
$this->functionData['field_entry'][$count_d5d345da741edce994fa7f492e0cb601]['content'] = $content;
$this->functionData['field_entry'][$count_d5d345da741edce994fa7f492e0cb601]['id'] = $id;
}
...
{
$count_70822aa980e189c79640054a13b16da6 = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_70822aa980e189c79640054a13b16da6]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_70822aa980e189c79640054a13b16da6]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_70822aa980e189c79640054a13b16da6]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_70822aa980e189c79640054a13b16da6]['perms'] = $perms;
}
...
{
$count_60d592001ea2d2d9466b938d7cfc38bc = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_60d592001ea2d2d9466b938d7cfc38bc]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_60d592001ea2d2d9466b938d7cfc38bc]['pagination'] = $pagination;
}
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__832f6e94bf5f73868a90f1588681e0e9($members,$pagination)."	</table>
    " . (($pagination) ? ("
	    <br />
	    {$pagination}
	    <br class='clear' />
...
function __f__832f6e94bf5f73868a90f1588681e0e9($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c94b15ed1e1bb0886a494ab222655104 = is_array($this->functionData['membersProfileForm']) ? count($this->functionData['membersProfileForm']) : 0;
$this->functionData['membersProfileForm'][$count_c94b15ed1e1bb0886a494ab222655104]['custom_fields'] = $custom_fields;
$this->functionData['membersProfileForm'][$count_c94b15ed1e1bb0886a494ab222655104]['group_titles'] = $group_titles;
$this->functionData['membersProfileForm'][$count_c94b15ed1e1bb0886a494ab222655104]['day'] = $day;
$this->functionData['membersProfileForm'][$count_c94b15ed1e1bb0886a494ab222655104]['mon'] = $mon;
$this->functionData['membersProfileForm'][$count_c94b15ed1e1bb0886a494ab222655104]['year'] = $year;
$this->functionData['membersProfileForm'][$count_c94b15ed1e1bb0886a494ab222655104]['amEditor'] = $amEditor;
$this->functionData['membersProfileForm'][$count_c94b15ed1e1bb0886a494ab222655104]['times'] = $times;
}
	...
	<ul>
		...
		" . (($day AND $mon AND $year) ? ("
			<li class='field'>
				...
				<select name=\"month\">&nbsp;
					".$this->__f__8a0724e21edf37ef4c616ffa38f2b1a1($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select>			
				<select name=\"day\">&nbsp;
					".$this->__f__860130f802c06f8f5d9dd36f2a7feaa0($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select> 
				<select name=\"year\">&nbsp;
					".$this->__f__f7942f582d340879b29c548a030a8f05($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select> <br />
...
function __f__8a0724e21edf37ef4c616ffa38f2b1a1($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__860130f802c06f8f5d9dd36f2a7feaa0($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__f7942f582d340879b29c548a030a8f05($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
{
$count_873a8b7f42f98eecf39553f689282046 = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_873a8b7f42f98eecf39553f689282046]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_873a8b7f42f98eecf39553f689282046]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_873a8b7f42f98eecf39553f689282046]['signature'] = $signature;
}
...
{
$count_0ca61cb10097e7936de57e3c95c98567 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_0ca61cb10097e7936de57e3c95c98567]['config'] = $config;
$this->functionData['notificationsForm'][$count_0ca61cb10097e7936de57e3c95c98567]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__db4de524d5d91d1dbb96165ecd8660d3($config,$emailData)."		".$this->__f__fb52797216a51a77472531efee3d3728($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__26a0a07fd145bc6abaf26ff98cca93f2($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__db4de524d5d91d1dbb96165ecd8660d3($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__26a0a07fd145bc6abaf26ff98cca93f2($config,$emailData,$groupKey,$group)."							
...
function __f__fb52797216a51a77472531efee3d3728($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_93be7cb1870ec911236f5b363d25831f = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_93be7cb1870ec911236f5b363d25831f]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_93be7cb1870ec911236f5b363d25831f]['error'] = $error;
$this->functionData['notificationsLog'][$count_93be7cb1870ec911236f5b363d25831f]['pages'] = $pages;
}
...
$IPBHTML .= "<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=removeNotifications&amp;do=remove", "public",'' ), "", "" ) . "\" id=\"checkBoxForm\" method=\"post\">
	...
	<div class='master_list' id='notifications'>
		...
		") : ("" . (($this->request['confirm']) ? ("
			...
			") : ("")) . "")) . "
		".$this->__f__fa74fa2bcc23672499de8ec8c877961e($notifications,$error,$pages)."	</div>
	" . ((count($notifications)) ? ("
		<div class='submit'>
...
function __f__fa74fa2bcc23672499de8ec8c877961e($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
