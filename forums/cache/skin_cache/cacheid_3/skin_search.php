...
/* CACHE FILE: Generated: Sat, 22 Dec 2012 18:11:02 GMT */
...
$this->_funcHooks['searchResultsWrapper'] = array('hasSearchResults','forumsTab','membersTab','helpTab','helpTab','hasSearchResults','noResultsTerm','hasTotal');
...
{
$count_0414b9184b0fe4b0e8e716c4bb7e5a10 = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_0414b9184b0fe4b0e8e716c4bb7e5a10]['data'] = $data;
}
$IPBHTML .= "<div class='row'>
	...
	{$this->lang->words['in']}
	".$this->__f__3f81cfb28e1b0c2b5c57e0004baed158($data)."	
	" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
		<span class='mini_pagination'>
			".$this->__f__af04c36d3a15f98c25de48287048cdef($data)."		</span>
	") : ("")) . "
	<br />
...
function __f__3f81cfb28e1b0c2b5c57e0004baed158($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__af04c36d3a15f98c25de48287048cdef($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d709de6081e776d901e1a1f9d66da409 = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_d709de6081e776d901e1a1f9d66da409]['data'] = $data;
}
$IPBHTML .= "<div class='row touch-row " . ((!empty( $data['_unreadUrl'] )) ? ("unread") : ("")) . "' id=\"sr-{$data['type_id_2']}\">
	...
	<div class='rowContent'>
		...
		") : ("")) . "
		<div>
			" . ucfirst($this->lang->words['in']) . "".$this->__f__440b5be9c753db1af5bdf85887e09003($data)."		</div>
...
function __f__440b5be9c753db1af5bdf85887e09003($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
{
$count_3c119724dccbdc95e9c5430145ebfd0b = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_3c119724dccbdc95e9c5430145ebfd0b]['followData'] = $followData;
}
...
{
$count_57ea1e8e33d3b13988b9f5dae04d7eae = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count_57ea1e8e33d3b13988b9f5dae04d7eae]['results'] = $results;
}
$IPBHTML .= "" . ((count($results)) ? ("".$this->__f__df8041570c7218b6a950b4cf915d57ea($results)."") : ("")) . "";
return $IPBHTML;
}


function __f__df8041570c7218b6a950b4cf915d57ea($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ad6f574fd3af779538e05dfc5a2dbf05 = is_array($this->functionData['followedContentForumsWrapperForums']) ? count($this->functionData['followedContentForumsWrapperForums']) : 0;
$this->functionData['followedContentForumsWrapperForums'][$count_ad6f574fd3af779538e05dfc5a2dbf05]['results'] = $results;
}
...
<div class='master_list'>
	".$this->__f__2dd88b5a5dbd27356ed26143f5b3b1ee($results)."</div>";
return $IPBHTML;
}


function __f__2dd88b5a5dbd27356ed26143f5b3b1ee($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a3c1d09756187766ec4a9dfe58d734fc = is_array($this->functionData['followedContentView']) ? count($this->functionData['followedContentView']) : 0;
$this->functionData['followedContentView'][$count_a3c1d09756187766ec4a9dfe58d734fc]['results'] = $results;
$this->functionData['followedContentView'][$count_a3c1d09756187766ec4a9dfe58d734fc]['pagination'] = $pagination;
$this->functionData['followedContentView'][$count_a3c1d09756187766ec4a9dfe58d734fc]['total'] = $total;
$this->functionData['followedContentView'][$count_a3c1d09756187766ec4a9dfe58d734fc]['error'] = $error;
$this->functionData['followedContentView'][$count_a3c1d09756187766ec4a9dfe58d734fc]['contentTypes'] = $contentTypes;
}
$IPBHTML .= "" . (($pagination) ? ("
<div class='controls'>
...
<div class='master_list'>
	...
	<div class='ipsPad'>
		...
		".$this->__f__7c9e8014875e5dfb647250537567f53a($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>
<div class='master_list'>
	...
	<div class='ipsPad'>
		<ul>
			".$this->__f__e06deac87ddbbfd619a6a6a9e5fbcad0($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__7c9e8014875e5dfb647250537567f53a($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e06deac87ddbbfd619a6a6a9e5fbcad0($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b25c95772fe9ff33714bec17c647434b = is_array($this->functionData['forumAdvancedSearchFilters']) ? count($this->functionData['forumAdvancedSearchFilters']) : 0;
$this->functionData['forumAdvancedSearchFilters'][$count_b25c95772fe9ff33714bec17c647434b]['forums'] = $forums;
$this->functionData['forumAdvancedSearchFilters'][$count_b25c95772fe9ff33714bec17c647434b]['archivedPostCount'] = $archivedPostCount;
$this->functionData['forumAdvancedSearchFilters'][$count_b25c95772fe9ff33714bec17c647434b]['topic'] = $topic;
}
...
{
$count_6a5b2f6a21fe94218d3a4b368ef31e74 = is_array($this->functionData['helpSearchResult']) ? count($this->functionData['helpSearchResult']) : 0;
$this->functionData['helpSearchResult'][$count_6a5b2f6a21fe94218d3a4b368ef31e74]['r'] = $r;
$this->functionData['helpSearchResult'][$count_6a5b2f6a21fe94218d3a4b368ef31e74]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_046f4a3d3b8fdf980f52e2ea88d97847 = is_array($this->functionData['memberCommentsSearchResult']) ? count($this->functionData['memberCommentsSearchResult']) : 0;
$this->functionData['memberCommentsSearchResult'][$count_046f4a3d3b8fdf980f52e2ea88d97847]['r'] = $r;
$this->functionData['memberCommentsSearchResult'][$count_046f4a3d3b8fdf980f52e2ea88d97847]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_8da62c3f0136cd07b7ea6ce0799bba6a = is_array($this->functionData['newContentView']) ? count($this->functionData['newContentView']) : 0;
$this->functionData['newContentView'][$count_8da62c3f0136cd07b7ea6ce0799bba6a]['results'] = $results;
$this->functionData['newContentView'][$count_8da62c3f0136cd07b7ea6ce0799bba6a]['pagination'] = $pagination;
$this->functionData['newContentView'][$count_8da62c3f0136cd07b7ea6ce0799bba6a]['total'] = $total;
$this->functionData['newContentView'][$count_8da62c3f0136cd07b7ea6ce0799bba6a]['sortDropDown'] = $sortDropDown;
$this->functionData['newContentView'][$count_8da62c3f0136cd07b7ea6ce0799bba6a]['sortIn'] = $sortIn;
$this->functionData['newContentView'][$count_8da62c3f0136cd07b7ea6ce0799bba6a]['dateCutSet'] = $dateCutSet;
}
...
" . ((is_array($sortIn) AND count( $sortIn )) ? ("
	<div class='ipsFilterPane' id='filter_section_pane' style='display: none'>
		...
		<div>
			...
			<ul>
				".$this->__f__1a7852b643bf44a74c46a7e02921c128($results,$pagination,$total,$sortDropDown,$sortIn,$dateCutSet)."			</ul>		
		</div>
	</div>
") : ("")) . "
...
function __f__455e7ccface05ef7639baad0d9d0fd56($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__1a7852b643bf44a74c46a7e02921c128($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bba7a5af1bd4429df9aef567d6a94c36 = is_array($this->functionData['searchAdvancedForm']) ? count($this->functionData['searchAdvancedForm']) : 0;
$this->functionData['searchAdvancedForm'][$count_bba7a5af1bd4429df9aef567d6a94c36]['filters'] = $filters;
$this->functionData['searchAdvancedForm'][$count_bba7a5af1bd4429df9aef567d6a94c36]['msg'] = $msg;
$this->functionData['searchAdvancedForm'][$count_bba7a5af1bd4429df9aef567d6a94c36]['current_app'] = $current_app;
$this->functionData['searchAdvancedForm'][$count_bba7a5af1bd4429df9aef567d6a94c36]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchAdvancedForm'][$count_bba7a5af1bd4429df9aef567d6a94c36]['isFT'] = $isFT;
$this->functionData['searchAdvancedForm'][$count_bba7a5af1bd4429df9aef567d6a94c36]['canTag'] = $canTag;
}
...
<div class='master_list ipsForm_vertical'>
	...
	" . ((count($filters)) ? ("".$this->__f__e78d189ece995358760f709abf8220f1($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."		") : ("")) . "	
	<div class='submit'>
...
function __f__f030ce7197f1e640e67005718fa91f0f($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='',$id='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9c4930911f2aae3b43f750bde1b88aec($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
							<ul>
								<li>
									...
									".$this->__f__f030ce7197f1e640e67005718fa91f0f($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data,$id,$_data)."									</select>
...
function __f__c02d586c9386d92f58560bb69131507c($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e78d189ece995358760f709abf8220f1($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . (($app == 'forums') ? ("<div id='app_filter_{$app}'>
				...
				" . ((count($data['sortDropDown'])) ? ("" . ((is_array($data['sortDropIn']) AND count( $data['sortDropIn'] )) ? ("
						".$this->__f__9c4930911f2aae3b43f750bde1b88aec($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."					") : ("<div class='ipsField'>
							...
							<select name='search_app_filters[$app][sortKey]' id='search_sort_by_{$app}' class='input_select' style='width:auto'>
								".$this->__f__c02d586c9386d92f58560bb69131507c($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."							</select>
...
{
$count_3a0a9013c8d0c8895aed879ce542c2f9 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_3a0a9013c8d0c8895aed879ce542c2f9]['results'] = $results;
$this->functionData['searchResults'][$count_3a0a9013c8d0c8895aed879ce542c2f9]['titlesOnly'] = $titlesOnly;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($results) && count($results)) ? ("
			".$this->__f__3154b33fb34045398d2db4e9fba87b8c($results,$titlesOnly)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__3154b33fb34045398d2db4e9fba87b8c($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_874a65db89af61a86db8b7f81e7d809f = is_array($this->functionData['searchResultsWrapper']) ? count($this->functionData['searchResultsWrapper']) : 0;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['results'] = $results;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['sortDropDown'] = $sortDropDown;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['sortIn'] = $sortIn;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['pagination'] = $pagination;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['total'] = $total;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['showing'] = $showing;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['search_term'] = $search_term;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['url_string'] = $url_string;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['current_key'] = $current_key;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['limited'] = $limited;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['wasLimited'] = $wasLimited;
$this->functionData['searchResultsWrapper'][$count_874a65db89af61a86db8b7f81e7d809f]['search_tags'] = $search_tags;
}
...
{
$count_ae6eb52d3ec884e341364162d46998dd = is_array($this->functionData['searchRowGenericFormat']) ? count($this->functionData['searchRowGenericFormat']) : 0;
$this->functionData['searchRowGenericFormat'][$count_ae6eb52d3ec884e341364162d46998dd]['r'] = $r;
$this->functionData['searchRowGenericFormat'][$count_ae6eb52d3ec884e341364162d46998dd]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<div class='result_info'>
...
{
$count_1846885744c328ab0ce6f04efe83d19a = is_array($this->functionData['topicPostSearchResultAsForum']) ? count($this->functionData['topicPostSearchResultAsForum']) : 0;
$this->functionData['topicPostSearchResultAsForum'][$count_1846885744c328ab0ce6f04efe83d19a]['data'] = $data;
$this->functionData['topicPostSearchResultAsForum'][$count_1846885744c328ab0ce6f04efe83d19a]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_63166d27825ada064cc2fa370fad386a = is_array($this->functionData['userPostsView']) ? count($this->functionData['userPostsView']) : 0;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['results'] = $results;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['pagination'] = $pagination;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['total'] = $total;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['member'] = $member;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['limited'] = $limited;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['wasLimited'] = $wasLimited;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['beginTime'] = $beginTime;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['sortIn'] = $sortIn;
$this->functionData['userPostsView'][$count_63166d27825ada064cc2fa370fad386a]['sortDropDown'] = $sortDropDown;
}
