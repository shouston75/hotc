...
$this->_funcHooks['postFormTemplate'] = array('logged_in_check','edit_title_check','statusMsgs','hazTag','edit_tags_check','htmlstatus','tracking','enablesig');
$this->_funcHooks['preview'] = array('postpreview');
$this->_funcHooks['topicSummary'] = array('ignoringpost','posts','topicsummaryposts');
$this->_funcHooks['uploadForm'] = array('canUseFlash','flashuploadhelp','uploadformhelp');
...
{
$count_5c6dd553c36bd89c65763b141ce2b3dc = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_5c6dd553c36bd89c65763b141ce2b3dc]['data'] = $data;
}
...
<div class='post_form poll_form' id='poll_form'>
	...
	<fieldset id='poll_wrap' style='display: none' class='clear'>
		<ul id='poll_container'>
			...
			" . (($this->settings['poll_allow_public'] AND ! $data['poll_votes']) ? ("<li class='field checkbox'>
...
{
$count_058ffb83f562ecf3b0e91074f45cc97f = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_058ffb83f562ecf3b0e91074f45cc97f]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_058ffb83f562ecf3b0e91074f45cc97f]['form'] = $form;
}
$IPBHTML .= "<div class='master_list'>
	...
	" . (($formData['formType'] == 'new' OR ( $formData['formType'] == 'edit')) ? ("" . (($formData['tagBox']) ? ("
		...
		" . (($this->memberData['member_id']) ? ("<div class='ipsField ipsField_checkbox'>
...
{
$count_d27ef0902e988ad15024980ab507c79c = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_d27ef0902e988ad15024980ab507c79c]['data'] = $data;
}
$IPBHTML .= "" . (($data AND trim($data) != '<br />' AND trim($data) != '<br>') ? ("
...
{
$count_24b2a101db3f6a36e076a559b0bd5bb1 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_24b2a101db3f6a36e076a559b0bd5bb1]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__33fa30f18f042a56be56e170d7fb24f2($posts)."") : ("")) . "
<p class='submit'>
...
function __f__33fa30f18f042a56be56e170d7fb24f2($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $pid => $data )
	{
		...
		<div class='post_block topic_summary'>
			<h3>" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($data) : '' ) . "</h3>
...
{
$count_4e94912f68f8b43125a1d9439b5164d8 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_4e94912f68f8b43125a1d9439b5164d8]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_4e94912f68f8b43125a1d9439b5164d8]['type'] = $type;
$this->functionData['uploadForm'][$count_4e94912f68f8b43125a1d9439b5164d8]['stats'] = $stats;
$this->functionData['uploadForm'][$count_4e94912f68f8b43125a1d9439b5164d8]['id'] = $id;
$this->functionData['uploadForm'][$count_4e94912f68f8b43125a1d9439b5164d8]['forum_id'] = $forum_id;
}
