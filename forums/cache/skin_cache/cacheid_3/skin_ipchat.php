...
{
$count_1fd5d7d1225f8dfe1b66b4cdc3bdb6c3 = is_array($this->functionData['ignoredUsersForm']) ? count($this->functionData['ignoredUsersForm']) : 0;
$this->functionData['ignoredUsersForm'][$count_1fd5d7d1225f8dfe1b66b4cdc3bdb6c3]['members'] = $members;
}
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__55c14673af491246a067aa506ed24819($members)."	</table>
</fieldset>
<fieldset class=\"row2\">
...
function __f__55c14673af491246a067aa506ed24819($members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
