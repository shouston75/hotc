...
$this->_funcHooks['globalTemplate'] = array('fbcenabled','pagenumberintitle','brandingBar','memberbox','notifications','messengerlink','notificationsCount','notificationsLink','hasMemberList','hasForums','hasBlog','hasGallery','hasNexus','viewnewcontentapp','legacyApp','mainpageContent','isNotMobbyApp','skinchanger','langchooser','vigLinkEnabled');
...
{
$count_afaa0d0f21fb45f88c21f84b59e850f6 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['html'] = $html;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['css'] = $css;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['items'] = $items;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_afaa0d0f21fb45f88c21f84b59e850f6]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__5a74b02fbabd37bf8416b555e53f353a($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__5a74b02fbabd37bf8416b555e53f353a($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8a1afa8a075a3c70782daba6a2fd31f9 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_8a1afa8a075a3c70782daba6a2fd31f9]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__973b598a131d7122da2c178db60da224($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__e0b409abcfe006fa46d93e787880a8a3($css)."") : ("")) . "";
return $IPBHTML;
}


function __f__973b598a131d7122da2c178db60da224($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e0b409abcfe006fa46d93e787880a8a3($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9ba95f572b314c4fd6e0da11921ac837 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_9ba95f572b314c4fd6e0da11921ac837]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__0c9adf7f39c7a85ea101b105cad06943($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__53d69efeff93aded1766877ef580e8ae($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0c9adf7f39c7a85ea101b105cad06943($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__53d69efeff93aded1766877ef580e8ae($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_1d690d42009d72fb774be83e2afc2be9 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_1d690d42009d72fb774be83e2afc2be9]['jsModules'] = $jsModules;
}
...
<script type='text/javascript'>
	Event.observe( window, 'resize', handleYoutube );
	Event.observe( window, 'load', handleYoutube );

	function handleYoutube(e)
	{
		var pageWidth	= $('content').getWidth();

		$$('.youtube', '.youtube embed').each( function(elem){
...
{
$count_49789d7d3ed362ffb1310b28bf903d08 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_49789d7d3ed362ffb1310b28bf903d08]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__3f875c573a343a9e40a4ee5c1a07c508($metaTags)."") : ("")) . "";
return $IPBHTML;
}


function __f__3f875c573a343a9e40a4ee5c1a07c508($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b0e18bfc0f18422bb808d5ddea4ad509 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__a3a8880f18549fa920d2acca3842e630()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__a3a8880f18549fa920d2acca3842e630()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9f05b3c75062c4a78b3c0ee9633914b5 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_9f05b3c75062c4a78b3c0ee9633914b5]['data'] = $data;
}
...
{
$count_e45f511f30508f73269a7d5164e2e859 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_e45f511f30508f73269a7d5164e2e859]['work'] = $work;
$this->functionData['paginationTemplate'][$count_e45f511f30508f73269a7d5164e2e859]['data'] = $data;
}
...
{
$count_b5aaa8197e2100dd0c31477c932319fe = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_b5aaa8197e2100dd0c31477c932319fe]['member'] = $member;
}
...
{
$count_f61bd95cd1a2b5cc45f960fc868c4cdc = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_f61bd95cd1a2b5cc45f960fc868c4cdc]['author'] = $author;
$this->functionData['userInfoPane'][$count_f61bd95cd1a2b5cc45f960fc868c4cdc]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_f61bd95cd1a2b5cc45f960fc868c4cdc]['options'] = $options;
}
$IPBHTML .= "<ul class='user_details'>
	...
	<ul class='user_fields'>
		...
		" . (($author['custom_fields'] != "") ? ("
			".$this->__f__6249ad0e3deab437310542cc4a4178e3($author,$contentid,$options)."		") : ("")) . "
	</ul>
...
function __f__04afc1b75730935d083b09779df4b3d2($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6249ad0e3deab437310542cc4a4178e3($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__04afc1b75730935d083b09779df4b3d2($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_b3b1b8cb31d42a1fbec11aead06f2bcd = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_b3b1b8cb31d42a1fbec11aead06f2bcd]['member'] = $member;
}
...
{
$count_29f751262843288687a934e4a3277e0d = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_29f751262843288687a934e4a3277e0d]['warning'] = $warning;
$this->functionData['warnDetails'][$count_29f751262843288687a934e4a3277e0d]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__333fecf9bc911f21bef0634c8474991a($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__333fecf9bc911f21bef0634c8474991a($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
