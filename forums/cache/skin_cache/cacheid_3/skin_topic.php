...
$this->_funcHooks['pollDisplay'] = array('hasVoters','multiVote','showingResults','poll_choices','votedClass','noGuestVote','poll_questions','showPollResults','publicPollNotice','deleteVote','cast','viewVotersLink','alreadyDisplayVotes','displayVotes','youCreatedPoll','voteButtonVoted','voteButtonMid','voteButton','editPoll');
$this->_funcHooks['post'] = array('isSolvedCss','isSolvedSausage','postMember','userIgnoredLang','userIgnoredLangTwo','postEditByReason','postEditBy','userIgnored','canEdit','canDelete','deleted','sDeleted');
...
$this->_funcHooks['topicViewTemplate'] = array('post_data','mod_links','hasPagesBA2','samePageBA2','closedButtonLink','replyButtonLink','replyButton','closedButton','hasPosts','canShare','modOptionsDropdown','closedButtonLink','replyButtonLink','replyButton','closedButton','fastReply','scrollToPost','notexist','scrollToPost2');
...
{
$count_d14f9b91fc87405d3bee295218359569 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_d14f9b91fc87405d3bee295218359569]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_d14f9b91fc87405d3bee295218359569]['forum'] = $forum;
}
...
{
$count_55a62038f849d6e3e8603e43aad6a67e = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_55a62038f849d6e3e8603e43aad6a67e]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_55a62038f849d6e3e8603e43aad6a67e]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_55a62038f849d6e3e8603e43aad6a67e]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_55a62038f849d6e3e8603e43aad6a67e]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_55a62038f849d6e3e8603e43aad6a67e]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_55a62038f849d6e3e8603e43aad6a67e]['editPoll'] = $editPoll;
}
$IPBHTML .= "<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__b790c8be95e8ff8fc5888ffa359a46ea($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__ca40322747d5ad773b51890b6fb69498($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b790c8be95e8ff8fc5888ffa359a46ea($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__ca40322747d5ad773b51890b6fb69498($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_1e05868140dd55bf5e16b064b8bbdb3a = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_1e05868140dd55bf5e16b064b8bbdb3a]['post'] = $post;
$this->functionData['post'][$count_1e05868140dd55bf5e16b064b8bbdb3a]['displayData'] = $displayData;
$this->functionData['post'][$count_1e05868140dd55bf5e16b064b8bbdb3a]['topic'] = $topic;
$this->functionData['post'][$count_1e05868140dd55bf5e16b064b8bbdb3a]['forum'] = $forum;
}
...
{
$count_86e014531ad75611f86faf37e35b351b = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_86e014531ad75611f86faf37e35b351b]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_617d24a853db49d302c6baba1534db72 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_617d24a853db49d302c6baba1534db72]['title'] = $title;
$this->functionData['show_attachment_title'][$count_617d24a853db49d302c6baba1534db72]['data'] = $data;
$this->functionData['show_attachment_title'][$count_617d24a853db49d302c6baba1534db72]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__20d71421a8590687266708ac8b071207($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__20d71421a8590687266708ac8b071207($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ec90e652216db32f37c241fb175b5f6c = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_ec90e652216db32f37c241fb175b5f6c]['data'] = $data;
}
...
{
$count_dbb6d92770160cf06c23f2b14d5b1ba1 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_dbb6d92770160cf06c23f2b14d5b1ba1]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_dbb6d92770160cf06c23f2b14d5b1ba1]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_dbb6d92770160cf06c23f2b14d5b1ba1]['topic'] = $topic;
}
...
{
$count_e13cf32ef30ce5b48418343acdd59208 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_e13cf32ef30ce5b48418343acdd59208]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_e13cf32ef30ce5b48418343acdd59208]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_e13cf32ef30ce5b48418343acdd59208]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_e13cf32ef30ce5b48418343acdd59208]['displayData'] = $displayData;
}
...
<div class='master_list'>
	...
	" . (($displayData['best_answer_post_data']) ? ("<br />
		<div class='topic_reply feature_box'>
			<h2 class='secondary'>
				...
				<span class='subtext'>" . $this->registry->getClass('class_localization')->getDate($displayData['best_answer_post_data']['post']['post_date'],"long", 0) . "</span>
			</h2>
	...
	" . ((is_array( $post_data ) AND count( $post_data )) ? ("
		".$this->__f__5692ef3f87f22e11c4888fa0de445281($forum,$topic,$post_data,$displayData)."	") : ("")) . "
	...
	") : ("")) . "
		...
		<div style='text-align:center'>
			...
			<div id='mobileModOptions' style='display:none'>
				".$this->__f__46ac2374f5e77017d54777c8d98e10dd($forum,$topic,$post_data,$displayData)."			</div>
		</div>
	") : ("")) . "
	<div class='controls'>
		<div class='buttons'>
...
function __f__5692ef3f87f22e11c4888fa0de445281($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__46ac2374f5e77017d54777c8d98e10dd($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
