...
{
$count_ea0e4dab470050d432cc5c0d82508af1 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_ea0e4dab470050d432cc5c0d82508af1]['members'] = $members;
$this->functionData['member_list_show'][$count_ea0e4dab470050d432cc5c0d82508af1]['pages'] = $pages;
$this->functionData['member_list_show'][$count_ea0e4dab470050d432cc5c0d82508af1]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_ea0e4dab470050d432cc5c0d82508af1]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_ea0e4dab470050d432cc5c0d82508af1]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_ea0e4dab470050d432cc5c0d82508af1]['url'] = $url;
}
...
<div id=\"filter-letters\">
		".$this->__f__dc2c4fb42a1dfc51abe0a902f4131d06($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."</div>
</div>
	" . ((is_array( $members ) and count( $members )) ? ("
				".$this->__f__1776ba155a28366abf46a8612a8a41f2($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."	") : ("
...
function __f__dc2c4fb42a1dfc51abe0a902f4131d06($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1776ba155a28366abf46a8612a8a41f2($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
