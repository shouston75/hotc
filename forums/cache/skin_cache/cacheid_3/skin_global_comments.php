...
{
$count_8496e6713c8945855bd03a2e3eca2c06 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_8496e6713c8945855bd03a2e3eca2c06]['comments'] = $comments;
$this->functionData['commentsList'][$count_8496e6713c8945855bd03a2e3eca2c06]['settings'] = $settings;
$this->functionData['commentsList'][$count_8496e6713c8945855bd03a2e3eca2c06]['pages'] = $pages;
$this->functionData['commentsList'][$count_8496e6713c8945855bd03a2e3eca2c06]['parent'] = $parent;
$this->functionData['commentsList'][$count_8496e6713c8945855bd03a2e3eca2c06]['preReply'] = $preReply;
}
...
<div class='comment_wrap' id='comment_wrap'>
	".$this->__f__f3b5b9adf710eacb4b18ac029dfb98a1($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($parent['_canComment']) ? ("
...
function __f__f3b5b9adf710eacb4b18ac029dfb98a1($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d0551b59ab9faf3e20bc328eaeb0a684 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_d0551b59ab9faf3e20bc328eaeb0a684]['comment'] = $comment;
$this->functionData['form'][$count_d0551b59ab9faf3e20bc328eaeb0a684]['parent'] = $parent;
$this->functionData['form'][$count_d0551b59ab9faf3e20bc328eaeb0a684]['editor'] = $editor;
$this->functionData['form'][$count_d0551b59ab9faf3e20bc328eaeb0a684]['settings'] = $settings;
$this->functionData['form'][$count_d0551b59ab9faf3e20bc328eaeb0a684]['errors'] = $errors;
$this->functionData['form'][$count_d0551b59ab9faf3e20bc328eaeb0a684]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
