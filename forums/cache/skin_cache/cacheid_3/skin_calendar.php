...
$this->_funcHooks['calendarMainContent'] = array('calendars','days','gotcalendars');
...
{
$count_b9613374dbe2d3439547830d63caa30f = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_b9613374dbe2d3439547830d63caa30f]['month_day'] = $month_day;
$this->functionData['cal_date_cell'][$count_b9613374dbe2d3439547830d63caa30f]['events'] = $events;
$this->functionData['cal_date_cell'][$count_b9613374dbe2d3439547830d63caa30f]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_b9613374dbe2d3439547830d63caa30f]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_b9613374dbe2d3439547830d63caa30f]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
" . (($queued != 0) ? ("
...
{
$count_317205dc6255b07e5760b56ed90bc0d1 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_317205dc6255b07e5760b56ed90bc0d1]['month_day'] = $month_day;
$this->functionData['cal_date_cell_today'][$count_317205dc6255b07e5760b56ed90bc0d1]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_317205dc6255b07e5760b56ed90bc0d1]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_317205dc6255b07e5760b56ed90bc0d1]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_317205dc6255b07e5760b56ed90bc0d1]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
" . (($queued != 0) ? ("
...
{
$count_0a04bdcd9b18e8ffc57090f4a407ca56 = is_array($this->functionData['cal_show_event']) ? count($this->functionData['cal_show_event']) : 0;
$this->functionData['cal_show_event'][$count_0a04bdcd9b18e8ffc57090f4a407ca56]['event'] = $event;
$this->functionData['cal_show_event'][$count_0a04bdcd9b18e8ffc57090f4a407ca56]['member'] = $member;
$this->functionData['cal_show_event'][$count_0a04bdcd9b18e8ffc57090f4a407ca56]['event_type'] = $event_type;
$this->functionData['cal_show_event'][$count_0a04bdcd9b18e8ffc57090f4a407ca56]['edit_button'] = $edit_button;
$this->functionData['cal_show_event'][$count_0a04bdcd9b18e8ffc57090f4a407ca56]['approve_button'] = $approve_button;
$this->functionData['cal_show_event'][$count_0a04bdcd9b18e8ffc57090f4a407ca56]['type'] = $type;
$this->functionData['cal_show_event'][$count_0a04bdcd9b18e8ffc57090f4a407ca56]['date_ends'] = $date_ends;
}
...
{
$count_a38dea6c0d058afd7dd9de1f3ade87fd = is_array($this->functionData['cal_week_content']) ? count($this->functionData['cal_week_content']) : 0;
$this->functionData['cal_week_content'][$count_a38dea6c0d058afd7dd9de1f3ade87fd]['calendars'] = $calendars;
$this->functionData['cal_week_content'][$count_a38dea6c0d058afd7dd9de1f3ade87fd]['date'] = $date;
$this->functionData['cal_week_content'][$count_a38dea6c0d058afd7dd9de1f3ade87fd]['month'] = $month;
$this->functionData['cal_week_content'][$count_a38dea6c0d058afd7dd9de1f3ade87fd]['year'] = $year;
$this->functionData['cal_week_content'][$count_a38dea6c0d058afd7dd9de1f3ade87fd]['prev'] = $prev;
$this->functionData['cal_week_content'][$count_a38dea6c0d058afd7dd9de1f3ade87fd]['next'] = $next;
$this->functionData['cal_week_content'][$count_a38dea6c0d058afd7dd9de1f3ade87fd]['cal_id'] = $cal_id;
}
...
<div id='calendar_list' class='left general_box'>
	...
	<ol>
		".$this->__f__65fc0827e329181df43f05c6ec84bf99($calendars,$date,$month,$year,$prev,$next,$cal_id)."	</ol>
	") : ("")) . "
...
function __f__65fc0827e329181df43f05c6ec84bf99($calendars, $date="",$month="",$year="",$prev="",$next="", $cal_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_18f890bf23a2b1b4b634865263e2f0fa = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_18f890bf23a2b1b4b634865263e2f0fa]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_18f890bf23a2b1b4b634865263e2f0fa]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_18f890bf23a2b1b4b634865263e2f0fa]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_18f890bf23a2b1b4b634865263e2f0fa]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_18f890bf23a2b1b4b634865263e2f0fa]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_18f890bf23a2b1b4b634865263e2f0fa]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_18f890bf23a2b1b4b634865263e2f0fa]['queued'] = $queued;
}
...
{
$count_92b730f2f89a863137b1b581c89058e9 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_92b730f2f89a863137b1b581c89058e9]['rows'] = $rows;
}
...
<div class='general_box'>	<ul>
		".$this->__f__88501f3823cc61c4a73c311a7a5b8ae2($rows)."	</ul>
</div>";
return $IPBHTML;
}


function __f__88501f3823cc61c4a73c311a7a5b8ae2($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_ab2e13515baef3c9cd1457a445fa1414 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['code'] = $code;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['calendar_id'] = $calendar_id;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['formtype'] = $formtype;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['event_id'] = $event_id;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['event_title'] = $event_title;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['form_title'] = $form_title;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['event_date'] = $event_date;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['event_type'] = $event_type;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['groups'] = $groups;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['button'] = $button;
$this->functionData['calendarEventForm'][$count_ab2e13515baef3c9cd1457a445fa1414]['editor'] = $editor;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
...
{
$count_629d7d5dc6ad268a415d79745c7c637d = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_629d7d5dc6ad268a415d79745c7c637d]['calendars'] = $calendars;
$this->functionData['calendarMainContent'][$count_629d7d5dc6ad268a415d79745c7c637d]['month'] = $month;
$this->functionData['calendarMainContent'][$count_629d7d5dc6ad268a415d79745c7c637d]['year'] = $year;
$this->functionData['calendarMainContent'][$count_629d7d5dc6ad268a415d79745c7c637d]['prev'] = $prev;
$this->functionData['calendarMainContent'][$count_629d7d5dc6ad268a415d79745c7c637d]['next'] = $next;
$this->functionData['calendarMainContent'][$count_629d7d5dc6ad268a415d79745c7c637d]['cal_jump'] = $cal_jump;
$this->functionData['calendarMainContent'][$count_629d7d5dc6ad268a415d79745c7c637d]['cal_id'] = $cal_id;
$this->functionData['calendarMainContent'][$count_629d7d5dc6ad268a415d79745c7c637d]['day_words'] = $day_words;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<h2>{$this->lang->words['calendars']}</h2>
<div id='calendar_list' class='left general_box'>
	...
	<p><strong>{$this->lang->words['select_calendar']}</strong></p>
	<ol>
		".$this->__f__f612d4cc91538f111cd72791bb410508($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."	</ol>
	") : ("")) . "
	<strong>{$this->lang->words['jump_to']}</strong><br />
...
<div id='current_calendar' class='right calendar_wrap'>
	...
	<table id='calendar_table' class='ipb_table' summary=\"{$this->lang->words['calendar_for']} {$month} {$year}\">
		...
		<tr class='header'>
			...
			".$this->__f__999879b6036d2e93c7afae8dce128e6b($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."			<!--IBF.DAYS_CONTENT-->
		</tr>
	</table>
...
function __f__f612d4cc91538f111cd72791bb410508($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $calendars as $cid => $cal )
...
function __f__999879b6036d2e93c7afae8dce128e6b($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_00d4741ba942fc2608886bf168acc081 = is_array($this->functionData['mini_cal_mini_wrap']) ? count($this->functionData['mini_cal_mini_wrap']) : 0;
$this->functionData['mini_cal_mini_wrap'][$count_00d4741ba942fc2608886bf168acc081]['month'] = $month;
$this->functionData['mini_cal_mini_wrap'][$count_00d4741ba942fc2608886bf168acc081]['mid'] = $mid;
$this->functionData['mini_cal_mini_wrap'][$count_00d4741ba942fc2608886bf168acc081]['year'] = $year;
$this->functionData['mini_cal_mini_wrap'][$count_00d4741ba942fc2608886bf168acc081]['events'] = $events;
$this->functionData['mini_cal_mini_wrap'][$count_00d4741ba942fc2608886bf168acc081]['day_words'] = $day_words;
}
...
<table class='mini_cal'>
	<tr class='header'>
		...
		".$this->__f__d27f8b541f5c3baef0eb0f4fbffedb3f($month,$mid,$year,$events,$day_words)."		{$events}
	</tr>
</table>";
return $IPBHTML;
}
...
function __f__d27f8b541f5c3baef0eb0f4fbffedb3f($month="",$mid="",$year="",$events="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day_words as $day )
