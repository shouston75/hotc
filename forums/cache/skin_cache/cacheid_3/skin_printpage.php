...
class skin_printpage_3 extends skinMaster{
...
$this->_funcHooks['pp_postentry'] = array('postqueued','iconid');
...
{
$count_3c54e3dd1bebf26ee87f13d9adad9a87 = is_array($this->functionData['pp_end']) ? count($this->functionData['pp_end']) : 0;
}
$IPBHTML .= "<!--Copyright-->
...
{
$count_e49549ecc8f26cacebcf0a9f7ac05122 = is_array($this->functionData['pp_postentry']) ? count($this->functionData['pp_postentry']) : 0;
$this->functionData['pp_postentry'][$count_e49549ecc8f26cacebcf0a9f7ac05122]['poster'] = $poster;
$this->functionData['pp_postentry'][$count_e49549ecc8f26cacebcf0a9f7ac05122]['entry'] = $entry;
}
