...
$this->_funcHooks['globalTemplateMinimal'] = array('fbcenabled','pagenumberintitle','brandingBar','messengerlink','memberbox','hasBlog','hasGallery','viewnewcontentapp','mainpageContent','skinchanger','langchooser','isNotMobbyApp');
...
{
$count_ad94acba1c6207c788d5a8e3a5ec6acd = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_ad94acba1c6207c788d5a8e3a5ec6acd]['msg'] = $msg;
}
...
{
$count_d8cab396b172374fe5b33c297f60c215 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_d8cab396b172374fe5b33c297f60c215]['message'] = $message;
}
...
{
$count_25bd5e3c8f3dbb28938019d06d1371d7 = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_25bd5e3c8f3dbb28938019d06d1371d7]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_25bd5e3c8f3dbb28938019d06d1371d7]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_25bd5e3c8f3dbb28938019d06d1371d7]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_25bd5e3c8f3dbb28938019d06d1371d7]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_25bd5e3c8f3dbb28938019d06d1371d7]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__6066909d0523b30148f524f3b7d46f66($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__3c3b1939ee10905fc017e3e6cd868df2($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__88f13c8fd5074f645458e24761adaef5($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__6624989a6af3abb255dadcc42f0cc20e($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__6066909d0523b30148f524f3b7d46f66($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3c3b1939ee10905fc017e3e6cd868df2($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__88f13c8fd5074f645458e24761adaef5($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__bcb60a822e219367cf04dbf4a84046c1($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6624989a6af3abb255dadcc42f0cc20e($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__bcb60a822e219367cf04dbf4a84046c1($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_d7f8381db4e4796b4da5211b08a19ef7 = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_d7f8381db4e4796b4da5211b08a19ef7]['message'] = $message;
$this->functionData['Error'][$count_d7f8381db4e4796b4da5211b08a19ef7]['code'] = $code;
$this->functionData['Error'][$count_d7f8381db4e4796b4da5211b08a19ef7]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_d7f8381db4e4796b4da5211b08a19ef7]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_d7f8381db4e4796b4da5211b08a19ef7]['title'] = $title;
}
...
{
$count_0ab466e320f08d588b4a1a399075a8cb = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_0ab466e320f08d588b4a1a399075a8cb]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_0ab466e320f08d588b4a1a399075a8cb]['unreadUrl'] = $unreadUrl;
}
...
{
$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232 = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_cdfc71dc7f9ea7bfbaebd1e72ee1b232]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__9bdfbc3110f05fca967fe147fda38d15($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__9bdfbc3110f05fca967fe147fda38d15($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ee51e1f2bf408bf78b1e252650bba6eb = is_array($this->functionData['redirectTemplate']) ? count($this->functionData['redirectTemplate']) : 0;
$this->functionData['redirectTemplate'][$count_ee51e1f2bf408bf78b1e252650bba6eb]['documentHeadItems'] = $documentHeadItems;
$this->functionData['redirectTemplate'][$count_ee51e1f2bf408bf78b1e252650bba6eb]['css'] = $css;
$this->functionData['redirectTemplate'][$count_ee51e1f2bf408bf78b1e252650bba6eb]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['redirectTemplate'][$count_ee51e1f2bf408bf78b1e252650bba6eb]['text'] = $text;
$this->functionData['redirectTemplate'][$count_ee51e1f2bf408bf78b1e252650bba6eb]['url'] = $url;
$this->functionData['redirectTemplate'][$count_ee51e1f2bf408bf78b1e252650bba6eb]['full'] = $full;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"> 
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		<link rel=\"shortcut icon\" href='" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/favicon.ico' />
		" . ((is_array( $css['import'] )) ? ("
			".$this->__f__d8894d7449321ffa209d65a95cac0bf1($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__5c310d339d35b1fa6717c51ad60fcaae($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--[if lte IE 7]>
			<link rel=\"stylesheet\" type=\"text/css\" title='Main' media=\"screen\" href=\"{$this->settings['public_dir']}style_css/{$this->registry->output->skin['_csscacheid']}/ipb_ie.css\" />
		<![endif]-->
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__59829d0f3685127000feca60c6491fa0($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--/CSS-->
		<script type='text/javascript'>
		//<![CDATA[
...
function __f__d8894d7449321ffa209d65a95cac0bf1($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['import'] as $data )
...
function __f__5c310d339d35b1fa6717c51ad60fcaae($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['inline'] as $data )
...
function __f__68fb3534f08e1b940e315293b4f91191($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems[ $type ] as $idx => $data )
...
function __f__59829d0f3685127000feca60c6491fa0($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__68fb3534f08e1b940e315293b4f91191($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_cffa90a219a9a4ee35344021778e0700 = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_cffa90a219a9a4ee35344021778e0700]['member'] = $member;
$this->functionData['repButtons'][$count_cffa90a219a9a4ee35344021778e0700]['data'] = $data;
}
...
<div class='likepop fixed_inner'>
	<ul class='ipsList_withminiphoto'>
		".$this->__f__4434159d2b233121b985affce13a185a($data,$relId)."	</ul>
</div>";
return $IPBHTML;
}


function __f__4434159d2b233121b985affce13a185a($data, $relId)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "<div>
	...
	<div class='ipsPad' style='min-height: 60px'>
		...
		") : ("".$this->__f__e8f6eb198940fdb414cb7f0731c5724e($reps)."		")) . "
	</div>
</div>";
return $IPBHTML;
}
...
function __f__e8f6eb198940fdb414cb7f0731c5724e($reps)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reps as $r )
...
{
$count_deadcced9752976f3ebad0d4604a3bfc = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_deadcced9752976f3ebad0d4604a3bfc]['tags'] = $tags;
}
$IPBHTML .= "<h3 class='maintitle'>{$this->lang->words['mob_tags']}</h3>
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		<ul class='ipsList_inline'>
		".$this->__f__bdbe16e3bc47b28d192e88a6617b8c78($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__bdbe16e3bc47b28d192e88a6617b8c78($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5cd91c7a5915efafe0aa1137cd20fb5c = is_array($this->functionData['tagEntry']) ? count($this->functionData['tagEntry']) : 0;
$this->functionData['tagEntry'][$count_5cd91c7a5915efafe0aa1137cd20fb5c]['tag'] = $tag;
$this->functionData['tagEntry'][$count_5cd91c7a5915efafe0aa1137cd20fb5c]['noClass'] = $noClass;
$this->functionData['tagEntry'][$count_5cd91c7a5915efafe0aa1137cd20fb5c]['app'] = $app;
$this->functionData['tagEntry'][$count_5cd91c7a5915efafe0aa1137cd20fb5c]['section'] = $section;
}
...
{
$count_920be2f67ca51024a75ee0801f7713d8 = is_array($this->functionData['tagPrefix']) ? count($this->functionData['tagPrefix']) : 0;
$this->functionData['tagPrefix'][$count_920be2f67ca51024a75ee0801f7713d8]['tag'] = $tag;
$this->functionData['tagPrefix'][$count_920be2f67ca51024a75ee0801f7713d8]['app'] = $app;
$this->functionData['tagPrefix'][$count_920be2f67ca51024a75ee0801f7713d8]['section'] = $section;
}
			...
			<div class='ipsTagBox_editor'>
				<span id='{$options['fieldId']}_addwrap'>
					" . ((!$options['isOpenSystem']) ? ("<select id='{$options['fieldId']}_tag_select' class='input_select'>
							" . ((!empty( $options['predefinedTags'] )) ? ("".$this->__f__0c3794362b69abee106e6db28e5b6bae($tags,$options,$where)."							") : ("")) . "
						</select>") : ("
...
function __f__0c3794362b69abee106e6db28e5b6bae($tags, $options, $where)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
