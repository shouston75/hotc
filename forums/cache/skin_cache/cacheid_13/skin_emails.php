...
class skin_emails_13 extends skinMaster{
...
{
$count_a9f3ab2078f4a7979ede7020fffb8dfa = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_a9f3ab2078f4a7979ede7020fffb8dfa]['title'] = $title;
$this->functionData['forward_form'][$count_a9f3ab2078f4a7979ede7020fffb8dfa]['text'] = $text;
$this->functionData['forward_form'][$count_a9f3ab2078f4a7979ede7020fffb8dfa]['lang'] = $lang;
$this->functionData['forward_form'][$count_a9f3ab2078f4a7979ede7020fffb8dfa]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_a9f3ab2078f4a7979ede7020fffb8dfa]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__a111663b0bf195455176ce3f3e35fc2c($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__a111663b0bf195455176ce3f3e35fc2c($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
