...
class skin_editors_13 extends skinMaster{
...
$this->_funcHooks['editor'] = array('hasWrningInfo','jsNotLoaded','ismini','ismini','hasContent','hasType','ismini','hasHeight','hasMinimize','hasCallback','hasSaveKey','hasToAcknowledge');
...
{
$count_7cbbaa0d2aa5e055d3bc89bdab1f8715 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_7cbbaa0d2aa5e055d3bc89bdab1f8715]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_7cbbaa0d2aa5e055d3bc89bdab1f8715]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_7cbbaa0d2aa5e055d3bc89bdab1f8715]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_7cbbaa0d2aa5e055d3bc89bdab1f8715]['extraData'] = $extraData;
}
...
/* -- editor --*/
function editor($formField='post', $content='', $options=array(), $autoSaveData=array(), $warningInfo='', $acknowledge=FALSE, $bbcodeVersion=null) {
$IPBHTML = "";
if( IPSLib::locationHasHooks( 'skin_editors', $this->_funcHooks['editor'] ) )
{
$count_0c621ca77e03f4ddee179f5ca5991af5 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_0c621ca77e03f4ddee179f5ca5991af5]['formField'] = $formField;
$this->functionData['editor'][$count_0c621ca77e03f4ddee179f5ca5991af5]['content'] = $content;
$this->functionData['editor'][$count_0c621ca77e03f4ddee179f5ca5991af5]['options'] = $options;
$this->functionData['editor'][$count_0c621ca77e03f4ddee179f5ca5991af5]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_0c621ca77e03f4ddee179f5ca5991af5]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_0c621ca77e03f4ddee179f5ca5991af5]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_0c621ca77e03f4ddee179f5ca5991af5]['bbcodeVersion'] = $bbcodeVersion;
}
...
") : ("" . (($warningInfo) ? ("
	...
	" . (($bbcodeVersion || $options['bypassCKEditor']) ? ("<!-- NO JS FALLBACK -->
		<input type='hidden' name='noCKEditor' id='noCKEditor_{$options['editorName']}' value='1' />
...
{
$count_dc3ee71423b082295dd6e6ea502bcda2 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_dc3ee71423b082295dd6e6ea502bcda2]['options'] = $options;
$this->functionData['editorLoadJs'][$count_dc3ee71423b082295dd6e6ea502bcda2]['inlineLoad'] = $inlineLoad;
}
...
{
$count_1d6767cfe85144a2106b75d4dd9dd7f6 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_1d6767cfe85144a2106b75d4dd9dd7f6]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_1d6767cfe85144a2106b75d4dd9dd7f6]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_1d6767cfe85144a2106b75d4dd9dd7f6]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_1d6767cfe85144a2106b75d4dd9dd7f6]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__539cfe550d1bb086c19ab6e7f2abac0a($rows,$pages,$app,$plugin)."		") : ("
...
function __f__539cfe550d1bb086c19ab6e7f2abac0a($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_94bceda459bd7e2fd02b6f28b943f0b0 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_94bceda459bd7e2fd02b6f28b943f0b0]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__320e31231fb01e7b4e9a6cb50a72eac2($tabs)."			</ul>
		</div>
...
function __f__320e31231fb01e7b4e9a6cb50a72eac2($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
