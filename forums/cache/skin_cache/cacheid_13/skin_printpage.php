...
class skin_printpage_13 extends skinMaster{
...
{
$count_dbbd22099d50c871a1490ef88f6a5bf0 = is_array($this->functionData['pp_end']) ? count($this->functionData['pp_end']) : 0;
}
$IPBHTML .= "<!--Copyright-->
...
{
$count_4351042c738d3bc2a1344817707e6c25 = is_array($this->functionData['pp_postentry']) ? count($this->functionData['pp_postentry']) : 0;
$this->functionData['pp_postentry'][$count_4351042c738d3bc2a1344817707e6c25]['poster'] = $poster;
$this->functionData['pp_postentry'][$count_4351042c738d3bc2a1344817707e6c25]['entry'] = $entry;
}
