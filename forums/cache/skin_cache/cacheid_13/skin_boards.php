...
class skin_boards_13 extends skinMaster{
...
{
$count_cbc4850c387121d4288a3ae8890bf684 = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_cbc4850c387121d4288a3ae8890bf684]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_cbc4850c387121d4288a3ae8890bf684]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_cbc4850c387121d4288a3ae8890bf684]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_cbc4850c387121d4288a3ae8890bf684]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_cbc4850c387121d4288a3ae8890bf684]['side_blocks'] = $side_blocks;
}
...
<div id='board_index' class='ipsLayout " . (($this->templateVars['sidebar_enabled']) ? ("ipsLayout_withright") : ("")) . " ipsLayout_largeright clearfix " . ((IPSCookie::get('hide_sidebar') == '1') ? ("no_sidebar") : ("")) . "'>	
	...
	<!-- CATS AND FORUMS -->
		" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
			".$this->__f__1f3ca69fbab578fa31081e560e6162e8($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		") : ("")) . "
	</div>
	" . (($this->templateVars['sidebar_enabled']) ? ("<div id='index_stats' class='ipsLayout_right clearfix' " . ((IPSCookie::get('hide_sidebar') == '1') ? ("style='display: none'") : ("")) . ">
			".$this->__f__8d5fe80376aea54c7ae877696de29e50($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</div>
...
//<![CDATA[
	...
	" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		".$this->__f__0e88d6dd7957087c0497c94869455e2a($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."	") : ("")) . "
//]]>
</script>
...
<div id='board_statistics' class='statistics clearfix'>
	...
	" . (($this->settings['show_active'] && $this->memberData['gbw_view_online_lists']) ? ("<h4 class='statistics_head'>" . sprintf( $this->lang->words['online_right_now'], $stats['TOTAL'] ) . " {$this->lang->words['active_users']}</h4>
		...
		</p>") : ("")) . "<!--hook.if.skin_boards.boardIndexTemplate.showActive.post.endif-->
...
function __f__0690e9a48ba395e6e956aeb01933e7f6($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $forum_data['subforums'] as $__id => $__data )
	{
		...
		$_ips___x_retval .= "
																" . (($__data[3]) ? ("<li class='unread'>") : ("<li>")) . "
																	<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showforum={$__data[0]}", "public",'' ), "{$__data[2]}", "showforum" ) . "\" title='" . IPSText::striptags($__data[1]) . "'>{$__data[1]}</a>" . ((empty($__data[4] )) ? (",") : ("")) . "
																</li>
...
function __f__4705cb0e2cae008d9141441e7ca84cb4($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
										" . (($forum_data['redirect_on']) ? ("<tr class='redirect_forum' id='f_{$forum_data['id']}'>
												...
												<td " . (($this->memberData['gbw_view_last_info']) ? ("colspan='2'") : ("")) . " class='col_c_forum'>
													<h4><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showforum={$forum_data['id']}", "public",'' ), "{$forum_data['name_seo']}", "showforum" ) . "\" title='" . IPSText::striptags($forum_data['name']) . "'>{$forum_data['name']}</a></h4>
												...
												<td class='col_c_forum'>
													...
													<h4>
														...
														") : ("")) . "
														<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showforum={$forum_data['id']}", "public",'' ), "{$forum_data['name_seo']}", "showforum" ) . "\" title='" . IPSText::striptags($forum_data['name']) . "'>{$forum_data['name']}</a>
													</h4>
													...
													" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
														...
														<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
															".$this->__f__0690e9a48ba395e6e956aeb01933e7f6($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."														</ol>
													") : ("")) . "
...
function __f__1f3ca69fbab578fa31081e560e6162e8($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
						...
						<div class='ipsBox table_wrap'>
							<div class='ipsBox_container'>
								<table class='ipb_table' summary=\"{$this->lang->words['forums_in_cat']} '{$_data['cat_data']['name']}'\">
									...
									<!-- / CAT HEADER -->
									".$this->__f__4705cb0e2cae008d9141441e7ca84cb4($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."								</table>
							</div>
						</div>
						<br />
					</div>") : ("")) . "
...
function __f__8d5fe80376aea54c7ae877696de29e50($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
...
function __f__cf8502b2eeb6ac93e4a22f4445ed5c5a($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
...
function __f__0e88d6dd7957087c0497c94869455e2a($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__cf8502b2eeb6ac93e4a22f4445ed5c5a($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."			") : ("")) . "
...
{
$count_7c2d62321cb28947478485919eda781c = is_array($this->functionData['hookFacebookActivity']) ? count($this->functionData['hookFacebookActivity']) : 0;
}
...
{
$count_0c27dc6c0b3c45171cf147a6e01925f1 = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_0c27dc6c0b3c45171cf147a6e01925f1]['topics'] = $topics;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		...
		".$this->__f__079b97654c91006aa39df53aeaab8af0($topics)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__079b97654c91006aa39df53aeaab8af0($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_222da418775d85b7cc555c3fb12fa485 = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_222da418775d85b7cc555c3fb12fa485]['tags'] = $tags;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	<h3>{$this->lang->words['popular_tags']}</h3>
	<div class='_sbcollapsable'>
		<ul class='ipsList_inline'>
		".$this->__f__f53dbf3f227db15fa6fae74778c94e78($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__f53dbf3f227db15fa6fae74778c94e78($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ba695e15be812aabb6703521a91f5420 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_ba695e15be812aabb6703521a91f5420]['replies'] = $replies;
}
$IPBHTML .= "".$this->__f__c1dc068decea206f2f0638ddb14d7b49($replies)."";
return $IPBHTML;
}


function __f__c1dc068decea206f2f0638ddb14d7b49($replies=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_60d7d096179204e44db4bf5802d9d397 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_60d7d096179204e44db4bf5802d9d397]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_60d7d096179204e44db4bf5802d9d397]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_60d7d096179204e44db4bf5802d9d397]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "<script type=\"text/javascript\">
...
</script>".$this->__f__390666bf9a2928c773c26dfcb9c43b82($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__390666bf9a2928c773c26dfcb9c43b82($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
