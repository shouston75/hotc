...
class skin_ibEconomy_13 extends skinMaster{
...
{
$count_1661537599a37b37b4d5ed158dba7ace = is_array($this->functionData['area_side_bar']) ? count($this->functionData['area_side_bar']) : 0;
$this->functionData['area_side_bar'][$count_1661537599a37b37b4d5ed158dba7ace]['isActive'] = $isActive;
$this->functionData['area_side_bar'][$count_1661537599a37b37b4d5ed158dba7ace]['areaLangName'] = $areaLangName;
$this->functionData['area_side_bar'][$count_1661537599a37b37b4d5ed158dba7ace]['title'] = $title;
$this->functionData['area_side_bar'][$count_1661537599a37b37b4d5ed158dba7ace]['moreURL'] = $moreURL;
}
...
{
$count_e04aff7c3bf719a0b376c5f52f12cee0 = is_array($this->functionData['blockRowLotto']) ? count($this->functionData['blockRowLotto']) : 0;
$this->functionData['blockRowLotto'][$count_e04aff7c3bf719a0b376c5f52f12cee0]['row'] = $row;
$this->functionData['blockRowLotto'][$count_e04aff7c3bf719a0b376c5f52f12cee0]['block'] = $block;
}
...
{
$count_3527288f05f6adf7975bfa9c4bc796f9 = is_array($this->functionData['blocks']) ? count($this->functionData['blocks']) : 0;
$this->functionData['blocks'][$count_3527288f05f6adf7975bfa9c4bc796f9]['blocks'] = $blocks;
}
...
{
$count_dc2e2539a07faf37f460b1ee8122ef3a = is_array($this->functionData['button_row']) ? count($this->functionData['button_row']) : 0;
$this->functionData['button_row'][$count_dc2e2539a07faf37f460b1ee8122ef3a]['my_points'] = $my_points;
$this->functionData['button_row'][$count_dc2e2539a07faf37f460b1ee8122ef3a]['leftButtons'] = $leftButtons;
}
...
{
$count_c39d7f491ee81ead0567f2b928faa995 = is_array($this->functionData['cart_wrapper']) ? count($this->functionData['cart_wrapper']) : 0;
$this->functionData['cart_wrapper'][$count_c39d7f491ee81ead0567f2b928faa995]['content'] = $content;
$this->functionData['cart_wrapper'][$count_c39d7f491ee81ead0567f2b928faa995]['totals'] = $totals;
}
...
{
$count_ca8fad1a13e2e9ef3198a524e700434a = is_array($this->functionData['editMemPtsPop']) ? count($this->functionData['editMemPtsPop']) : 0;
$this->functionData['editMemPtsPop'][$count_ca8fad1a13e2e9ef3198a524e700434a]['member'] = $member;
$this->functionData['editMemPtsPop'][$count_ca8fad1a13e2e9ef3198a524e700434a]['url'] = $url;
}
...
{
$count_a42b6c4ab83236a763d0d2122c39bb53 = is_array($this->functionData['init_js_css']) ? count($this->functionData['init_js_css']) : 0;
}
$IPBHTML .= "<!--JS-->
...
{
$count_727abd784dd03dac6187dc10b3e62ac3 = is_array($this->functionData['memberInfoPane']) ? count($this->functionData['memberInfoPane']) : 0;
$this->functionData['memberInfoPane'][$count_727abd784dd03dac6187dc10b3e62ac3]['member'] = $member;
$this->functionData['memberInfoPane'][$count_727abd784dd03dac6187dc10b3e62ac3]['miniShopItemBox'] = $miniShopItemBox;
}
...
{
$count_d636be8bec986e5d3a4f126090c7ffba = is_array($this->functionData['memberProfileDonate']) ? count($this->functionData['memberProfileDonate']) : 0;
$this->functionData['memberProfileDonate'][$count_d636be8bec986e5d3a4f126090c7ffba]['memberID'] = $memberID;
}
...
{
$count_fcfd10c76f8396de8dc3087d37ddd124 = is_array($this->functionData['memPanePop']) ? count($this->functionData['memPanePop']) : 0;
$this->functionData['memPanePop'][$count_fcfd10c76f8396de8dc3087d37ddd124]['member'] = $member;
$this->functionData['memPanePop'][$count_fcfd10c76f8396de8dc3087d37ddd124]['url'] = $url;
}
$IPBHTML .= "<form action='{$this->settings['base_url']}app=ibEconomy&amp;do=donate' method='post'>
		<table class='ipb_table'>
			<tr class='header'>
...
{
$count_0c0c823d1e040cd671f77fda4c89570d = is_array($this->functionData['pointButton']) ? count($this->functionData['pointButton']) : 0;
$this->functionData['pointButton'][$count_0c0c823d1e040cd671f77fda4c89570d]['member'] = $member;
}
...
{
$count_12af300d64ac0ba939f3322069ad51e8 = is_array($this->functionData['profileTab']) ? count($this->functionData['profileTab']) : 0;
$this->functionData['profileTab'][$count_12af300d64ac0ba939f3322069ad51e8]['assets'] = $assets;
$this->functionData['profileTab'][$count_12af300d64ac0ba939f3322069ad51e8]['transactions'] = $transactions;
$this->functionData['profileTab'][$count_12af300d64ac0ba939f3322069ad51e8]['member'] = $member;
$this->functionData['profileTab'][$count_12af300d64ac0ba939f3322069ad51e8]['shopItems'] = $shopItems;
}
...
{
$count_a5f93ef1d7efa6cd4866b6de0a495263 = is_array($this->functionData['settings']) ? count($this->functionData['settings']) : 0;
$this->functionData['settings'][$count_a5f93ef1d7efa6cd4866b6de0a495263]['mySettings'] = $mySettings;
$this->functionData['settings'][$count_a5f93ef1d7efa6cd4866b6de0a495263]['myPluginSettings'] = $myPluginSettings;
}
...
{
$count_50de064566f9c3b45e686658a7c3935a = is_array($this->functionData['standings_row']) ? count($this->functionData['standings_row']) : 0;
$this->functionData['standings_row'][$count_50de064566f9c3b45e686658a7c3935a]['member'] = $member;
}
...
{
$count_a8b907156420d4f0ca71e15be890cb5e = is_array($this->functionData['standings_wrapper']) ? count($this->functionData['standings_wrapper']) : 0;
$this->functionData['standings_wrapper'][$count_a8b907156420d4f0ca71e15be890cb5e]['content'] = $content;
$this->functionData['standings_wrapper'][$count_a8b907156420d4f0ca71e15be890cb5e]['pages'] = $pages;
$this->functionData['standings_wrapper'][$count_a8b907156420d4f0ca71e15be890cb5e]['active'] = $active;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("memberlist", "0" ) . "
...
{
$count_c59a9988d1e6b151ef674a4b9809b377 = is_array($this->functionData['stats']) ? count($this->functionData['stats']) : 0;
$this->functionData['stats'][$count_c59a9988d1e6b151ef674a4b9809b377]['active'] = $active;
$this->functionData['stats'][$count_c59a9988d1e6b151ef674a4b9809b377]['totals'] = $totals;
}
...
{
$count_e16aa19511ec2507be8ea92ff4d35cd7 = is_array($this->functionData['tab']) ? count($this->functionData['tab']) : 0;
$this->functionData['tab'][$count_e16aa19511ec2507be8ea92ff4d35cd7]['isActive'] = $isActive;
$this->functionData['tab'][$count_e16aa19511ec2507be8ea92ff4d35cd7]['tabName'] = $tabName;
$this->functionData['tab'][$count_e16aa19511ec2507be8ea92ff4d35cd7]['tabLangName'] = $tabLangName;
$this->functionData['tab'][$count_e16aa19511ec2507be8ea92ff4d35cd7]['title'] = $title;
}
$IPBHTML .= "<li " . (($isActive) ? ("class='active'") : ("")) . ">
...
{
$count_e0030529d16face86bcc5865b826652c = is_array($this->functionData['transactions_wrapper']) ? count($this->functionData['transactions_wrapper']) : 0;
$this->functionData['transactions_wrapper'][$count_e0030529d16face86bcc5865b826652c]['content'] = $content;
$this->functionData['transactions_wrapper'][$count_e0030529d16face86bcc5865b826652c]['otherSW'] = $otherSW;
$this->functionData['transactions_wrapper'][$count_e0030529d16face86bcc5865b826652c]['pages'] = $pages;
$this->functionData['transactions_wrapper'][$count_e0030529d16face86bcc5865b826652c]['showMember'] = $showMember;
}
$IPBHTML .= "<div class='maintitle ipsFilterbar'>
			<ul class='ipsList_inline ipsType_smaller'>
...
{
$count_edf0ec78780bd5f1554874371dbcb276 = is_array($this->functionData['wrapper']) ? count($this->functionData['wrapper']) : 0;
$this->functionData['wrapper'][$count_edf0ec78780bd5f1554874371dbcb276]['active'] = $active;
$this->functionData['wrapper'][$count_edf0ec78780bd5f1554874371dbcb276]['showpage'] = $showpage;
}
