...
/* CACHE FILE: Generated: Sat, 22 Dec 2012 23:42:14 GMT */
/* DO NOT EDIT DIRECTLY - THE CHANGES WILL NOT BE   */
/* WRITTEN TO THE DATABASE AUTOMATICALLY            */
/*--------------------------------------------------*/

class skin_calendar_13 extends skinMaster{
...
{
$count_027c19dedda6af79bf6a0a9e42524623 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_027c19dedda6af79bf6a0a9e42524623]['month_day'] = $month_day;
$this->functionData['cal_date_cell'][$count_027c19dedda6af79bf6a0a9e42524623]['events'] = $events;
$this->functionData['cal_date_cell'][$count_027c19dedda6af79bf6a0a9e42524623]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_027c19dedda6af79bf6a0a9e42524623]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_027c19dedda6af79bf6a0a9e42524623]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
" . (($queued != 0) ? ("
...
{
$count_a3ec9f86f55e4d4c9f4031240e9500d1 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_a3ec9f86f55e4d4c9f4031240e9500d1]['month_day'] = $month_day;
$this->functionData['cal_date_cell_today'][$count_a3ec9f86f55e4d4c9f4031240e9500d1]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_a3ec9f86f55e4d4c9f4031240e9500d1]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_a3ec9f86f55e4d4c9f4031240e9500d1]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_a3ec9f86f55e4d4c9f4031240e9500d1]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
" . (($queued != 0) ? ("
...
{
$count_30cec157673355098950eac828c0a16a = is_array($this->functionData['cal_show_event']) ? count($this->functionData['cal_show_event']) : 0;
$this->functionData['cal_show_event'][$count_30cec157673355098950eac828c0a16a]['event'] = $event;
$this->functionData['cal_show_event'][$count_30cec157673355098950eac828c0a16a]['member'] = $member;
$this->functionData['cal_show_event'][$count_30cec157673355098950eac828c0a16a]['event_type'] = $event_type;
$this->functionData['cal_show_event'][$count_30cec157673355098950eac828c0a16a]['edit_button'] = $edit_button;
$this->functionData['cal_show_event'][$count_30cec157673355098950eac828c0a16a]['approve_button'] = $approve_button;
$this->functionData['cal_show_event'][$count_30cec157673355098950eac828c0a16a]['type'] = $type;
$this->functionData['cal_show_event'][$count_30cec157673355098950eac828c0a16a]['date_ends'] = $date_ends;
}
...
{
$count_5ac53ec49da32f80bc7273ee7317b252 = is_array($this->functionData['cal_week_content']) ? count($this->functionData['cal_week_content']) : 0;
$this->functionData['cal_week_content'][$count_5ac53ec49da32f80bc7273ee7317b252]['calendars'] = $calendars;
$this->functionData['cal_week_content'][$count_5ac53ec49da32f80bc7273ee7317b252]['date'] = $date;
$this->functionData['cal_week_content'][$count_5ac53ec49da32f80bc7273ee7317b252]['month'] = $month;
$this->functionData['cal_week_content'][$count_5ac53ec49da32f80bc7273ee7317b252]['year'] = $year;
$this->functionData['cal_week_content'][$count_5ac53ec49da32f80bc7273ee7317b252]['prev'] = $prev;
$this->functionData['cal_week_content'][$count_5ac53ec49da32f80bc7273ee7317b252]['next'] = $next;
$this->functionData['cal_week_content'][$count_5ac53ec49da32f80bc7273ee7317b252]['cal_id'] = $cal_id;
}
...
<div id='mini_calendars' class='left calendar_wrap'>
	<div id='calendar_list' class='left general_box'>
		...
		<ol>
			".$this->__f__05cf7363c0b2f4c24eb1d346e5824744($calendars,$date,$month,$year,$prev,$next,$cal_id)."		</ol>
		") : ("")) . "
...
function __f__05cf7363c0b2f4c24eb1d346e5824744($calendars, $date="",$month="",$year="",$prev="",$next="", $cal_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2391d6039602c3655a5db8bc53c821c4 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_2391d6039602c3655a5db8bc53c821c4]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_2391d6039602c3655a5db8bc53c821c4]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_2391d6039602c3655a5db8bc53c821c4]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_2391d6039602c3655a5db8bc53c821c4]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_2391d6039602c3655a5db8bc53c821c4]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_2391d6039602c3655a5db8bc53c821c4]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_2391d6039602c3655a5db8bc53c821c4]['queued'] = $queued;
}
...
{
$count_e1c10f0d8f36a30f9fe00dc8da2594b6 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_e1c10f0d8f36a30f9fe00dc8da2594b6]['rows'] = $rows;
}
...
<div class='general_box'>	<ul>
		".$this->__f__2396cab3208ba2e156ca09ff7cc82cef($rows)."	</ul>
</div>";
return $IPBHTML;
}


function __f__2396cab3208ba2e156ca09ff7cc82cef($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_e760ccf89490b50596caae87235dfce5 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['code'] = $code;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['calendar_id'] = $calendar_id;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['formtype'] = $formtype;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['event_id'] = $event_id;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['event_title'] = $event_title;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['form_title'] = $form_title;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['event_date'] = $event_date;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['event_type'] = $event_type;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['groups'] = $groups;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['button'] = $button;
$this->functionData['calendarEventForm'][$count_e760ccf89490b50596caae87235dfce5]['editor'] = $editor;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
...
{
$count_11bd59aa9cdd06b54170ba48a0c0d944 = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_11bd59aa9cdd06b54170ba48a0c0d944]['calendars'] = $calendars;
$this->functionData['calendarMainContent'][$count_11bd59aa9cdd06b54170ba48a0c0d944]['month'] = $month;
$this->functionData['calendarMainContent'][$count_11bd59aa9cdd06b54170ba48a0c0d944]['year'] = $year;
$this->functionData['calendarMainContent'][$count_11bd59aa9cdd06b54170ba48a0c0d944]['prev'] = $prev;
$this->functionData['calendarMainContent'][$count_11bd59aa9cdd06b54170ba48a0c0d944]['next'] = $next;
$this->functionData['calendarMainContent'][$count_11bd59aa9cdd06b54170ba48a0c0d944]['cal_jump'] = $cal_jump;
$this->functionData['calendarMainContent'][$count_11bd59aa9cdd06b54170ba48a0c0d944]['cal_id'] = $cal_id;
$this->functionData['calendarMainContent'][$count_11bd59aa9cdd06b54170ba48a0c0d944]['day_words'] = $day_words;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<h2>{$this->lang->words['calendars']}</h2>
<div id='current_calendar' class='right calendar_wrap'>
	...
	<table id='calendar_table' class='ipb_table' summary=\"{$this->lang->words['calendar_for']} {$month} {$year}\">
		...
		<tr class='header'>
			...
			".$this->__f__c69227feaa4b007c1e40ee8bbb7c8e97($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."			<!--IBF.DAYS_CONTENT-->
		</tr>
	</table>
...
<div id='mini_calendars' class='left calendar_wrap'>
	<div id='calendar_list' class='general_box'>
		...
		<p><strong>{$this->lang->words['select_calendar']}</strong></p>
		<ol>
			".$this->__f__a4218cde4a0233ef18d4b0b3a01c2872($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."		</ol>
		") : ("")) . "
		<strong>{$this->lang->words['jump_to']}</strong><br />
...
function __f__c69227feaa4b007c1e40ee8bbb7c8e97($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a4218cde4a0233ef18d4b0b3a01c2872($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $calendars as $cid => $cal )
...
{
$count_cef5aea047808264a713e0b610ee48a3 = is_array($this->functionData['mini_cal_mini_wrap']) ? count($this->functionData['mini_cal_mini_wrap']) : 0;
$this->functionData['mini_cal_mini_wrap'][$count_cef5aea047808264a713e0b610ee48a3]['month'] = $month;
$this->functionData['mini_cal_mini_wrap'][$count_cef5aea047808264a713e0b610ee48a3]['mid'] = $mid;
$this->functionData['mini_cal_mini_wrap'][$count_cef5aea047808264a713e0b610ee48a3]['year'] = $year;
$this->functionData['mini_cal_mini_wrap'][$count_cef5aea047808264a713e0b610ee48a3]['events'] = $events;
$this->functionData['mini_cal_mini_wrap'][$count_cef5aea047808264a713e0b610ee48a3]['day_words'] = $day_words;
}
...
$IPBHTML .= "<!-- <a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&amp;cal_id={$this->request['_cal_id']}&amp;m={$mid}&amp;y=$year", "public",'' ), "", "" ) . "\"> --><div class='mini-cal-wrap'>
	...
	<table class='mini_cal'>
		<tr class='header'>
			...
			".$this->__f__32649358a25dc1cf61ea541526c3cc4a($month,$mid,$year,$events,$day_words)."	
			{$events}
		</tr>
	</table>
</div>";
...
function __f__32649358a25dc1cf61ea541526c3cc4a($month="",$mid="",$year="",$events="",$day_words="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day_words as $day )
