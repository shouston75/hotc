...
class skin_forum_13 extends skinMaster{
...
$this->_funcHooks['topic'] = array('nav','haslastpage','pages','queuedtopic','hasmodlinks','solvedBadge','archivedBadge','archivingBadge','queuedpostsImg','topicUnapproved','hasPrefix','showForumNav','showReason','topicDeletedReason','hasTags','multipages','canReadPreview','isHot','isMember','replylang','isMemberCloseA','isLink','hasPollBump','canSeeLastInfo','mmtidon','tidRestore','isUnapproved','issupermod','ispinned','islink','closedtopic','opentopic','islink2','topicmoderator','topicIsDeleted','archivedCb','mmicon','adCodeColSpan','adCodeCheck');
...
{
$count_d3c0486387bd9e4bd70b8740e88ef854 = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_d3c0486387bd9e4bd70b8740e88ef854]['title'] = $title;
$this->functionData['forumAttachments'][$count_d3c0486387bd9e4bd70b8740e88ef854]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_d3c0486387bd9e4bd70b8740e88ef854]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__0931c0ccf226462c5d225e1f5840b02d($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__0931c0ccf226462c5d225e1f5840b02d($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_36b509be7ab69a3a9847dc749d9971ee = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_36b509be7ab69a3a9847dc749d9971ee]['inforum'] = $inforum;
}
...
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
	<table class='ipb_table topic_list hover_rows' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='announcements'>
		".$this->__f__8da494e9878c12b9f7b05459cec58a7e($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</table>
	<br />
") : ("")) . "
<!-- __-SUBFORUMS-__ -->
		...
		<div class='ipsBox table_wrap'>
			<div class='ipsBox_container'>
				<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$forum_data['name']}'\">
					".$this->__f__188f04ecb0c5f76ede8ffefd62ba07e7($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</table>
			</div>
		</div>
	</div>
	<br /><br />
		...
		<div class='ipsBox_container'>
			<table class='ipb_table topic_list hover_rows " . (($this->memberData['is_mod'] == 1) ? ("is_mod") : ("")) . "' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
				...
				" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
					".$this->__f__d5fbabc4aa1e1caf66269747c1affacb($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				") : ("<tr> 
						" . (($this->memberData['is_mod'] == 1) ? ("
	...
	<div id='forum_footer' class='statistics clear clearfix'>
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='right ipsType_small'>
				...
				".$this->__f__a37b6ca8dfdb2c4c61f0111cb28d537a($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			</div>
		") : ("")) . "
...
" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
	".$this->__f__565c8549a8261d9bf372a81aa1825a24($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
</select>";
return $IPBHTML;
}


function __f__8da494e9878c12b9f7b05459cec58a7e($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__728175e68f3e6b5307eae47d45382c91($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c44ca5bfc9cd6eb724ca929b0bac23a6($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
										...
										<td class='col_c_forum'>
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												...
												<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
													".$this->__f__728175e68f3e6b5307eae47d45382c91($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."												</ol>
											") : ("")) . "
...
function __f__188f04ecb0c5f76ede8ffefd62ba07e7($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
						" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
							".$this->__f__c44ca5bfc9cd6eb724ca929b0bac23a6($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."						") : ("")) . "
...
function __f__d5fbabc4aa1e1caf66269747c1affacb($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a37b6ca8dfdb2c4c61f0111cb28d537a($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__565c8549a8261d9bf372a81aa1825a24($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3bff8e8c352581d6dd1ca3e6a6f83546 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_3bff8e8c352581d6dd1ca3e6a6f83546]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_3bff8e8c352581d6dd1ca3e6a6f83546]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_3bff8e8c352581d6dd1ca3e6a6f83546]['opts'] = $opts;
}
...
{
$count_31ac95a473b3e4fb83729a0273c5f52a = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_31ac95a473b3e4fb83729a0273c5f52a]['data'] = $data;
$this->functionData['topic'][$count_31ac95a473b3e4fb83729a0273c5f52a]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_31ac95a473b3e4fb83729a0273c5f52a]['other_data'] = $other_data;
$this->functionData['topic'][$count_31ac95a473b3e4fb83729a0273c5f52a]['inforum'] = $inforum;
}
$IPBHTML .= "" . ((($this->memberData['is_mod'] AND ! $data['approved']) OR $data['_isDeleted']) ? ("<tr itemscope itemtype=\"http://schema.org/Article\" class='__topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable moderated' id='trow_{$data['_tid']}' data-tid=\"{$data['_tid']}\">") : ("<tr itemscope itemtype=\"http://schema.org/Article\" class='__topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable' id='trow_{$data['_tid']}' data-tid=\"{$data['_tid']}\">")) . "
	...
	<td class='col_f_content " . (($this->memberData['is_mod'] == 1 || $forum_data['permissions']['TopicSoftDelete']) ? (" with_mod_links") : ("")) . "'>
		...
		") : ("")) . "
		" . ((! $inforum && $data['nav']) ? ("
			".$this->__f__d63ceda8a71ea00f8ce8cce50a32ecec($data,$forum_data,$other_data,$inforum)."		") : ("")) . "
		<h4>
			{$data['prefix']}
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__5179aef9960f8ad4af1185d676861da1($data,$forum_data,$other_data,$inforum)."			</ul>
		") : ("")) . "
	</td>
		...
		<ul class='last_post ipsType_small'>
			...
			<li>
				<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$data['tid']}&amp;view=getlastpost", "public",'' ), "{$data['title_seo']}", "showtopic" ) . "' title='{$this->lang->words['goto_last_post']}: {$data['title']}'>
					" . (($data['last_real_post']) ? ("
						" . $this->registry->getClass('class_localization')->getDate($data['last_real_post'],"DATE", 0) . "
					") : ("
						" . $this->registry->getClass('class_localization')->getDate($data['last_post'],"DATE", 0) . "
					")) . "
				</a>
			</li>
		</ul>
...
function __f__d63ceda8a71ea00f8ce8cce50a32ecec($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5179aef9960f8ad4af1185d676861da1($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b1eda22afce82544bd57f9e6b2693e2f = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_b1eda22afce82544bd57f9e6b2693e2f]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__3b5e152c37893905aab05fc24852c687($rating_id)."</span>";
return $IPBHTML;
}


function __f__3b5e152c37893905aab05fc24852c687($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f9d97c9f5f32d042cef8cda8ac903b3a = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_f9d97c9f5f32d042cef8cda8ac903b3a]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
