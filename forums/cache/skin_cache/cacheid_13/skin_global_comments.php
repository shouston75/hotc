...
class skin_global_comments_13 extends skinMaster{
...
{
$count_9b3407ee5f8d6e59caf1a27402f3be7a = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_9b3407ee5f8d6e59caf1a27402f3be7a]['r'] = $r;
$this->functionData['comment'][$count_9b3407ee5f8d6e59caf1a27402f3be7a]['parent'] = $parent;
$this->functionData['comment'][$count_9b3407ee5f8d6e59caf1a27402f3be7a]['settings'] = $settings;
}
...
{
$count_b3e32c18a774172ff94a5bfdff4564bf = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_b3e32c18a774172ff94a5bfdff4564bf]['r'] = $r;
$this->functionData['commentHidden'][$count_b3e32c18a774172ff94a5bfdff4564bf]['parent'] = $parent;
$this->functionData['commentHidden'][$count_b3e32c18a774172ff94a5bfdff4564bf]['settings'] = $settings;
}
...
{
$count_0cf6f65e800cdb8fd7b67f14517ab9c8 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_0cf6f65e800cdb8fd7b67f14517ab9c8]['comments'] = $comments;
$this->functionData['commentsList'][$count_0cf6f65e800cdb8fd7b67f14517ab9c8]['settings'] = $settings;
$this->functionData['commentsList'][$count_0cf6f65e800cdb8fd7b67f14517ab9c8]['pages'] = $pages;
$this->functionData['commentsList'][$count_0cf6f65e800cdb8fd7b67f14517ab9c8]['parent'] = $parent;
$this->functionData['commentsList'][$count_0cf6f65e800cdb8fd7b67f14517ab9c8]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__8b2ea5a3c6593d2e207ce537d75a4f89($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__8b2ea5a3c6593d2e207ce537d75a4f89($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9d59638dd86440284bcb417fa8acdeb8 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_9d59638dd86440284bcb417fa8acdeb8]['comment'] = $comment;
$this->functionData['form'][$count_9d59638dd86440284bcb417fa8acdeb8]['parent'] = $parent;
$this->functionData['form'][$count_9d59638dd86440284bcb417fa8acdeb8]['editor'] = $editor;
$this->functionData['form'][$count_9d59638dd86440284bcb417fa8acdeb8]['settings'] = $settings;
$this->functionData['form'][$count_9d59638dd86440284bcb417fa8acdeb8]['errors'] = $errors;
$this->functionData['form'][$count_9d59638dd86440284bcb417fa8acdeb8]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
