...
class skin_post_13 extends skinMaster{
...
{
$count_893d60c6cebd657f25ad2d5f18dc62d3 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_893d60c6cebd657f25ad2d5f18dc62d3]['data'] = $data;
}
...
{
$count_5a10a3825b3c1c6e568c5df266a5daf4 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_5a10a3825b3c1c6e568c5df266a5daf4]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_5a10a3825b3c1c6e568c5df266a5daf4]['form'] = $form;
}
...
{
$count_85b6d2ac61d0a33d22a5909c380d7d03 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_85b6d2ac61d0a33d22a5909c380d7d03]['data'] = $data;
}
...
{
$count_4fbfe0be3c8e4996fd5f978d2843615f = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_4fbfe0be3c8e4996fd5f978d2843615f]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__93a2c2e02d0319b1c4c4f40214a89b72($posts)."") : ("")) . "
<p class='submit'>
...
function __f__93a2c2e02d0319b1c4c4f40214a89b72($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ae497aa0e17e1dd9587ca28ebcc8bab7 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_ae497aa0e17e1dd9587ca28ebcc8bab7]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_ae497aa0e17e1dd9587ca28ebcc8bab7]['type'] = $type;
$this->functionData['uploadForm'][$count_ae497aa0e17e1dd9587ca28ebcc8bab7]['stats'] = $stats;
$this->functionData['uploadForm'][$count_ae497aa0e17e1dd9587ca28ebcc8bab7]['id'] = $id;
$this->functionData['uploadForm'][$count_ae497aa0e17e1dd9587ca28ebcc8bab7]['forum_id'] = $forum_id;
}
