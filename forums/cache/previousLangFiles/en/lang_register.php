...
'dname_text' 					=> "This is the name shown with all your topics and posts. Between 3 and %s chars. Illegal chars: [ ] | ; ,  &#036; &#92; &lt; &gt; &quot;",
'reg_error_dname_len'      		=> "The display name must be between 3 and %s characters",
...
'user_name_text' 				=> "This is the name you'll use to log in. [3 and %s characters long]",
...
'lp_text_email'    				=> "Enter your account email address in the field below. The email address is case <b>in</b>sensitive.<br />Once you have submitted the form, you will receive an email asking for validation of this request to ensure that no malicious use has occurred. This email will also contain a link that you must click for further instruction.",
'las_input_text' 				=> "Please enter the 6 character code shown in the image. If you cannot read the code, click the image to generate a new one.  Case sensitive.",

// 2.2: NEW
'form_title_attention' 			=> "Attention!",
'reg_error_email_invalid'		=> "The email address you entered is invalid (ex: name@domain.com)<br /> or contains illegal characters: [ ] ; # &amp; ! * ' &quot; &lt; &gt; % ( ) { } ? &#092;",
'reg_error_dname_only'			=> "The display name can only contain these characters: ",
'reg_error_uname_only'			=> "The username can only contain these characters: ",
...
'tc_regbut' 					=> "Register",
'op_email_title' 				=> "Receiving Email",
'op_email_text' 				=> "Now and again, the administrators and other members might wish to contact you via email through this board.",
'op_email_ad'   				=> "Receive email from administrators",
'op_email_mem' 					=> "Receive email from other members",
'op_tz_title'   				=> "Time Zone Settings",
'op_tz_text'   					=> "You can adjust the default time zone setting below",
'op_tz_dst'    					=> 'Observing Daylight Saving Time?',
'submit_text' 					=> "I agree to the terms of this registration and wish to proceed.",

'cf_optional'     				=> "Optional Information",

'user_name_title'          		=> "Username:",

'password_title'   				=> "Password:",
'password'		   				=> "Enter your password",
'password_text'    				=> "Passwords must be between 3 and 32 characters long",
'password_confirm' 				=> "Confirm Password",
'password_confirm_text' 		=> "Please re-enter your password: It must match exactly",

'email_address_title' 			=> "Email Address:",
'email_address_text'  			=> "Enter a valid email address. Illegal characters: [ ] ; # &amp; ! * ' &quot; &lt; &gt; % ( ) { } ? &#092;",
'email_address_confirm' 		=> "Confirm Email Address",
'email_address_confirm_text' 	=> "Please re-enter your email address: It must match exactly",
...
'rv_ins'    					=> "Please enter your %s below to search for any pending validation requests. If any are found, the email will be resent to the email address you registered with.",
'rv_name'   					=> "Registered Member Name",
'rv_email'   					=> "Registered Member Email",
...
'err_user_start_zero' 			=> "Your chosen username must not begin with a zero (0)",
...
'err_no_password'  				=> "You must enter a valid password between 3 and 32 characters",
...
'err_email_exists'  			=> "An account is already registered with that email address, please choose another",
...
'coppa_form_text'   			=> "A parent or guardian must complete and mail or fax a signed <#FORM_LINK#> to the administrator of the board before a child under the age of 13 can complete the registration process.<br /><br />For further information, please contact:",
...
'lp_email_address' 				=> "Enter your email address",
