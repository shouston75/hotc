...
'atn_sitemap_success_desc' => "The sitemap generator did not finish the last run, this may be because you tried to run it manually from the Admin CP or the task is not running regularly enough due to forum inactivity. You may wish to set up this task to run via CRON.",
