...
'language_word_pack_no_results' => "No results found",
...
's_functions' => "Disable Dangerous PHP Functions",
's_functions_bad' => "We recommend disabling the following functions on your server. If you do not manage your server yourself, your hosting provider will be able to assist with this.<br />%s",
's_functions_good' => "All of the recommended functions to disable have been disabled on your server.",
...
's_open_basedir' => "Enable open_basedir",
's_open_basedir_bad' => "We recommend enabling the PHP configuration option open_basedir and setting it to your webroot and temporary directory. If you do not manage your server yourself, your hosting provider will be able to assist with this.",
's_open_basedir_good' => "open_basedir is enabled and set to:<br />%s",
's_open_basedir_good_noval' => "open_basedir is enabled.",
...
'task_cronmode_desc_11' => "2. Make sure any tasks that you previously disabled to run by individual crons are re-enabled and those crons deleted on the server.",
