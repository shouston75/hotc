...
'sec_change_the_line_define_cp_dire' => "Replacing the <strong>admin</strong> with your directory name.",
...
'sec_locate_the_admin_directory_cho' => "Locate the 'admin' directory. Choose 'rename' from your FTP client menu and rename it to whatever you like.",
'sec_locate_the_initdataphp_file_th' => "Create a file called 'constants.php'. Download it, open it in a text editor, and paste the following contents.",
