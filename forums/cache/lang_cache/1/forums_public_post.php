...
'not_enough_points_to_post_in_this_forum' => "Sorry, you don't have enough <%POINTS_NAME%> to post a reply in this forum. You need <%AMOUNT%> <%POINTS_NAME%> to post a reply in this forum.",
'not_enough_points_to_start_topic_in_this_forum' => "Sorry, you don't have enough <%POINTS_NAME%> to create a topic in this forum. You need <%AMOUNT%> <%POINTS_NAME%> to create a new topic in this forum.",
