...
/*******************************************************
NOTE: This is a cache file generated by IP.Board on Thu, 13 Dec 2012 15:51:32 +0000 by Walter White
...
'ban_name' => "Name",
'ban_names' => "Non-Registrable Names",
...
'cf_f_admin' => "<strong class='title'>Make Admin and Super Moderator Editable/Viewable Only?</strong>",
...
'cf_f_group' => "<strong class='title'>Profile Group</strong>",
'cf_f_icon' => "<strong class='title'>Profile Icon</strong>",
'cf_f_key' => "<strong class='title'>Field Key</strong>",
'cf_f_key_info' => "This is a key that can be used to identify the field (e.g. in skins)",
'cf_f_max' => "<strong class='title'>Maximum Input</strong>",
'cf_f_max_info' => "For text input and text areas (in characters)",
'cf_f_must' => "<strong class='title'>Field MUST be completed and not left empty?</strong>",
'cf_f_must_info' => "If 'yes', an error will be shown if this field is not completed.",
'cf_f_option' => "<strong class='title'>Option Content (for drop downs, checkboxes and radio buttons)</strong>",
...
'cf_f_order' => "<strong class='title'>Display order</strong>",
'cf_f_order_info' => "When editing and displaying (numeric 1 lowest)",
'cf_f_priv' => "<strong class='title'>Make this a private profile field?</strong>",
...
'cf_f_reg' => "<strong class='title'>Include on registration page?</strong>",
'cf_f_reg_info' => "If 'yes', the field will be shown upon registration.",
'cf_f_title' => "<strong class='title'>Field Title</strong>",
'cf_f_title_info' => "Max characters: 200",
'cf_f_type' => "<strong class='title'>Field Type</strong>",
'cf_f_view' => "<strong class='title'>Topic View Format?</strong>",
...
'cf_removeto' => "<strong class='title'>Custom Profile Field to remove...</strong>",
...
'm_banned' => "Member Ban Adjusted",
'm_bannedlog' => "Altered ban status for member %s",
'm_banyourself' => "You cannot ban yourself",
...
'm_deleted' => "Up to %d Member Account(s) Deleted",
...
'm_movemembers' => "You are not permitted to move members",
...
'rep_form_image_help' => "Image to be displayed on member account, images should be in the following location: ",
...
'rnk_minpostsneeded' => "<strong class=\"title\">Minimum number of posts needed</strong>",
...
'rnk_numpips' => "<strong class=\"title\">Number of pips</strong> (Maximum: 100)",
...
'rnk_ranktitle' => "<strong class='title'>Rank Title</strong>",
...
'sm_addnote' => "Add Note",
'sm_allowadmin' => "Receive bulk mails?",
...
't_emailchange' => "Email change request at %s",
...
't_memunspammed' => "%s Member(s) Un-Flagged",
't_message' => "Message",
