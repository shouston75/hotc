...
<div class='tabwrap'>
	...
	<div id='tabtab-5' class='taboff'>About Me</div>
	<div id='tabtab-6' class='taboff'>Custom Fields</div>
</div>
			...
			<table cellpadding='0' cellspacing='0' border='0' width='100%'>
			 <tr>
				...
				<td>
						 ...
						 <tr>
							<td width='40%' class='tablerow1'><strong>Warning Adjustments</strong></td>
							<td width='60%' class='tablerow2'>
								{$form['warn_level']}
...
<div id='tabpane-5' class='formmain-background'>
	<fieldset class='formmain-fieldset'>
	    <legend><strong>Member's About Me Information</strong></legend>
		{$form['aboutme']}
	</fieldset>
</div>
